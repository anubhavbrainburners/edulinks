...
const IMAGES = [
  { src: "/images/tuuk2Img1.png", alt: "Feature pill 1" },
  { src: "/images/tuuk2Img2.png", alt: "Feature pill 2" },
  { src: "/images/tuuk2Img3.png", alt: "Feature pill 3" },
  { src: "/images/tuuk2Img4.png", alt: "Feature pill 4" },
];

export default function TuUk2M() {
  return (
      ...
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        <header className="text-center mb-10">
          <h1 className="text-3xl md:text-4xl font-semibold text-gray-800 pt-10">
             Why Choose UK's Top Universities
          </h1>
        </header>
