...
const faqs = [
  {
    ...
    answer:
      "It is known for academic excellence, research leadership, and global employability.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range from NZD 43,000 to NZD 87,000 per year, depending on the program.",
  },
  {
    question: "Does Auckland offer scholarships for international students?",
    answer:
      "Yes - Auckland International Student Excellence Scholarship and NZ Government scholarships are available.",
  },
  {
