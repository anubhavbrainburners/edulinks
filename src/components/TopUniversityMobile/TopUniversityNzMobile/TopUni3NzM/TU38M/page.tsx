...
const faqs = [
  {
    ...
    answer:
      "It is known for its excellence in law, environmental science, and international relations.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range from NZD 40,000 to NZD 60,000 per year, depending on the program.",
  },
  {
    question: "Does the university offer scholarships for international students?",
    answer:
      "Yes - Victoria International Excellence Scholarship and other merit-based awards are available.",
  },
  {
