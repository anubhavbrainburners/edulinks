...
const ITEMS: Item[] = [
  {
    id: 1,
    label: "Faculty of Business and Government",
    degrees: [
      {
        title: (
          <>
  ...
  },
  {
    ...
    degrees: [
      ...
      },
      {
        ...
        duration: "1 Years (Full-Time)",
        fee: "NZD 50,000",
        requirement: "Bachelor's in Law + IELTS 6.5",
        intake: "February",
      },
    ],
  },
  {
    ...
    degrees: [
      ...
      },
      {
        ...
        fee: "NZD 46,000/year",
        requirement: "Bachelor's in Science/Policy + IELTS 6.5",
        intake: "February",
      },
    ],
  },
  {
    ...
    degrees: [
      ...
      },
      {
        ...
        duration: "2 Years (Full-Time)",
        fee: "NZD 45,000/year",
        requirement: "Bachelor's in Arts/Politics + IELTS 6.5",
        intake: "February",
      },
    ],
  },
