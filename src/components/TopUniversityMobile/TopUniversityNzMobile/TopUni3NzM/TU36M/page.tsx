...
export default function TU36M() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
          Study in Wellington, close to decision-makers and innovators.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Strong focus on sustainability, law, and policy studies.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          150+ student clubs, cultural events, and entrepreneurship programs.
        </>
      ),
    },
  ];
    ...
    <main className="px-4 py-4 bg-white -mt-20">
      <div className="max-w-[1100px] mx-auto">
        <h1 className="text-center text-3xl font-bold mb-5 text-[#545454]">
          Life at Victoria University of Wellington
        </h1>
