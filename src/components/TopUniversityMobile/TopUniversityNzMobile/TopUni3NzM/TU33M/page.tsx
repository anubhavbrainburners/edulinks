...
export default function TU33M() {
  const points = [
    "Ranked among the Top 250 globally (QS & THE Rankings)",
    "Located in New Zealand's capital city, close to government and industry",
    "Strong programs in law, business, and environmental sciences",
    "Scholarships available for international students",
    "Research-focused and globally connected",
  ];
