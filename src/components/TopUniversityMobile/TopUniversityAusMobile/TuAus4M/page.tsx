...
export default function TuAus4M() {
  ...
  return (
    <section className="w-full px-8 py-25 -mt-20 bg-white">
      {/* FAQ Section */}
      ...
      <p className="text-[#666666] text-[16px] text-center leading-relaxed mb-8">
        ...
        simplified. Explore the most frequently asked questions about EduLinks,
        our platform, and how we help you grow.
      </p>
