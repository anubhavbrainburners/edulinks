...
import TuUsa2M from "../TuUsa2m/page";
import TuUsa3M from "../TuUsa3M/page";
import TuUsa4M from "../TuUsa4M/page";

export default function TuUsa1M() {
  return (
    <>
    <section
      id="below-header"
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          Top 20 Universities in the USA
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
              Explore America’s leading universities offering world-class education, cutting-edge research, and limitless global career opportunities.
          </span>
        </p>
