...
const IMAGES = [
  { src: "/images/tuusa2Img1.png", alt: "Feature pill 1" },
  { src: "/images/tuusa2Img2.png", alt: "Feature pill 2" },
  { src: "/images/tuusa2Img3.png", alt: "Feature pill 3" },
  { src: "/images/tuusa2Img4.png", alt: "Feature pill 4" },
];

export default function TuUsa2M() {
  return (
      ...
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        <header className="text-center mb-10">
          <h1 className="text-3xl md:text-4xl font-semibold text-gray-800 pt-10">
             Why Choose USA's Top Universities
          </h1>
        </header>
