    ...
    >
      ...
      >
        ...
        <div className="mt-16 max-w-[550px]">
          <h1 className="text-4xl font-bold mb-6 text-[#545454]">English Test</h1>
        ...
        <div className="max-w-[650px] mx-auto text-[#545454]">
          <div className="bg-white rounded-4xl shadow-lg px-8 pt-10 pb-10">
            <div className="px-4">
              ...
              <p className="text-lg font-medium mb-12">Choose One Section</p>
            </div>

            <form className="space-y-4" aria-label="English Test Section">
              {options.map((opt, idx) => {
