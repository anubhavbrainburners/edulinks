    ...
    <section className="relative w-full bg-white py-12 sm:py-16 md:py-20 px-4 sm:px-8 md:px-16 mt-5 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center">
        ...
        <div className="text-center md:text-left">
          ...
          <ul className="space-y-4 sm:space-y-5 text-lg sm:text-xl md:text-[22px] text-[#333] font-bold">
            {[
              ...
              >
                <span className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 ml-4 sm:ml-6 md:ml-8 rounded-full bg-[#37D7D9] mt-1.5"></span>
