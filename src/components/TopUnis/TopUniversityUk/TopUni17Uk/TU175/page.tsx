...
const REASONS = [
  {
    ...
    text: (
      <>
         Lakeside Heslington campus with innovative architecture and green spaces.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Advanced research facilities, libraries, and digital learning hubs.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          On-campus housing, sports facilities, and student support services.
      </>
    ),
  },
  {
    ...
    text: (
      <>
           York Global Campus network promoting international collaboration.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Ranked among the top UK universities for sustainability.
      </>
    ),
  },
];
