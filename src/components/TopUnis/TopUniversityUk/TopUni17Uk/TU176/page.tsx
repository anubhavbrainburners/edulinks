...
export default function TU176() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
          EExcellent graduate outcomes and internship<br/> links.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         Study in the medieval city of York, rich in culture<br/> and heritage.
        </>
      ),
    },
    {
      ...
      body: (
        <>
           Research-led teaching in a collaborative learning<br/> environment.
        </>
      ),
    },
  ];
