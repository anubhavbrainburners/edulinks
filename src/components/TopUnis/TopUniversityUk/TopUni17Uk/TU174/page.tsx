...
const ITEMS: Item[] = [
  ...
  { id: 2, label: <>Faculty of Social Sciences</> },
  { id: 3, label: <>York Management School</> },
  { id: 4, label: <>Faculty of Arts and<br/> Humanities</> },
  { id: 5, label: <>Faculty of Health Sciences</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">MSc Public Policy</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 year (full-time)
                        </div>
