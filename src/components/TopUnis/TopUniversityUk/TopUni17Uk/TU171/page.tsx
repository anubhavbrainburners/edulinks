      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
                Established in 1963, the University of York is a world-renowned member of the Russell Group,
 known for its academic excellence, research innovation, and supportive student community. It
 consistently ranks among the top 20 universities in the UK and within the top 150 globally.
            </span>
        </p>
