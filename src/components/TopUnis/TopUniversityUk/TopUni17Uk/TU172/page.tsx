      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
                 The University of York offers more than 300 undergraduate<br/> and postgraduate programs across
 disciplines including<br/> science, business, social sciences, arts, and health. The university<br/> emphasizes
 interdisciplinary learning, sustainability, and<br/> employability, with a strong global reputation for
 research-<br/>led teaching.
            </p>
          {/* Button */}
