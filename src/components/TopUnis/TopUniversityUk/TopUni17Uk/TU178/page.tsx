...
const faqs = [
  {
    ...
    answer:
      "York is known for academic excellence, employability, and research impact in science, business, and humanities.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Fees range from GBP 25,000 to GBP 30,000 per year, depending on the program.",
  },
  {
    question: "Does York offer scholarships for international students?",
    answer:
      "Yes - York Global Excellence Scholarships and Chevening Awards are available.",
  },
  {
    question: "Can international students work while studying?",
    answer:
      "Yes, students can work up to 20 hours/week during term time and full-time during holidays.",
  },
];
