      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
              Founded in 1829, King's College London (KCL) is one of the UK's oldest and most prestigious
 universities. A member of the Russell Group, KCL is globally recognized for excellence in teaching
 and research, particularly in health sciences, law, business, and humanities. It is consistently ranked
 among the top 35 universities in the world.
            </span>
        </p>
