      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
              King's offers over 300 undergraduate and postgraduate <br/>programs across its nine faculties. Located
 in the heart of <br/>London, KCL provides an inspiring academic environment <br/>and excellent industry
 connections with global employers.<br/> The university's research-led approach fosters innovation<br/> and
