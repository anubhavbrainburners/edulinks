...
export default function TU76() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
          Strong industry ties and internships in <br/>London.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Study in one of the world's most dynamic<br/> cities.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Research and startup support through King's<br/> Entrepreneurship Institute.
        </>
      ),
    },
  ];
