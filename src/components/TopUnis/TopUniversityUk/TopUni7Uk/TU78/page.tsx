...
const faqs = [
  {
    ...
    answer:
      "King's is renowned for medicine, law, business, and the humanities, with a strong research foundation.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range from GBP 28,000 to GBP 34,000 per year, depending on the program.",
  },
  {
    question: "Does King's College offer scholarships for international students?",
    answer:
      "Yes - King's Global Award and Chevening Scholarships are available.",
  },
  {
    question: "Can international students work while studying?",
    answer:
      "Yes, up to 20 hours/week during term time and full-time during vacations.",
  },
];

export default function TU78() {
