...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Health and Life <br/>Sciences</> },
  { id: 2, label: <>Faculty of Law</> },
  { id: 3, label: <>Faculty of Natural and Mathematical<br/> Sciences</> },
  { id: 4, label: <>King's Business Schoo</> },
  { id: 5, label: <>Faculty of Arts and <br/>Humanitie</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 1 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                           High School (Biology/Chemistry) + IELTS 7.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: September
                        </div>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor's in Health + IELTS 7.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           Intake: September
                        </div>
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">LLM Master of Laws</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 year (full-time)
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor's in CS/Maths + IELTS 7.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: September
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">MSc Finance and Accounting</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                           Bachelor's in Business/Economics + IELTS 7.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          September
                        </div>
                  ...
                  {id === 5 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                           Bachelor's in Humanities/Social Science + IELTS 7.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          September
                        </div>
