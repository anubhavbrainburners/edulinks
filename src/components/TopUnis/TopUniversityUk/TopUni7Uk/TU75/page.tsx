...
const REASONS = [
  {
    ...
    text: (
      <>
         Strand Campus - Home to humanities, law, and social sciences.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Guy's and St Thomas' Campuses - Focused on medicine and health sciences.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Waterloo and Denmark Hill Campuses - Dedicated to nursing, life sciences, and business.
      </>
    ),
  },
  {
    ...
    text: (
      <>
         Modern libraries, innovation hubs, and collaborative spaces.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Student housing and career development support across all campuses.
      </>
    ),
  },
];
