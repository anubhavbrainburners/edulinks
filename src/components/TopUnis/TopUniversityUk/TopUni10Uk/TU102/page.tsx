      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
               The University of Bristol offers a wide range of undergraduate <br/>and postgraduate programs across
 arts, science, engineering,<br/> law, medicine, and business. Known for its academic rigor and<br/> vibrant
 student community, Bristol combines academic excellence <br/>with an energetic city lifestyle in
 southwest England.
            </p>
          {/* Button */}
