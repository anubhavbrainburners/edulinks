...
const faqs = [
  {
    ...
    answer:
      "It's known for its research excellence, innovation, and high graduate employability.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Fees range from GBP 28,000 to GBP 52,000 per year, depending on the program.",
  },
  {
    question: "Does Bristol offer scholarships for international students?",
    answer:
      "Yes - Think Big Scholarships and Vice-Chancellor's Awards are available.",
  },
  {
