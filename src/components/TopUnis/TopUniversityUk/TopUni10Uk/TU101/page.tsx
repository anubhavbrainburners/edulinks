      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
              Established in 1876, the University of Bristol is one of the UK's most prestigious research
 universities. A member of the Russell Group, it is globally recognized for its excellence in teaching,
 research, and innovation, consistently ranking among the top 60 universities worldwide.
            </span>
        </p>
