...
export default function TU106() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
          Industry partnerships and strong employability<br/> rates.
    ...
    },
    {
      ...
      body: (
        <>
        Culture, festivals, and nightlife in Bristol <br/>city.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Home to cutting-edge global discoveries.
        </>
      ),
    },
  ];
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-6">
          ...
          <div className="relative -mt-2">
            ...
            <div className="absolute inset-0 flex flex-col justify-center px-8 items-end text-right">
              <h2 className="text-xl pt-5 font-bold mb-4 -mt-6">
                {cards[1].title}
              </h2>
          ...
          <div className="relative -mt-2">
            ...
            />
            <div className="absolute inset-0 flex flex-col justify-center px-8 items-end text-right">
              <h2 className="text-xl font-bold mb-4 -mt-14">
                {cards[3].title}
              </h2>
