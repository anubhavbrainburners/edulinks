...
export default function TU56() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
          Top-ranked for multidisciplinary<br/> innovation.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Internships and placements with major<br/> organizations.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Study in the cultural and economic capital of<br/> the UK.
        </>
      ),
    },
  ];
