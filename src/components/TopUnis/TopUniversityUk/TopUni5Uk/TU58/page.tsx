...
const faqs = [
  {
    ...
    answer:
      "UCL is renowned for research excellence, global outlook, and leadership in engineering, medicine, and social sciences.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range from GBP 30,000 to GBP 52,000 per year, depending on the program.",
  },
  {
    question: "Does UCL offer scholarships for international students?",
    answer:
      "Yes - UCL Global Masters Scholarship and Undergraduate Access Opportunity Scholarships are available.",
  },
  {
    question: "Can international students work while studying?",
    answer:
      "Yes, students can work up to 20 hours/week during term time and full-time during vacations.",
  },
];
