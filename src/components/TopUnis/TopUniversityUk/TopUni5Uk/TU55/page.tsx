...
const REASONS = [
  {
    ...
    text: (
      <>
         Bloomsbury Campus - Central London location with historic and modern buildings.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          UCL Library Services - one of the largest academic library systems in the UK.
      </>
    ),
  },
  {
    ...
    text: (
      <>
         Innovation & Enterprise Hub supporting startups and student ventures.
      </>
    ),
  },
  {
    ...
    text: (
      <>
         Advanced laboratories, simulation centres, and art studios.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        On-campus accommodation, cafés, gyms, and social spaces.
      </>
    ),
  },
];
