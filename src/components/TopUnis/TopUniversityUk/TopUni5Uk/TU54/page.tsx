...
const ITEMS: Item[] = [
  ...
  { id: 2, label: <>Faculty of Life Sciences and<br/> Medicine</> },
  { id: 3, label: <>Faculty of Arts and <br/>Humanities</> },
  { id: 4, label: <>Faculty of Social and Historical<br/> Sciences</> },
  { id: 5, label: <>UCL School of Management</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">MSc Public Health</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 year (full-time)
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">MSc International Relations</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                           Bachelor's in Social Sciences + IELTS 7.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          September
                        </div>
