...
const ITEMS: Item[] = [
  { id: 1, label: <>College of Physical Sciences <br/>and Engineering</> },
  { id: 2, label: <>Cardiff Business School</> },
  { id: 3, label: <>College of Biomedical and <br/>Life Sciences</> },
  { id: 4, label: <>College of Arts, Humanities and<br/> Social Sciences</> },
  { id: 5, label: <>School of Computer Science and<br/> Informatics</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 5 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">MSc Artificial Intelligence</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
