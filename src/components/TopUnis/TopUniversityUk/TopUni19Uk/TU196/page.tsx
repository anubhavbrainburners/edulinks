...
export default function TU196() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
           Excellent employability and internship<br/> opportunities.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Study in Cardiff, a lively and affordable <br/>UK city.
        </>
      ),
    },
    {
      ...
      body: (
        <>
           Leading UK university for innovation and <br/>impact.
        </>
      ),
    },
  ];
