      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
                 Cardiff University offers more than 300 undergraduate<br/> and postgraduate programs across fields
 such as Business,<br/> Engineering, Medicine, Law, and Arts. With a strong global <br/>reputation and
 excellent graduate employability, it attracts <br/>over 33,000 students from more than 130 countries.
            </p>
          {/* Button */}
