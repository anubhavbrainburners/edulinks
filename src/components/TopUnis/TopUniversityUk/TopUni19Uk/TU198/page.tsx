...
const faqs = [
  {
    ...
    answer:
      "Cardiff is known for its research strength, graduate employability, and student experience.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Fees range from GBP 24,500 to GBP 35,000 per year, depending on the program.",
  },
  {
    question: "Does Cardiff offer scholarships for international students?",
    answer:
      "Yes - Cardiff Vice-Chancellor's International Scholarships and Chevening Awards are available.",
  },
  {
