...
const REASONS = [
  {
    ...
    text: (
      <>
         Modern city-based campus integrated into the heart of Cardiff.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          World-class laboratories, libraries, and research centers.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    text: (
      <>
           Student residences close to campus with 24/7 security.
      </>
    ),
  },
  {
    ...
    text: (
      <>
         Sports, culture, and societies for an active student lifestyle.
      </>
    ),
  },
];
