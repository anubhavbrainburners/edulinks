      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
                Founded in 1883, Cardiff University is a leading Russell Group institution known for research
 excellence, innovative teaching, and a vibrant student community. It is one of the top universities in
 the UK and consistently ranks among the world's top 200 universities.
            </span>
        </p>
