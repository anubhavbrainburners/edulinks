...
const faqs = [
  {
    ...
    answer:
      "LSE is known for social sciences, particularly in economics, politics, and law.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range from GBP 27,500 to GBP 40,000 per year, depending on the program.",
  },
  {
    question: "Does LSE offer scholarships for international students?",
    answer:
      "Yes - LSE Undergraduate Support Scheme and Graduate Support Scheme are available.",
  },
  {
