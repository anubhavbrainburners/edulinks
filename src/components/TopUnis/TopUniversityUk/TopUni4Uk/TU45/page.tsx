...
const REASONS = [
  {
    ...
    text: (
      <>
         Central London campus near Covent Garden and the Thames River.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          World-class libraries, including the British Library of Political and Economic Science.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Modern lecture theatres, collaborative spaces, and student hubs.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        On-campus accommodation and international student services.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Proximity to major financial institutions and policy organizations.
      </>
    ),
  },
];
