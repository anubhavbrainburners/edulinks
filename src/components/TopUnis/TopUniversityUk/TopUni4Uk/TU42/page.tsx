      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
             LSE offers over 200 undergraduate and postgraduate<br/> programs focusing on economics,
 international relations,<br/> business, and law. Situated in the heart of London, it provides<br/> students
 access to major global institutions, multinational<br/> companies, and government organizations for
 unparalleled<br/> learning and networking opportunities.
            </p>
          {/* Button */}
