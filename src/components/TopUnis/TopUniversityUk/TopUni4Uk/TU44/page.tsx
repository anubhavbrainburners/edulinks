...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Economics and<br/> Finance</> },
  { id: 2, label: <>Faculty of Law and Political <br/>Science</> },
  { id: 3, label: <>Faculty of Business and <br/>Management</> },
  { id: 4, label: <>Faculty of Social Policy and<br/> Development</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 1 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor's in Economics/Finance + IELTS 7.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           Intake: September
                        </div>
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">MSc in International Relations</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 year (full-time)
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor's in relevant field + IELTS 7.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: September
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">MSc in Development Studies</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                           Bachelor's in Social Science + IELTS 7.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          September
                        </div>
