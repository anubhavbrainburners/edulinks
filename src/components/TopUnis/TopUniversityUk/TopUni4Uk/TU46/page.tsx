...
export default function TU46() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
          Access to leaders in business, politics, and<br/> academia.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Over 94% employability within six months of<br/> graduation.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Cultural diversity and world-class city <br/>experiences.
        </>
      ),
    },
  ];
