      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
              Founded in 1895, the London School of Economics and Political Science (LSE) is one of the world's
 leading social science universities. Renowned for its excellence in economics, politics, sociology,
 and law, LSE consistently ranks among the top 10 universities globally.
            </span>
        </p>
