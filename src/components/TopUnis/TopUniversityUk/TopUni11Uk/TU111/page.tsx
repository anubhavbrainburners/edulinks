      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
              Founded in 1451, the University of Glasgow is one of the oldest and most prestigious universities in
 the English-speaking world. A member of the Russell Group, it is globally recognized for its
 excellence in research, teaching, and innovation, consistently ranking among the top 100
