...
const faqs = [
  {
    ...
    answer:
      "Glasgow is known for world-class research, teaching excellence, and innovation in science and medicine.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range from GBP 25,000 to GBP 55,000 per year, depending on the program.",
  },
  {
    question: "Does Glasgow offer scholarships for international students?",
    answer:
      "Yes - University of Glasgow International Leadership Scholarship and Chevening Awards are available.",
  },
  {
