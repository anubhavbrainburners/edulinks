...
export default function TU116() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
          Ranked among top UK universities for research <br/>quality.
    ...
    },
    {
      ...
      body: (
        <>
        Excellent employability and internship <br/>support.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Experience Scottish culture, music, and<br/> festivals.
        </>
      ),
    },
  ];
