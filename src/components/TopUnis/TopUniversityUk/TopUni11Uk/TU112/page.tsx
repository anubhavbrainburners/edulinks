      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
               The University of Glasgow offers over 500 undergraduate <br/>and postgraduate programs across a wide
 range of disciplines,<br/> including engineering, medicine, business, arts, and science.<br/> The university is
 home to a vibrant international community<br/> and a strong focus on global research collaborations.
            </p>
          {/* Button */}
