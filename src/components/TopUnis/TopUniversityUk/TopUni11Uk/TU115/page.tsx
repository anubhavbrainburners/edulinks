...
const REASONS = [
  {
    ...
    text: (
      <>
         Gilmorehill Campus - Historic main campus with modern facilities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Advanced research laboratories, innovation hubs, and creative studios.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          University Library with over 2.5 million books and digital resources.
      </>
    ),
  },
  {
    ...
    text: (
      <>
         Student housing, sports facilities, and global networking events.
      </>
    ),
  },
  {
    ...
    text: (
      <>
           Dedicated international student support and career guidance.
      </>
    ),
  },
];
