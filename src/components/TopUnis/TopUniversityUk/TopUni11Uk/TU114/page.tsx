...
const ITEMS: Item[] = [
  ...
  { id: 2, label: <>College of Medicine, Veterinary and<br/> Life Sciences</> },
  { id: 3, label: <>College of Arts and Social<br/> Sciences</> },
  { id: 4, label: <>Adam Smith Business School</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">MSc Biomedical Sciences</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 year (full-time)
                        </div>
