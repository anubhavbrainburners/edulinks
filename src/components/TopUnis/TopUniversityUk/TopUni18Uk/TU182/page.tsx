      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
                 The University of Exeter offers a wide range of undergraduate<br/> and postgraduate degrees across its
 faculties in Business,<br/> Engineering, Medicine, Social Sciences, and Humanities. With<br/> a focus on
 sustainability and innovation, Exeter attracts over <br/>30,000 students from more than 150 countries.
            </p>
          {/* Button */}
