...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Engineering, Mathematics and <br/>Physical Sciences</> },
  { id: 2, label: <>Exeter Business School</> },
  { id: 3, label: <>Faculty of Medicine and <br/>Healthl</> },
  { id: 4, label: <>Faculty of Humanities, Arts and <br/>Social Sciences</> },
  { id: 5, label: <>Faculty of Environment, Science <br/>and Economy</> },
];
                  ...
                  {id === 5 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                            A-levels (Science subjects) + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: September
                        </div>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">MSc Renewable Energy Engineering</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
