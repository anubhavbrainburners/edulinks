      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
                Founded in 1955, the University of Exeter is a prestigious Russell Group institution renowned for its
 research excellence, teaching quality, and stunning campuses in southwest England. It consistently
 ranks among the top 15 universities in the UK and top 150 globally.
            </span>
        </p>
