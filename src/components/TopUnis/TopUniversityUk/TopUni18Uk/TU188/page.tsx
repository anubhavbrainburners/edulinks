...
const faqs = [
  {
    ...
    answer:
      "Exeter is known for research excellence, sustainability leadership, and employability.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Fees range from GBP 26,000 to GBP 39,000 per year, depending on the program.",
  },
  {
