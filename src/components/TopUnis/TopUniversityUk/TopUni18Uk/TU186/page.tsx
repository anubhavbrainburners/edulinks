...
export default function TU186() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
           Excellent employability and placement<br/> programs.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         Leading UK university for green<br/> initiatives.
        </>
      ),
    },
    {
      ...
      body: (
        <>
           Arts, sports, and societies across two <br/>scenic campuses.
        </>
      ),
    },
  ];
