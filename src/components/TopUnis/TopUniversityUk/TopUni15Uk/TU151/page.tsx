      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
                Founded in 1881, the University of Nottingham is one of the UK's leading research-intensive
 institutions and a member of the prestigious Russell Group. It is known for academic excellence,
 innovation, and a global outlook with campuses in the UK, China, and Malaysia.
            </span>
        </p>
