...
const faqs = [
  {
    ...
    answer:
      "Nottingham is known for its global presence, research excellence, and employability outcomes.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Fees range from GBP 27,000 to GBP 39,000 per year, depending on the program.",
  },
  {
    question: "Does Nottingham offer scholarships for international students?",
    answer:
      "Yes - Developing Solutions Scholarships and Vice-Chancellor's Awards are available.",
  },
  {
