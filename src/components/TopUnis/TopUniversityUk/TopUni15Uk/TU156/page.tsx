  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
           150+ nationalities represented on<br/> campus.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Excellent employability and internship programs.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         Leading UK institution in sustainability and <br/>technology.
        </>
      ),
    },
    {
      ...
      body: (
        <>
           Located in one of the UK's most affordable<br/> student cities.
        </>
      ),
    },
  ];
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-6">
          ...
          <div className="relative -mt-2">
            ...
            <div className="absolute inset-0 flex flex-col justify-center px-8 items-end text-right">
              <h2 className="text-xl pt-5 font-bold mb-4 -mt-12">
                {cards[1].title}
              </h2>
