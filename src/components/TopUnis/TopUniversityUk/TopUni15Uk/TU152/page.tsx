      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
                The University of Nottingham offers a broad range of undergraduate<br/> and postgraduate programs
 across its faculties of Engineering,<br/> Science, Business, Medicine, Arts, and Social Sciences. It is<br/>
 consistently ranked among the world's top 100 universities and<br/> emphasizes employability, research,
 and sustainability.
            </p>
          {/* Button */}
