...
const faqs = [
  {
    ...
    answer:
      "Warwick is known for business, economics, and engineering excellence with strong research and industry engagement.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range from GBP 28,000 to GBP 49,000 per year, depending on the program.",
  },
  {
    question: "Does Warwick offer scholarships for international students?",
    answer:
      "Yes - Warwick Chancellor's International Scholarship and WBS Excellence Scholarships are available.",
  },
  {
    question: "Can international students work while studying?",
    answer:
      "Yes, students can work up to 20 hours/week during term time and full-time during breaks.",
  },
];
