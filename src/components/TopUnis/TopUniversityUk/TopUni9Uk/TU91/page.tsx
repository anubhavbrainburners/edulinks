      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
              Founded in 1965, the University of Warwick is one of the UK's top universities, known for its
 academic excellence, innovation, and strong industry links. It consistently ranks among the top 10
 universities in the UK and top 100 globally, particularly for business, economics, and engineering.
            </span>
        </p>
