...
export default function TU96() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
          Strong links with industries and global<br/> employers.
    ...
    },
    {
      ...
      body: (
        <>
        Academic excellence with diverse student<br/> life.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Entrepreneurship and research at the university<br/> core.
        </>
      ),
    },
  ];
