...
const faqs = [
  {
    ...
    answer:
      "Southampton is known for engineering, computer science, and maritime research.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range from GBP 25,000 to GBP 50,000 per year, depending on the program.",
  },
  {
    question: "Does Southampton offer scholarships for international students?",
    answer:
      "Yes - Vice-Chancellor's Scholarships and Commonwealth Shared Scholarships are available.",
  },
  {
