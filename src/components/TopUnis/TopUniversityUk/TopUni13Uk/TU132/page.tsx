      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
                The University of Southampton offers over 350 undergraduate<br/> and postgraduate programs in
 engineering, technology, medicine,<br/> arts, and business. It is globally recognized for its innovation and<br/>
 strong industry partnerships, especially in engineering and <br/>ocean sciences.
            </p>
          {/* Button */}
