...
const REASONS = [
  {
    ...
    text: (
      <>
         Highfield Campus - main academic and research hub with state-of-the-art facilities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Boldrewood Innovation Campus - home to advanced engineering and maritime technology.
      </>
    ),
  },
  {
    ...
    text: (
      <>
           Modern libraries, student housing, and sports complexes.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Strong student support, including career and visa guidance.
      </>
    ),
  },
  {
    ...
    text: (
      <>
           Collaboration spaces and innovation labs for research and entrepreneurship.
      </>
    ),
  },
];

export default function TU135 () {
  return (
