      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
               Founded in 1862, the University of Southampton is a member of the Russell Group and one of the
 UK's top research-intensive universities. Renowned for its excellence in engineering, computer
 science, and business, it is ranked among the world's top 100 universities.
            </span>
        </p>
