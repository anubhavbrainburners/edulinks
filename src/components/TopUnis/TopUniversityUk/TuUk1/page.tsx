...
export default function TuUk1() {
  ...
  return (
    ...
    >
      ...
      {/* ===== content ===== */}
      <div className="text-center relative z-20 max-w-6xl -mt-10">
        <h1
        ...
        >
          <span className="block text-base sm:text-lg">
            Explore the UK’s most prestigious universities offering globally respected degrees, centuries of academic
          </span>
          <span className="block text-base sm:text-lg">
            excellence, and strong post-study work opportunities.
            </span>
        </p>
