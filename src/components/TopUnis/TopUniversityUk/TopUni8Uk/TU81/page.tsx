      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
              Founded in 1824, the University of Manchester is one of the UK's largest and most prestigious
 universities, known for research excellence and innovation. It is a member of the Russell Group and
 consistently ranks among the top 30 universities globally. The university's alumni include 25 Nobel
 laureates.
            </span>
        </p>
