      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
              The University of Manchester offers over 400 undergraduate<br/> and postgraduate programs in
 engineering, medicine, business,<br/> humanities, and science. It is a global leader in research and is<br/>
 renowned for its discovery of graphene and contributions to<br/> modern science and technology.
            </p>
          {/* Button */}
