...
const faqs = [
  {
    ...
    answer:
      "Manchester is known for its contributions to science, engineering, and social impact, as well as its research excellence.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range from GBP 27,500 to GBP 52,000 per year, depending on the program.",
  },
  {
    question: "Does Manchester offer scholarships for international students?",
    answer:
      "Yes - Global Futures Scholarship and Vice-Chancellor's Scholarships are available.",
  },
  {
