...
const faqs = [
  {
    ...
    answer:
      "Leeds is renowned for research excellence, employability, and vibrant student life.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Fees range from GBP 26,000 to GBP 47,000 per year, depending on the program.",
  },
  {
    question: "Does Leeds offer scholarships for international students?",
    answer:
      "Yes - Leeds International Foundation Year Scholarships and Dean's Excellence Awards are available.",
  },
  {
