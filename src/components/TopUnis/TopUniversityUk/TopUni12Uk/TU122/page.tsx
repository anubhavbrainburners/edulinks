      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
               The University of Leeds offers over 500 undergraduate <br/>and postgraduate programs across its
 faculties in engineering,<br/> science, business, law, and arts. It is home to more than 39,000<br/> students,
 including 13,000 international students from over 150<br/> countries. Leeds is also one of the most
 affordable and student-<br/>friendly cities in the UK.
            </p>
          {/* Button */}
