...
const REASONS = [
  {
    ...
    text: (
      <>
         One of the largest single-site campuses in the UK with modern academic buildings.
      </>
    ),
  },
  {
    ...
    text: (
      <>
           Advanced laboratories, libraries, and study zones.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Cutting-edge research centres and innovation hubs.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    text: (
      <>
           Strong emphasis on sustainability and green campus initiatives.
      </>
    ),
  },
];
