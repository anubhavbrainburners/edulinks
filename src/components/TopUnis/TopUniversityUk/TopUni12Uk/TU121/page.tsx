      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
              Established in 1904, the University of Leeds is one of the largest and most prestigious universities in
 the UK. A member of the Russell Group, Leeds is known for academic excellence, world-leading
 research, and a vibrant student community. It ranks among the top 100 universities globally.
            </span>
        </p>
