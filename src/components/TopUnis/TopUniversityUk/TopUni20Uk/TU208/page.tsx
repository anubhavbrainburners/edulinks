...
const faqs = [
  {
    ...
    answer:
      "QMUL is known for research excellence, diversity, and strong global employability.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Fees range from GBP 25,500 to GBP 48,000 per year, depending on the program.",
  },
  {
    question: "Does Queen Mary offer scholarships for international students?",
    answer:
      "Yes - Global Excellence Scholarships and Chevening Awards are available.",
  },
  {
