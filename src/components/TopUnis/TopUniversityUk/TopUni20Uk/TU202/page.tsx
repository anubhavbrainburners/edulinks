      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
                 Queen Mary offers over 400 undergraduate and postgraduate <br/>programs across faculties in
 Engineering, Science, Business,<br/> Law, Medicine, and Humanities. It is one of the most internationally<br/>
 diverse universities in the UK, with over 34,000 students from<br/> 170+ countries.
            </p>
          {/* Button */}
