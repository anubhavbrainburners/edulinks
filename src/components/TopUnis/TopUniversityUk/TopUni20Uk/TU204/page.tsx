...
const ITEMS: Item[] = [
  ...
  { id: 2, label: <>School of Business and <br/>Management</> },
  { id: 3, label: <>Faculty of Medicine and<br/> Dentistry</> },
  { id: 4, label: <>School of Law</> },
  { id: 5, label: <>Faculty of Humanities and Social<br/> Sciences</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">MSc International Business</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 year (full-time)
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">LLM International Law</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
                  ...
                  {id === 5 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">MA Global Development</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                           Bachelor's in Social Sciences + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          September
                        </div>
