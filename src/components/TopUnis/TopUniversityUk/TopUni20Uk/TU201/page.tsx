      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
                Founded in 1887, Queen Mary University of London (QMUL) is a prestigious Russell Group
 university known for research excellence, diversity, and strong academic programs. Located in the
 heart of London, it ranks among the top 150 universities globally and is a hub for innovation and
 global engagement.
            </span>
        </p>
