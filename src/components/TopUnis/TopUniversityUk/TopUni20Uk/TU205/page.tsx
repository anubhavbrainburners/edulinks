...
const REASONS = [
  {
    ...
    text: (
      <>
         Mile End Campus - modern academic hub with advanced research and teaching facilities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Dedicated innovation and entrepreneurship spaces for startups.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    text: (
      <>
           On-campus accommodation with easy access to London transport links.
      </>
    ),
  },
  {
    ...
    text: (
      <>
         Student support, career guidance, and international mentoring programs.
      </>
    ),
  },
];
