      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
                The University of Birmingham offers more than 500 undergraduate<br/> and postgraduate programs
 across faculties including Engineering,<br/> Business, Health, Arts, and Social Sciences. Known for its
 cutting-<br/>edge research and strong international reputation, the university<br/> attracts over 38,000
