...
const REASONS = [
  {
    ...
    text: (
      <>
         Historic red-brick campus with modern academic and residential facilities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Advanced research laboratories, libraries, and sports complexes.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Dedicated international student support and career development services.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Strong connections with global employers for internships and placements.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Green, student-friendly campus with great transport links to Birmingham city centre.
      </>
    ),
  },
];
