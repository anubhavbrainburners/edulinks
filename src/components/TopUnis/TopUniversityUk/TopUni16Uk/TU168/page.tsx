...
const faqs = [
  {
    ...
    answer:
      "Birmingham is renowned for engineering, business, and medical sciences.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Fees range from GBP 25,000 to GBP 50,000 per year, depending on the program.",
  },
  {
    question: "Does Birmingham offer scholarships for international students?",
    answer:
      "Yes - Global Masters Scholarship and Vice-Chancellor's International Awards are available.",
  },
  {
