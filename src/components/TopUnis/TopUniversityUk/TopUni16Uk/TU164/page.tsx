...
const ITEMS: Item[] = [
  { id: 1, label: <>College of Engineering and<br/> Physical Sciences</> },
  { id: 2, label: <>Birmingham Business School</> },
  { id: 3, label: <>College of Medical and Dental<br/> Sciences</> },
  { id: 4, label: <>College of Arts and <br/>Law</> },
  { id: 5, label: <>College of Life and Environmental<br/> Sciences</> },
];
