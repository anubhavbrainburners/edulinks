      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
                Founded in 1900, the University of Birmingham is a prestigious member of the Russell Group,
 renowned for its world-class teaching, research excellence, and innovation. It is one of the UK's top
 universities, consistently ranked among the top 100 globally.
            </span>
        </p>
