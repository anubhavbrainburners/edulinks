  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
           Students from over 150 nationalities.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Excellent industry connections and placement<br/> programs.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         Located in the UK's second-largest and most<br/> dynamic city.
        </>
      ),
    },
    {
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-6">
          ...
          <div className="relative -mt-2">
            ...
            <div className="absolute inset-0 flex flex-col justify-center px-8 items-end text-right">
              <h2 className="text-xl pt-5 font-bold mb-4 -mt-10">
                {cards[1].title}
              </h2>
          ...
          <div className="relative -mt-2">
            ...
            />
            <div className="absolute inset-0 flex flex-col justify-center px-8 items-end text-right">
              <h2 className="text-xl font-bold mb-4 -mt-15">
                {cards[3].title}
              </h2>
