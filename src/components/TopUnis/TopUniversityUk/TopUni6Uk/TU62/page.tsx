      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
              The University of Edinburgh offers more than 500 undergraduate<br/> and postgraduate programs
 across arts, science, medicine,<br/> engineering, and business. It has a strong global community<br/> with
 over 44,000 students from 180+ countries and is recognized<br/> for innovation and entrepreneurship in
