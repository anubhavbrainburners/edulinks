      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
              Founded in 1583, the University of Edinburgh is one of the oldest and most prestigious universities
 in the world. Renowned for its research excellence, academic reputation, and global impact, it is a
 member of the Russell Group and ranks consistently among the top 20 universities worldwide.
            </span>
        </p>
