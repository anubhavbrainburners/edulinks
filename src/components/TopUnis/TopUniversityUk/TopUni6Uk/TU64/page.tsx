...
const ITEMS: Item[] = [
  { id: 1, label: <>College of Science and<br/> Engineering</> },
  { id: 2, label: <>College of Arts, Humanities, and Social<br/> Sciences</> },
  { id: 3, label: <>College of Medicine and Veterinary<br/> Medicine</> },
  { id: 4, label: <>University of Edinburgh Business <br/>School</> },
];
