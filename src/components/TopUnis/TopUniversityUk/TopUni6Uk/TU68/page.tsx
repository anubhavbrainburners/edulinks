...
const faqs = [
  {
    ...
    answer:
      "It is known for world-class research, teaching excellence, and innovation across disciplines.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range from GBP 30,000 to GBP 55,000 per year, depending on the program.",
  },
  {
    question: "Does Edinburgh offer scholarships for international students?",
    answer:
      "Yes - Edinburgh Global Scholarships and Chevening Awards are available.",
  },
  {
    question: "Can international students work while studying?",
    answer:
      "Yes, students can work up to 20 hours/week during term and full-time during breaks.",
  },
];
