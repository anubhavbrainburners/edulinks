...
const REASONS = [
  {
    ...
    text: (
      <>
         Central Campus - Home to humanities and social sciences, historic architecture, and cultural hubs.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          King's Buildings - Engineering and science campus with advanced labs.
      </>
    ),
  },
  {
    ...
    text: (
      <>
         BioQuarter - World-leading medical and research complex.
      </>
    ),
  },
  {
    ...
    text: (
      <>
         Modern libraries, sports centres, innovation hubs, and student housing.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Strong academic and career support network for international students.
      </>
    ),
  },
];
