      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
             Established in 1907, Imperial College London is a world-leading institution specializing in science,
 engineering, medicine, and business. Ranked among the global top 10 universities, Imperial is
 known for cutting-edge research, industry partnerships, and innovation in technology and
 entrepreneurship.
            </span>
        </p>
