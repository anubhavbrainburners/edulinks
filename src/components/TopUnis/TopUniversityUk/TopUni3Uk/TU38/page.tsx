...
const faqs = [
  {
    ...
    answer:
      "Imperial is renowned for STEM programs, research innovation, and global industry connections.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range from GBP 38,000 to GBP 55,000 per year, depending on the program.",
  },
  {
    question: "Does Imperial offer scholarships for international students?",
    answer:
      "Yes - President's Undergraduate Scholarships and Imperial Excellence Scholarships are available.",
  },
  {
