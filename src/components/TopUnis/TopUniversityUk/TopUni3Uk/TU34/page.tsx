...
const ITEMS: Item[] = [
  ...
  { id: 2, label: <>Faculty of Natural Sciences</> },
  { id: 3, label: <>Faculty of Medicine</> },
  { id: 4, label: <>Imperial College Business <br/>School</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 1 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor's in Engineering + IELTS 7.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           Intake: October
                        </div>
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">MSc in Data Science and Machine Learning</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 year (full-time)
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            BSc in Economics, Finance & Data Science
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          3 years (full-time)
