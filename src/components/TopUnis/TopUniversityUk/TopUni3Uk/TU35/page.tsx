...
const REASONS = [
  {
    ...
    text: (
      <>
         South Kensington Campus - Central London location with modern labs and libraries.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Innovation Hub and Enterprise Lab supporting student startups.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Advanced engineering and medical simulation centres.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        On-campus housing, cafés, gyms, and sports facilities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Excellent links with London's tech and finance sectors.
      </>
    ),
  },
];
