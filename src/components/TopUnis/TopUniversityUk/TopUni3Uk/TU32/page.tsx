      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
             Imperial College offers over 250 undergraduate and<br/> postgraduate programs across its four faculties.
 Located <br/>in the heart of London, the university provides students<br/> with access to state-of-the-art
 facilities, a dynamic learning<br/> environment, and strong connections with global industries<br/> and
