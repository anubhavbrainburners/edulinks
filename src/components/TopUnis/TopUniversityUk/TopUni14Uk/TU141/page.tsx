      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
                Founded in 1832, Durham University is one of the UK's oldest and most prestigious institutions. A
 member of the Russell Group, it consistently ranks among the top 10 universities in the UK and top
 100 worldwide, known for its academic excellence and collegiate community structure.
            </span>
        </p>
