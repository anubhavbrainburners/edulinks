      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
                Durham University offers a diverse range of undergraduate<br/> and postgraduate programs across its
 four faculties - Arts & <br/>Humanities, Science, Business, and Social Sciences. It's recognized<br/> globally
 for its outstanding teaching, world-leading research,<br/> and high student satisfaction rates.
            </p>
          {/* Button */}
