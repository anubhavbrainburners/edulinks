...
export default function TU6() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
          Blend of heritage and innovation in one<br/> academic hub.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Unmatched career networks and graduate <br/>employability.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Cultural events, student societies, and world-class<br/> debates.
        </>
      ),
    },
  ];
