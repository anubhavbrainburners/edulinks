...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Humanities and Social <br/>Sciences</> },
  { id: 2, label: <>Faculty of Science and <br/>Engineering</> },
  { id: 3, label: <>Faculty of Business and <br/>Law</> },
  { id: 4, label: <>Faculty of Medicine and Health<br/> Sciences</> },
];
                  ...
                  {id === 4 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          A-levels (Chemistry/Biology) + IELTS 7.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: October
                        </div>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">MSc in Global Health Science</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
