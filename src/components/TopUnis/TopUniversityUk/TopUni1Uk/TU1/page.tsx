      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
             Established in 1096, the University of Oxford is the oldest university in the English-speaking world
 and one of the most prestigious globally. Known for academic excellence, research innovation, and
 influential alumni, Oxford consistently ranks among the top 5 universities in the world.
            </span>
        </p>
