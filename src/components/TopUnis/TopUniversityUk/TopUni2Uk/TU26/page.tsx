...
export default function TU26() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
          800 years of history with cutting-edge<br/> research.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Outstanding employability and alumni <br/>network.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Punting on the Cam, formal dinners, and cultural <br/>festivals.
        </>
      ),
    },
  ];
