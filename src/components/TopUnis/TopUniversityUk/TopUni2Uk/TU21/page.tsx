      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
             Founded in 1209, the University of Cambridge is one of the world's oldest and most prestigious
 universities. It is globally renowned for academic excellence, innovation, and leadership,
 consistently ranking among the top 3 universities worldwide. Cambridge alumni include more than
 120 Nobel laureates and influential world leaders.
            </span>
        </p>
