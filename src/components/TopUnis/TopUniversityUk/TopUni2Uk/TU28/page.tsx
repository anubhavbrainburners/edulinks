...
const faqs = [
  {
    ...
    answer:
      "Cambridge is known for academic excellence, world-class research, and producing global leaders in every field.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Fees range from GBP 38,000 to GBP 66,000 per year, depending on the program.",
  },
  {
    question: "Does Cambridge offer scholarships for international students?",
    answer:
      "Yes - Gates Cambridge, Chevening, and Cambridge Trust scholarships are available.",
  },
  {
