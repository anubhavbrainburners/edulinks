      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
            Cambridge comprises 31 colleges offering more than 300 <br/>programs across arts, sciences,
 engineering, medicine, and <br/>humanities. The university fosters a research-driven<br/> environment and
 offers a unique tutorial system ensuring <br/>personalized academic guidance. It is also a hub for global<br/>
 innovation and entrepreneurship through its renowned<br/> "Cambridge Cluster."
            </p>
          {/* Button */}
