...
const REASONS = [
  {
    ...
    text: (
      <> Main Campus (Waterloo) - Modern research and learning spaces in Canada's Silicon Valley.
  ...
  },
  {
    ...
    text: (
      <>
           Innovation Arena - Start-up incubator connecting students to industry mentors.
  ...
  },
  {
    ...
    text: (
      <>
        State-of-the-art labs, libraries, and engineering research centres
      </>
    ),
  },
  {
    ...
    text: (
      <>
         On-campus residences, wellness hubs, and student support offices.
  ...
  },
  {
    ...
    text: (
      <>
        Waterloo Research Institute for Quantum Computing and AI labs
      </>
    ),
  },
];
