...
const points = [
  ...
  {
    text: "Canada's #1 university for computer science and engineering reputation",
    style: "absolute left-[15%] top-[-7%] w-[30%] text-center",
  },
  {
    text: "Largest co-op education program in North America",
    style: "absolute left-[54%] top-[20%] w-[30%] text-left",
  },
  {
    text: " Located in Ontario's technology hub, near Toronto",
    style: "absolute left-[40%] top-[80%] w-[26%] text-center",
  },
  {
    text: "Strong partnerships with Google, Microsoft, and Shopify",
