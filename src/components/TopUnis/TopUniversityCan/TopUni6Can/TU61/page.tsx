  ...
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        Ranked among the Top 150 universities globally, <br/>the University of Waterloo is recognized for its
leadership <br/>in engineering, computer science, mathematics, and <br/>business. With over 42,000
students, including 10,000+ <br/>international learners, Waterloo combines world-class <br/>academics with
real-world experience through the <br/>largest co-op program in the world
