...
const faqs = [
  {
    question: "What is the University of Waterloo famous for?",
    answer:
      "Waterloo is renowned for engineering, computer science, and its globally recognized co-op programs.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range between CAD $41,000 - $52,000 per year depending on the program.",
  },
  {
    question: " Does Waterloo offer scholarships for international students?",
    answer:
