  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
          10,000+ international students from 120+ countries
        </>
      ),
    },
    {
      title: "Waterloo Lifestyle",
      body: (
        <>
         A technology-driven city with high employability rates
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Over 500 active research projects and start-up support.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Hackathons, innovation challenges, and student clubs year-round
