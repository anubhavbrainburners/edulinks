    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
         ...
         Founded in 1957, the University of Waterloo is one of Canada's top-ranked research universities,
renowned for innovation, entrepreneurship, and cooperative education (co-op). With strong global
partnerships and a forward-thinking academic approach, Waterloo prepares students for the future
