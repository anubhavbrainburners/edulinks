    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
         ...
         Founded in 1907, the University of Saskatchewan (USask) is a leading Canadian research
university known for innovation in agriculture, engineering, medicine, and sustainability. Located in
the vibrant city of Saskatoon, USask offers students a collaborative and affordable learning
environment with strong career opportunities.
