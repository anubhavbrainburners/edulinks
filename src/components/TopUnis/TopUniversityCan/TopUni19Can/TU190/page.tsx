    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
         ...
         Founded in 1942, Carleton University is a leading public research institution located in Canada's
capital city, Ottawa. It is renowned for its programs in engineering, public affairs, journalism,
business, and technology, with a strong focus on experiential learning and innovation.
