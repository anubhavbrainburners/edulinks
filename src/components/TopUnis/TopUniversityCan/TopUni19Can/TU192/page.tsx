...
const points = [
  ...
  {
    text: "Located in Ottawa - hub for government, technology, and diplomacy",
    style: "absolute left-[15%] top-[-7%] w-[35%] text-center",
  },
  {
    text: "Strong emphasis on practical learning, internships, and research",
    style: "absolute left-[54%] top-[20%] w-[30%] text-left",
  },
  {
    text: "Affordable tuition and living costs compared to other major cities",
    style: "absolute left-[40%] top-[80%] w-[28%] text-center",
  },
  {
    text: "Safe, diverse, and vibrant student community",
