...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Engineering and Design</> },
  { id: 2, label: <>Sprott School of Business</> },
  { id: 3, label: <>Faculty of Science</> },
 
  { id: 4, label: <>Faculty of Public Affairs</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold"> Master of Public Policy and Administration</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                         2 years
                        </div>
