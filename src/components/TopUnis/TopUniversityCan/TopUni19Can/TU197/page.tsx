...
const faqs = [
  {
    question: "What is Carleton University known for?",
    answer:
      "Carleton is known for engineering, journalism, and public affairs programs.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range between CAD $35,000 - $45,000 per year depending on the program.",
  },
  {
    question: " Does Carleton offer scholarships for international students?",
    answer:
      " Yes - Carleton provides entrance awards, merit-based scholarships, and graduate assistantships.",
  },
  {
