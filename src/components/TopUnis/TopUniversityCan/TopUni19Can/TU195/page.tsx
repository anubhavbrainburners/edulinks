...
export default function TU195() {
  const cards: Card[] = [
    ...
    {
      title: "Ottawa Lifestyle",
      body: (
        <>
        Study in Canada's capital<br/> with access to government and industry
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Active engagement in sustainability and AI research
        </>
      ),
    },
    {
      ...
      body: (
        <>
          250+ clubs, student<br/> associations, and leadership programs.
