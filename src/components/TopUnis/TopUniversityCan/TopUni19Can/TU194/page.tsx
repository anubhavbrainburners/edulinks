...
const REASONS = [
  {
    ...
    text: (
      <>Riverside Campus - Picturesque location along the Rideau River with modern labs and libraries.
  ...
  },
  {
    ...
    text: (
      <>
           Advanced engineering and tech labs, innovation hubs, and media studios.
  ...
  },
  {
    ...
    text: (
      <>
        Student residences, fitness centres, and cultural facilities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Co-op programs with government, tech, and non-profit sectors
  ...
  },
  {
    ...
    text: (
      <>
         Dedicated career and international student services.
      </>
    ),
  },
];
