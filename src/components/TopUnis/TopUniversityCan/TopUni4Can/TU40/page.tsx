    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
         ...
         Established in 1908, the University of Alberta is one of Canada's leading research-intensive
universities, known globally for innovation, teaching excellence, and strong industry partnerships.
With over 40,000 students from more than 150 countries, UAlberta offers a diverse and dynamic
