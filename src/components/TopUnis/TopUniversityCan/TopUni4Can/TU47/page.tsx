...
const faqs = [
  {
    question: " What is the University of Alberta known for?",
    answer:
      "UAlberta is best known for engineering, health sciences, computing, and business research excellence.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      " Tuition fees range between CAD $39,000 - $55,000 per year depending on the program",
  },
  {
    question: "  Does the University of Alberta offer scholarships?",
    answer:
      "Yes - UAlberta provides international entrance awards and merit-based scholarships",
  },
  {
    question: "Can international students work while studying?",
    answer:
      "Yes, international students can work 20 hours per week during studies and full-time duringbreaks.",
  },
];

export default function TU47() {
