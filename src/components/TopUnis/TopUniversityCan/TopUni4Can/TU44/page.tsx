...
const REASONS = [
  {
    ...
    text: (
      <>North Campus (Edmonton) - Main campus with world-class research centres and modern
academic buildings.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Augustana Campus - Liberal arts campus offering small-class personalized learning.
  ...
  },
  {
    ...
    text: (
      <>
        Campus Saint-Jean - French-language campus supporting bilingual education.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Cutting-edge labs, libraries, and innovation hubs across faculties.
  ...
  },
  {
    ...
    text: (
      <>
        Student residences, sports centres, and co-op work opportunities.
      </>
    ),
  },
];
