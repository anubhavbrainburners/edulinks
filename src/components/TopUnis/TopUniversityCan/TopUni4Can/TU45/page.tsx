  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
          Over 40,000 students from 150+ countries.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Affordable,<br/> multicultural city with strong job prospects.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Home to over    <br/> 400 research labs and start-up incubators.
        </>
      ),
    },
    {
      ...
      body: (
        <>
           450+ student <br/> clubs,festivals, and leadership opportunities.
  ...
  return (
    <main className="px-6 py-12 mt-35">
      <div className="max-w-[1100px] mx-auto">
       ...
       Life at the University of Alberta
