...
const points = [
  {
    text: "Ranked among the Top 110 globally and Top 5 in Canada (QS Rankings)",
    style: "absolute left-[-16%] top-[25%] w-[30%] text-right",
  },
  {
    text: "Strong focus on research, innovation, and practical learning",
    style: "absolute left-[15%] top-[-7%] w-[30%] text-center",
  },
  {
    text: "One of Canada's top universities for graduate employability",
    style: "absolute left-[54%] top-[20%] w-[30%] text-left",
  },
  {
    text: "Affordable tuition and living costs compared to major cities",
    style: "absolute left-[40%] top-[80%] w-[25%] text-center",
  },
  {
    text: "Welcoming campus community in Edmonton, Alberta's capital city",
