    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
         ...
         Founded in 1848, the University of Ottawa (uOttawa) is the world's largest bilingual (English-French)
university, known for its excellence in research, innovation, and diversity. Located in Canada's
capital city, it offers students unique opportunities for internships, research, and international
collaboration.
