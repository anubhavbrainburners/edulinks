...
const REASONS = [
  {
    ...
    text: (
      <> Downtown Ottawa Campus - Steps away from Parliament Hill and federal agencies.
  ...
  },
  {
    ...
    text: (
      <>
           Advanced research centres and bilingual libraries
  ...
  },
  {
    ...
    text: (
      <>
        On-campus residences, health centres, and athletic facilities
      </>
    ),
  },
  {
    ...
    text: (
      <>
         Innovation Hub connecting students with industries and government.
  ...
  },
  {
    ...
    text: (
      <>
        Strong support services for international students and bilingual learning.
      </>
    ),
  },
];
