...
const faqs = [
  {
    question: " What is the University of Ottawa known for?",
    answer:
      "Ottawa is known for its bilingual education, political science, law, and health programs.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range between CAD $41,000 - $53,000 per year depending on the program.",
  },
  {
    question: "  Does the University of Ottawa offer scholarships?",
    answer:
      "Yes - Ottawa offers international entrance scholarships and merit-based awards.",
  },
  {
