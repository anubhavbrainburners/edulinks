...
export default function TU115() {
  const cards: Card[] = [
    ...
    {
      title: "Capital City Lifestyle",
      body: (
        <>
        Access to government internships and networking.
        </>
      ),
    },
    {
      ...
      body: (
        <>
           Top research impact in social and health sciences.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         300+ clubs, societies, and leadership initiatives.
