  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        Founded in 1841, Queen's University is one of Canada's oldest and most prestigious institutions,
known for its research excellence, vibrant student community, and commitment to leadership and
innovation. Located in Kingston, Ontario, Queen's offers a globally recognized education in a
