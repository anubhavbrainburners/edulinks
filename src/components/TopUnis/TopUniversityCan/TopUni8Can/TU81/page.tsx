...
export default function TU81() {
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      ...
      Ranked among the Top 250 universities worldwide, Queen's University is home to more than 27,000
students from over 120 countries. It is recognized for outstanding programs in business,
engineering, health sciences, law, and the arts. Queen's fosters a strong sense of community and
provides students with exceptional research and networking opportunities.
