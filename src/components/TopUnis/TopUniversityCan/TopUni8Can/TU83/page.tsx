...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Engineering and Applied Science</> },
  { id: 2, label: <>Smith School of Business</> },
  { id: 3, label: <>Faculty of Health Sciences</> },
 
  { id: 4, label: <>Faculty of Arts and Science</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 3 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            Bachelor of Science (Life Sciences/Nursing)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          4 years
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">  Master of Science (Data Analytics)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                         2 years
                        </div>
