...
export default function TU85() {
  const cards: Card[] = [
    ...
    {
      title: "Kingston Lifestyle",
      body: (
        <>
         Safe, scenic city between Toronto, Ottawa, and Montreal.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Strong interdisciplinary research and startup ecosystem
        </>
      ),
    },
    {
      ...
      body: (
        <>
          250+ student clubs, events, and leadership programs.
