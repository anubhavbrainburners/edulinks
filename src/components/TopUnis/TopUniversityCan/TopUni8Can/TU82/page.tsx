...
const points = [
  {
    text: "Ranked among the Top 250 globally (QS World University Rankings)",
  ...
  {
    text: "Home to the prestigious Smith School of Business",
    style: "absolute left-[54%] top-[20%] w-[30%] text-left",
  },
  {
    text: " Exceptional student experience and global alumni network",
    style: "absolute left-[40%] top-[80%] w-[26%] text-center",
  },
  {
    text: "Beautiful lakeside campus in Kingston, a historic and safe city",
