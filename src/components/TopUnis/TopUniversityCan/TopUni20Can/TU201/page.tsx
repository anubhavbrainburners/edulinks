  ...
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        Ranked among the Top 600 universities globally,<br/> TMU hosts over 46,000 students, including 10,000<br/>
international students from more than 140 countries.<br/> The university offers industry-driven programs
across<br/> business, engineering, design, media, and health <br/>sciences, providing students with
real-world experience<br/> and global exposure.
