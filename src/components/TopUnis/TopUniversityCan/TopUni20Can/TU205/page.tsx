...
export default function TU205() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
        Located in Canada's<br/> financial, media, and tech capital.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Home to DMZ, one of the world's<br/> top university-based startup incubators
        </>
      ),
    },
    {
      ...
      body: (
        <>
          200+ student groups, <br/>cultural associations, and events.
