    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
         ...
         Established in 1948, Toronto Metropolitan University (TMU), formerly known as Ryerson University,
is one of Canada's most innovative and career-focused institutions. Located in downtown Toronto,
TMU is recognized for experiential learning, entrepreneurship, and excellence in technology and
creative industries.
