...
const faqs = [
  {
    question: "What is Toronto Metropolitan University known for?",
    answer:
      "TMU is known for business, media, engineering, and innovation programs, and its strong links to industry.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range between CAD $34,000 - $50,000 per year depending on the program.",
  },
  {
    question: "Does TMU offer scholarships for international students?",
    answer:
      "Yes - TMU offers International Student Merit Scholarships and President's Entrance Awards.",
  },
  {
