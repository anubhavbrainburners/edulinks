...
const faqs = [
  {
    question: "Why are Canadian universities ranked among the best globally?",
    answer:
      "They are known for academic excellence, research innovation, affordability, and strong graduate outcomes.",
  },
  {
    question: "What exams are required for top Canadian universities?",
    answer:
      "IELTS, TOEFL, or Duolingo for English; some programs may require GRE or GMAT.",
  },
  {
    question: "Which fields are most popular at Canada’s top institutions?",
    answer:
      "Computer Science, Engineering, Business, Health Sciences, and Environmental Studies.",
  },
  {
    question: "Are Canadian degrees valued internationally?",
    answer:
      "Yes — Canada’s top institutions are well-recognized across the U.S., Europe, Asia, and the Middle East.",
  },
  {
    question: "Do top Canadian universities offer scholarships?",
    answer:
      "Yes — universities offer entrance scholarships, merit-based awards, and research grants.",
  },
];
