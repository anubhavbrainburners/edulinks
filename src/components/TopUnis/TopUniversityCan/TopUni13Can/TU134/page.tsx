...
const REASONS = [
  {
    ...
    text: (
      <>Main Campus - Modern and eco-friendly facilities in a green urban setting.
  ...
  },
  {
    ...
    text: (
      <>
          Research centres in health, artificial intelligence, and environment
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Cutting-edge laboratories and technology hubs
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Student residences, sports complexes, and cultural facilities
  ...
  },
  {
    ...
    text: (
      <>
    French-language immersion and support for international students.
      </>
    ),
  },
];
