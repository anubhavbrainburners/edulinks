  ...
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        Ranked among the Top 450 universities worldwide,<br/> Université Laval is home to over 45,000
students,<br/> including more than 8,000 international students from <br/>120+ countries. The university is
recognized for<br/> excellence in health sciences, engineering, social sciences, <br/>and sustainable
development
