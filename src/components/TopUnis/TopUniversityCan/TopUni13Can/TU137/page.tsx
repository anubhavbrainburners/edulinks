...
const faqs = [
  {
    question: "What is Laval University known for?",
    answer:
      "Laval is known for sustainability research, French-language education, and excellence in health and engineering.",
  },
  {
    question: " What are the tuition fees for international students?",
    answer:
      "Tuition fees range between CAD $28,000 - $36,000 per year depending on the program",
  },
  {
    question: " Does Laval offer scholarships for international students?",
    answer:
      "Yes - Laval provides entrance scholarships, merit awards, and funding for research students.",
  },
  {
    question: "Can international students work while studying?",
    answer:
      "Yes, students can work 20 hours per week during studies and full-time during breaks.",
  },
];

export default function TU137() {
