  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        Founded in 1852, Laval University is the oldest French-language university in North America and
one of Canada's leading research institutions. Located in Quebec City, it offers world-class
academic programs, sustainability-focused initiatives, and a strong commitment to global
collaboration.
