...
const points = [
  {
    text: "Ranked among the Top 450 globally (QS World University Rankings)",
    style: "absolute left-[-16%] top-[25%] w-[30%] text-right",
  },
  {
    text: " Oldest French-language university in North America",
    style: "absolute left-[15%] top-[-7%] w-[30%] text-center",
  },
  {
    text: "Strong focus on sustainability, innovation, and internationalization",
    style: "absolute left-[54%] top-[20%] w-[30%] text-left",
  },
  {
    text: " Affordable tuition compared to other major Canadian institutions",
    style: "absolute left-[40%] top-[80%] w-[26%] text-center",
  },
  {
    text: " Located in Quebec City - a safe, historic, and culturally rich environment",
