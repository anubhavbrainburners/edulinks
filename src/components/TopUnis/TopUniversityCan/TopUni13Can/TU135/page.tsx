...
export default function TU135() {
  const cards: Card[] = [
    ...
    {
      title: "Quebec Lifestyle",
      body: (
        <>
       Affordable, safe, and culturally vibrant city.
    ...
    },
    {
      ...
      body: (
        <>
          Recognized leader in green initiatives
        </>
      ),
    },
    {
      ...
      body: (
        <>
          250+ clubs, student associations, and cultural events.
