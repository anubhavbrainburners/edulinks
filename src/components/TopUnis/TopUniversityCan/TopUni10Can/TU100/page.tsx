    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
         ...
         Founded in 1818, Dalhousie University is one of Canada's oldest and most respected universities,
known for research excellence, hands-on learning, and global community engagement. Located in
the coastal city of Halifax, Dalhousie offers a world-class education with a welcoming and vibrant
student environment
