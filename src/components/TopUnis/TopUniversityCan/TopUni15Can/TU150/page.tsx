  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        Founded in 1877, the University of Manitoba (UofM) is Western Canada's first university and a
leading public research institution. Known for its diverse programs, research excellence, and
affordable tuition, it ranks among Canada's top 25 universities and attracts students from over 120
countries.
