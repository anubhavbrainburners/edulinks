...
const faqs = [
  {
    question: "What is the University of Manitoba known for?",
    answer:
      "UofM is known for excellence in research, business, engineering, health sciences, and sustainable development.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Fees range between CAD $19,000 - $38,000 per year, depending on the program.",
  },
  {
    question: " Does the University of Manitoba offer scholarships for international students?",
    answer:
      "Yes - UofM offers entrance scholarships, graduate fellowships, and research funding for top international applicants.",
  },
  {
    question: "Can international students work while studying?",
    answer:
      "Yes - International students can work up to 20 hours/week during classes and full-time during breaks under Canadian work regulations.",
  },
];

export default function TU157() {
