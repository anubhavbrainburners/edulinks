  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
         Multicultural campus fostering global friendships and collaboration.
        </>
      ),
    },
    {
    ...
    },
    {
      ...
      body: (
        <>
          Among Canada's most cost-effective cities for students.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         Experience Winnipeg's arts, sports, and cultural festivals year-round.
