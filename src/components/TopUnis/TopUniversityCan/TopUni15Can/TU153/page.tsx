...
const ITEMS: Item[] = [
  { id: 1, label: <>Asper School of Business</> },
  { id: 2, label: <>Faculty of Engineering</> },
  { id: 3, label: <>Faculty of Science</> },
 
  { id: 4, label: <>Rady Faculty of Health Sciences</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Science in Electrical Engineering</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          GRE (optional) + Bachelor's in Engineering
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           Fall/Winter
                        </div>
