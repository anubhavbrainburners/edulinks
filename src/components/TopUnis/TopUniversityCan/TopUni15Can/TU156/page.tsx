      ...
      <div className="space-y-16 relative">
            ...
            <div className="absolute top-1/2 left-0 transform -translate-y-1/2 w-full flex justify-end items-center">
              ...
              <div className="text-white text-lg max-w-[380px] leading-relaxed mr-30">
                <ul className="list-disc space-y-1">
                  <li>
                      Academic: High school diploma with strong performance in Math, English, and Sciences.
                  </li>
                  <li>
                    Language Tests: IELTS 6.5 (no band below 6.0) / TOEFL 86 (no section below 20).

                  </li>
                  <li>
                    Documents: Transcripts, statement of purpose, and proof of English proficiency.
        ...
        <div className="relative flex justify-start">
          ...
          <div className="absolute top-1/2 left-0 transform -translate-y-1/2 w-full flex justify-start items-center">
            {/* Left Side Text */}
            <div className="text-black text-lg max-w-[410px] leading-relaxed ml-46">
              <ul className="list-disc space-y-1">
                <li>
                    Academic: Bachelor's degree in a relevant discipline with minimum 3.0 GPA.

                </li>
                <li>
                  Tests: GRE/GMAT (varies by program).
                </li>
                 <li>
                  Documents: SOP, Letters of Recommendation, Resume/CV, and academic transcripts.
                </li>
              </ul>
            </div>
