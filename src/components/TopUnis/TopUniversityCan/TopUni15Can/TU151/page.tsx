  ...
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        The University of Manitoba offers over 100<br/> undergraduate and graduate programs across <br/> its 24
faculties and schools, including the Faculty <br/>of Science, Faculty  of Engineering, and Asper <br/>School of
Business. It is renowned for fostering<br/>  innovation, leadership, and sustainability through<br/>  hands-on
