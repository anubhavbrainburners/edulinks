...
const REASONS = [
  {
    ...
    text: (
      <> Main Fort Garry campus with modern labs, libraries, and athletic facilities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Research hubs like the Centre for Earth Observation Science (CEOS) and Smartpark Innovation
Hub.
  ...
  },
  {
    ...
    text: (
      <>
        Advanced medical research through the Bannatyne Health Sciences Campus.
      </>
    ),
  },
  {
    ...
    text: (
      <>
         Over 100 student clubs, fitness centers, and cultural associations.
  ...
  },
  {
    ...
    text: (
      <>
        Extensive student support services including academic advising and international student
mentorship.
      </>
    ),
  },
