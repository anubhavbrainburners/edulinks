...
const REASONS = [
  {
    ...
    text: (
      <>
         Downtown Montreal Campus - historic campus with modern labs, research hubs, and cultural
spaces
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Macdonald Campus - focused on environmental, agricultural, and life sciences
      </>
    ),
  },
  {
    ...
    text: (
      <>
           Over 40 libraries and advanced research centres
      </>
    ),
  },
  {
    ...
    text: (
      <>
         Student housing, fitness facilities, and wellness centres.
  ...
  },
  {
    ...
    text: (
      <>
        Global research partnerships and startup incubators.
      </>
    ),
  },
];
