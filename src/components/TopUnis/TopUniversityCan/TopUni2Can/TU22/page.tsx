...
const points = [
  {
    text: "Ranked #2 in Canada and Top 30 globally (QS World University Rankings)",
    style: "absolute left-[-16%] top-[25%] w-[33%] text-right",
  },
  {
    text: "High employability rate for graduates worldwide",
    style: "absolute left-[15%] top-[-7%] w-[30%] text-center",
  },
  {
    text: "English-language university in a bilingual (English-French) city",
    style: "absolute left-[54%] top-[20%] w-[30%] text-left",
  },
  {
    text: "Strong emphasis on research, innovation, and student leadership",
    style: "absolute left-[40%] top-[80%] w-[28%] text-center",
  },
  {
    text: "Affordable living in Montreal, one of North America's best student cities",
