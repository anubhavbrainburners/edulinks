      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
           Founded in 1821, McGill University is one of Canada's most prestigious institutions, renowned for
academic excellence, groundbreaking research, and global diversity. Located in the heart of
Montreal, McGill consistently ranks among the world's top universities for innovation and
