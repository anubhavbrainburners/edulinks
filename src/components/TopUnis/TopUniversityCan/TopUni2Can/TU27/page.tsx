...
const faqs = [
  {
    question: "What is McGill University best known for?",
    answer:
      "McGill is known for excellence in medicine, law, engineering, and management, along with research leadership.",
  },
  {
    question: "What are the average tuition fees?",
    answer:
      " Tuition fees range between CAD $45,000 - $65,000 per year depending on the program.",
  },
  {
    question: "Does McGill offer scholarships for international students?",
    answer:
      "Yes - McGill offers merit-based entrance awards and the McGill Entrance Bursary Program",
  },
  {
