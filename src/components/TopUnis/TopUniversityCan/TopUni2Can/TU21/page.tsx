      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
            Ranked among the Top 20 universities worldwide,<br/> the University of Toronto is recognized for
academic<br/> excellence, innovation, and diversity.Hosting over <br/>97,000 students  from more than 160
countries, U of T <br/>offers exceptional programsacross business, engineering, <br/>health, computer
