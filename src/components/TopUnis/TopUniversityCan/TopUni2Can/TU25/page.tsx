...
export default function TU25() {
  const cards: Card[] = [
    ...
    {
      title: "Montreal Lifestyle ",
      body: (
        <>
         Affordable, bilingual, and culturally vibrant city.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          World-class facilities and Nobel laureate faculty.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          250+ clubs, societies, and cultural associations.
        </>
      ),
    },
  ];
