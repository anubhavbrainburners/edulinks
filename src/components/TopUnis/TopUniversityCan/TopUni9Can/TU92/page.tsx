...
const points = [
  ...
  {
    text: "One of Canada's fastest-growing research universities",
    style: "absolute left-[15%] top-[-7%] w-[30%] text-center",
  },
  {
    text: " Strong ties with Calgary's booming industries and innovation sector",
    style: "absolute left-[54%] top-[20%] w-[30%] text-left",
  },
  {
    text: " High post-graduate employability rate",
    style: "absolute left-[40%] top-[80%] w-[26%] text-center",
  },
  {
    text: "Safe, affordable, and student-friendly city with access to the Rocky Mountains",
