    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
         ...
         Established in 1966, the University of Calgary (UCalgary) is one of Canada's top comprehensive
research universities, known for innovation, entrepreneurship, and strong community engagement.
Located in Alberta's economic hub, it combines academic excellence with hands-on learning and
real-world impact.
