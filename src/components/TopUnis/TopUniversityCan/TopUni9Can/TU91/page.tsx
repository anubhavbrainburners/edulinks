  ...
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        Ranked among the Top 250 universities globally, UCalgary is home to over 33,000 students,
including 8,000 international learners from 160+ countries. It is widely recognized for programs in
energy, engineering, business, and health sciences, along with a strong focus on sustainability and
