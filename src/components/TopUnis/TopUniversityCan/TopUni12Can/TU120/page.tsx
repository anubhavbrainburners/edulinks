  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        Founded in 1965, Simon Fraser University (SFU) is one of Canada's top comprehensive
universities, recognized globally for innovation, sustainability, and strong community engagement.
With campuses in Burnaby, Surrey, and Vancouver, SFU offers a dynamic learning environment at
the heart of Canada's West Coast technology hub.
