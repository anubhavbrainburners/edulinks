  ...
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
       ...
       Ranked among the Top 350 universities worldwide, <br/>SFU has over 35,000 students from 140+
countries.<br/> It is renowned for programs in business, engineering, <br/>computing science, health, and the
environment. <br/>SFU integrates academic learning with practical <br/>experience through one of Canada's
strongest co-op<br/> programs
