...
const faqs = [
  {
    question: "What is Simon Fraser University known for?",
    answer:
      "SFU is known for sustainability, innovation, and its top-ranked co-op education program.",
  },
  {
    question: " What are the tuition fees for international students?",
    answer:
      " Tuition fees range between CAD $40,000 - $55,000 per year depending on the program.",
  },
  {
    question: "Does SFU offer scholarships for international students?",
    answer:
      "Yes - Waterloo offers merit-based entrance scholarships and international experience awards",
  },
  {
