...
const REASONS = [
  {
    ...
    text: (
      <>Burnaby Mountain Campus - Main campus offering scenic views and modern architecture.
  ...
  },
  {
    ...
    text: (
      <>
        Vancouver Campus - Industry-oriented programs and business innovation centre.
  ...
  },
  {
    ...
    text: (
      <>
        Surrey Campus - Technology and design-focused programs.
      </>
    ),
  },
  {
    ...
    text: (
      <>
         High-tech research labs, libraries, and startup incubators.
  ...
  },
  {
    ...
    text: (
      <>
       Student housing, recreational spaces, and global student support services.
      </>
    ),
  },
];
