  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        Established in 1974, Concordia University is one of Canada's most innovative and diverse public
universities, known for research, technology, and experiential learning. Located in the heart of
Montreal, Concordia provides world-class education in a dynamic, multicultural city ranked among
the best for students globally.
