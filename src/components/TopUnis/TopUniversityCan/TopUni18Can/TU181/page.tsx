  ...
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        Established in 1974, Concordia University is one <br/>of Canada's most innovative and diverse public<br/>
universities, known for research, technology, and <br/>experiential learning. Located in the heart of<br/>
Montreal, Concordia provides world-class education <br/>in a dynamic, multicultural city ranked among
the <br/>best for students globally.
