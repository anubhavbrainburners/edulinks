...
const REASONS = [
  {
    ...
    text: (
      <>Sir George Williams Campus - Urban campus in downtown Montreal with high-tech labs and
creative studios
  ...
  },
  {
    ...
    text: (
      <>
          Loyola Campus - Green, research-focused campus for science and humanities
  ...
  },
  {
    ...
    text: (
      <>
        State-of-the-art labs, innovation centres, and libraries.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Student residences, recreation centres, and cultural hubs.
  ...
  },
  {
    ...
    text: (
      <>
       Extensive co-op and internship programs across faculties.
