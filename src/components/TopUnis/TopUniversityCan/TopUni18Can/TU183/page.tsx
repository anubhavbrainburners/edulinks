...
const ITEMS: Item[] = [
  { id: 1, label: <>Gina Cody School of Engineering and Computer Science</> },
  { id: 2, label: <>John Molson School of Business</> },
  { id: 3, label: <>Faculty of Arts and Science</> },
 
  { id: 4, label: <>Faculty of Fine Arts</> },
];
                  ...
                  {id === 4 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                          Bachelor of Fine Arts (Design/Animation)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          4 years 
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                         High School + Portfolio + IELTS 6.5 
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: September
                        </div>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">  Master of Design</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                         2 years
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                           Bachelor's in Design/Arts + Portfolio + IELTS 6.5 
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: September
                        </div>
