...
const faqs = [
  {
    question: "What is Concordia University known for?",
    answer:
      "Concordia is known for innovation, engineering, and business programs, as well as its global diversity.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range between CAD $31,000 - $45,000 per year depending on the program.",
  },
  {
    question: " Does Concordia offer scholarships for international students?",
    answer:
      "Yes - Concordia offers International Excellence Scholarships and financial aid opportunities",
  },
  {
