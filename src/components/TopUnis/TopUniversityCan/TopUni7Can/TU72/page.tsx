...
const points = [
  ...
  {
    text: "Home to the renowned Ivey Business School and Schulich School of Medicine",
    style: "absolute left-[15%] top-[-7%] w-[30%] text-center",
  },
  {
    text: "High employability rate and strong alumni network",
    style: "absolute left-[54%] top-[20%] w-[30%] text-left",
  },
  {
    text: "Research-intensive university with world-class facilities",
    style: "absolute left-[40%] top-[80%] w-[26%] text-center",
  },
  {
    text: " Safe, affordable, and student-friendly city",
