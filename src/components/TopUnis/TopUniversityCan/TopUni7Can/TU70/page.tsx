  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        Established in 1878, Western University is one of Canada's leading public research institutions,
known for academic excellence, leadership development, and a vibrant student community. Located
in London, Ontario, Western combines high-quality education with a supportive campus experience
and global impact.
