...
const faqs = [
  {
    question: "What is Western University known for?",
    answer:
      " Western is known for business, health sciences, and engineering excellence.",
  },
  {
    question: " What are the tuition fees for international students?",
    answer:
      "Tuition fees range between CAD $41,000 - $67,000 per year depending on the program",
  },
  {
    question: " Does Western offer scholarships for international students?",
    answer:
      "Yes - Western offers International President's Entrance Scholarships and merit-based awards.",
  },
  {
