...
export default function TU71() {
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      ...
      Ranked among the Top 200 universities worldwide, Western University has over 38,000 students
from 130+ countries. It is widely recognized for its programs in business, health sciences,
engineering, law, and social sciences. Western's innovative learning environment and research
excellence prepare students for leadership in a global context.
