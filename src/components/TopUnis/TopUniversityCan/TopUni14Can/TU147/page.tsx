...
const faqs = [
  {
    question: "What is Memorial University known for?",
    answer:
      "MUN is known for ocean research, engineering, and affordable quality education",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range between CAD $18,000 - $25,000 per year depending on the program.",
  },
  {
    question: "Does Memorial University offer scholarships for international students?",
    answer:
      "Yes - Memorial offers entrance scholarships and research-based financial aid",
  },
  {
