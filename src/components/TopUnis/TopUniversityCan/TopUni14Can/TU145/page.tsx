...
export default function TU145() {
  const cards: Card[] = [
    ...
    {
      title: "Newfoundland Lifestyle",
      body: (
        <>
         Coastal, safe, and affordable living environment.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Ocean research and sustainability leadership.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          200+ clubs, societies, and cultural associations.
