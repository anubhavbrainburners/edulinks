...
const REASONS = [
  {
    ...
    text: (
      <> St. John's Campus - Modern and research-focused facilities with a welcoming atmosphere.
  ...
  },
  {
    ...
    text: (
      <>
         Marine Institute - Specialized in ocean engineering and maritime studies.
  ...
  },
  {
    ...
    text: (
      <>
         Grenfell Campus - Focus on fine arts and environmental programs
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Modern laboratories, libraries, and research centres.
  ...
  },
  {
    ...
    text: (
      <>
       On-campus housing, recreation centres, and career services.
      </>
    ),
  },
];
