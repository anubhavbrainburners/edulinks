  ...
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
       ...
       Ranked among the Top 700 universities worldwide, <br/>Memorial University serves over 19,000
students<br/> from 115+ countries. The university offers diverse<br/> programs in engineering, business,
health sciences,<br/> ocean studies, and the arts, with a focus on<br/> experiential learning and sustainability.
