    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
         ...
         Established in 1925, Memorial University of Newfoundland (MUN) is one of Canada's most
affordable and globally recognized universities, known for research excellence, innovation, and
community engagement. Located in the scenic Atlantic province of Newfoundland and Labrador,
MUN offers high-quality education with strong international support.
