...
const REASONS = [
  {
    ...
    text: (
      <> Keele Campus - York's main campus featuring cutting-edge labs, libraries, and innovation hubs.
  ...
  },
  {
    ...
    text: (
      <>
          Glendon Campus - Bilingual (English-French) liberal arts campus.
  ...
  },
  {
    ...
    text: (
      <>
        State-of-the-art engineering and business facilities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Student housing, career centres, and sports complexes.
  ...
  },
  {
    ...
    text: (
      <>
        Subway access directly connecting to downtown Toronto.
      </>
    ),
  },
];
