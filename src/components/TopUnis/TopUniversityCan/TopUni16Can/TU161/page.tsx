  ...
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
       ...
       Ranked among the Top 500 universities globally, <br/>York University has over 55,000 students,
including <br/>10,000+ international students from 170+ countries. <br/>The university is well-known for its
programs in business,<br/> law, health, engineering, and social sciences. Its strong<br/> industry connections
and modern campus make it a <br/>top destination for international students.
