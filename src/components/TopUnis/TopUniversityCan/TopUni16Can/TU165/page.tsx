...
export default function TU165() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
        Study in Canada's largest and most dynamic city
        </>
      ),
    },
    {
      ...
      body: (
        <>
          25+ research centres with global impact.
    ...
    },
    {
      ...
      body: (
        <>
           350+ student clubs,<br/> cultural festivals, and professional associations
