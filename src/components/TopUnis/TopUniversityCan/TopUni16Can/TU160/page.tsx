    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
         ...
         Established in 1959, York University is Canada's third-largest university and a global leader in
research, innovation, and experiential education. Located in Toronto, one of the world's most
multicultural cities, York offers students endless opportunities for academic and career growth.
