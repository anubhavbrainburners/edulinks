...
const faqs = [
  {
    question: "What is the University of Toronto known for?",
    answer:
      "U of T is known for its excellence in research, engineering, medicine, and business.",
  },
  {
    question: "What is the tuition fee range for international students?",
    answer:
      " Tuition ranges between CAD $45,000 - $75,000 per year, depending on the program.",
  },
  {
    question: "Does the University of Toronto offer scholarships?",
    answer:
