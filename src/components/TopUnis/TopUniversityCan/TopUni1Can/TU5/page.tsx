...
export default function TU5() {
  const cards: Card[] = [
    ...
    {
      title: "Toronto Lifestyle",
      body: (
        <>
         Multicultural city with career,<br/> culture, and global networking opportunities.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          900+ research labs and <br/> interdisciplinary opportunities.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Festivals, clubs, and<br/>  leadership programs throughout the year.
        </>
      ),
    },
  ];
