      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
            Established in 1827, the University of Toronto (U of T) is Canada's leading public research university
and one of the top-ranked institutions in the world. With three campuses across the Greater Toronto
Area, it offers world-class education, global research excellence, and unmatched career
opportunities.
            </span>
        </p>
