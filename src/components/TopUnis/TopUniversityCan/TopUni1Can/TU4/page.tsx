...
const REASONS = [
  {
    ...
    text: (
      <>
         St. George Campus - historic main campus in downtown Toronto with advanced labs, libraries, and
global research centres.
  ...
  },
  {
    ...
    text: (
      <>
          Scarborough & Mississauga Campuses - modern campuses with high-tech facilities and
