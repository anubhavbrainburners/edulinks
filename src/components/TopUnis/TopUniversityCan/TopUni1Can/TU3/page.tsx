...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Applied Science & <br /> Engineering</> },
  { id: 2, label: <>Rotman School of Management</> },
  { id: 3, label: <>Faculty of Arts &<br />Science</> },
 
  { id: 4, label: <>Faculty of Medicine &<br /> Health</> },
];
                  ...
                  {id === 3 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            Bachelor of Arts (Economics/Psychology/Political Science)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          4 years
