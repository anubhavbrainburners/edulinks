    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          ...
          Established in 1908, the University of British Columbia (UBC) is a world-leading public research
university ranked among the top 40 globally. Known for academic excellence, sustainability
leadership, and global innovation, UBC attracts students from over 160 countries.
            </span>
        </p>
