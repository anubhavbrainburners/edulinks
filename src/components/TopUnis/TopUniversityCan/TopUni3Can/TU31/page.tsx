    ...
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
         ...
         UBC ranks among the Top 40 universities in the world<br/> and is consistently recognized for its
academic excellence,<br/> research innovation, and commitment to sustainability.<br/> With over 68,000
students across its Vancouver and <br/>Okanagan campuses, UBC provides transformative learning<br/>
experiences in business, engineering, science, and humanities
