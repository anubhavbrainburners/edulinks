    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
         ...
         Established in 1887, McMaster University is a top-ranked Canadian research university known for
innovation in teaching, problem-based learning, and global research impact. Located in Hamilton,
Ontario, McMaster combines academic excellence with a strong focus on interdisciplinary
