...
const REASONS = [
  {
    ...
    text: (
      <> Main Campus (Hamilton) - Green, vibrant campus with modern labs and research centres.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Advanced medical research facilities and innovation hubs.
  ...
  },
  {
    ...
    text: (
      <>
        Over 20 libraries and digital learning spaces.
      </>
    ),
  },
  {
    ...
    text: (
      <>
         Student residences, recreation centres, and career development support.
  ...
  },
  {
    ...
    text: (
      <>
        Close proximity to Toronto for internship and job opportunities.
      </>
    ),
  },
];
