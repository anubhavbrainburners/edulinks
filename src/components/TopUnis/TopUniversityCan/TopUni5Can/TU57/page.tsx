...
const faqs = [
  {
    question: "What is McMaster University known for?",
    answer:
      "McMaster is known for its world-class programs in health sciences, business, and engineering.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range between CAD $40,000 - $52,000 per year depending on the program.",
  },
  {
    question: " Does McMaster offer scholarships for international students?",
    answer:
