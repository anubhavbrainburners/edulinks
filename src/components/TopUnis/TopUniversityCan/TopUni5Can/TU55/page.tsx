  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
          Global Community - Students from 120+ countries
        </>
      ),
    },
    {
      title: "Edmonton Lifestyle",
      body: (
        <>
          Hamilton Lifestyle - Affordable<br/> city with access to nature and big-city amenities
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Research & Innovation - World-<br/>class facilities and global collaboration projects
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Active Campus Life - 300+ <br/>clubs, events, and student-run organizations
