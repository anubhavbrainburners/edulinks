...
const ITEMS: Item[] = [
  { id: 1, label: <>Harvard College (Undergraduate)</> },
  { id: 2, label: <>Harvard Business School</> },
  { id: 3, label: <>Harvard Law School</> },
 
  { id: 4, label: <>Harvard Medical School</> },
  { id: 5, label: <>Harvard Graduate School of Arts and Sciences</> },
];
                  ...
                  {id === 2 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Requirement: GMAT/GRE + Bachelor's degree 
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: Fall
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Requirement: LSAT + Bachelor's degree
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: Fall
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                         Requirement: MCAT + Bachelor's in Science
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: Fall
                        </div>
                  ...
                  {id === 5 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Requirement: GRE + Bachelor's in Science
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: Fall
                        </div>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Requirement: GRE + Research Experience 
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: Fall
                        </div>
