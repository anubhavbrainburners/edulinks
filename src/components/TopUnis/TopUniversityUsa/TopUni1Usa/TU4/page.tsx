...
const REASONS = [
  {
    ...
    text: (
      <>
       5,000-acre campus featuring libraries, museums, laboratories, and student residences.
  ...
  },
  {
    ...
    text: (
      <>
          Harvard Library - the largest academic library in the world with over 20 million volumes.
      </>
    ),
  },
  {
    ...
    text: (
      <>
           World-class research centers and startup incubators such as the Harvard Innovation Labs
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Access to interdisciplinary programs with MIT through the Harvard-MIT collaboration.
  ...
  },
  {
    ...
    text: (
      <>
        Global networking opportunities, cultural events, and entrepreneurship support.
      </>
    ),
  },
];
