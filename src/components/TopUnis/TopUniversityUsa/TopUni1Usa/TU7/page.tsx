...
const faqs = [
  {
    question: "What is Harvard University known for?",
    answer:
      "Harvard is known for excellence in education, research, and leadership across all disciplines.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      " Tuition ranges between $56,000 and $76,000 per year, depending on the program.",
  },
  {
    question: "Does Harvard offer scholarships for international students?",
    answer:
      "Yes - Need-based financial aid and fellowships are available to both domestic and international students.",
  },
  {
