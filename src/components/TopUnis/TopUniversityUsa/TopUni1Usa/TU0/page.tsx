    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          ...
          Founded in 1636, Harvard University is the oldest institution of higher education in the United States
and one of the most prestigious universities in the world. Known for its academic excellence, global
influence, and distinguished alumni, Harvard consistently ranks among the top 5 universities
worldwide.
            </span>
        </p>
