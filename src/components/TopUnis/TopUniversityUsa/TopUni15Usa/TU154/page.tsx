...
const REASONS = [
  {
    ...
    text: (
      <> Ann Arbor campus spans 780 acres with world-class academic and research infrastructure.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Advanced research institutes such as the Michigan Engineering Research Institute and Life
Sciences Institute.
  ...
  },
  {
    ...
    text: (
      <>
      Hatcher Graduate Library and Law Quadrangle, icons of academic excellence.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Cutting-edge tech incubators like the Center for Entrepreneurship.
  ...
  },
  {
    ...
    text: (
      <>
       1,600+ student clubs, cultural events, and NCAA Division I sports.
      </>
    ),
  },
];
