  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
       ...
       Founded in 1817, the University of Michigan (U-M) is one of the top public research universities in
the world. Known for its academic excellence, innovation, and strong alumni network, U-M
consistently ranks among the top 25 universities globally and is recognized for leadership in
engineering, business, medicine, and the arts
            </span>
        </p>
