  ...
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        U-M offers over 280 degree programs across<br/> 19 schools and colleges, including the College of<br/>
Engineering, Ross School of Business, and School <br/>of Literature, Science, and the Arts. The
university<br/> fosters a spirit of collaboration and creativity,<br/> combining academic rigor with real-world
impact<br/> in research, entrepreneurship, and global engagement.
