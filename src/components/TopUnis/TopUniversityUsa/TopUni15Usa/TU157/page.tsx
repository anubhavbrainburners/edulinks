...
const faqs = [
  {
    question: "What is the University of Michigan known for?",
    answer:
      "U-M is known for excellence in engineering, business, medicine, and social sciences, with a strong focus on research and innovation.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Fees range between US $54,000 - 75,000 per year, depending on the program.",
  },
  {
    question: "  Does the University of Michigan offer scholarships for international students?",
    answer:
      "Yes - Merit-based awards and research assistantships are available to eligible students.",
  },
  {
