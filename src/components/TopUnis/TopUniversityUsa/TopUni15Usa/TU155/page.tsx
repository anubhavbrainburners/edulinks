...
export default function TU155() {
  const cards: Card[] = [
    {
      ...
      body: (
        <>
        Top-ranked U.S. public university for research funding.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Students from over <br/>120 countries create a vibrant campus community.
    ...
    },
    {
      ...
      body: (
        <>
          A96% of graduates <br/>employed or in further study within six months.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         Ann Arbor offers arts, culture, <br/>and innovation in a student-friendly environment.
  ...
  return (
    <main className="px-6 py-12 mt-35">
      ...
      Life at University of Michigan
