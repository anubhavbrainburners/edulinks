...
const ITEMS: Item[] = [
  ...
  { id: 2, label: <>Ross School of Business</> },
  { id: 3, label: <>College of Literature, Science, and the Arts</> },
 
  { id: 4, label: <>Medical School</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Management (MM)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                         1 year
                        </div>
