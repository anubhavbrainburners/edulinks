...
const points = [
  {
    text: "Ranked #21 in QS World University Rankings 2025.",
    style: "absolute left-[-16%] top-[25%] w-[30%] text-right",
  },
  {
    text: "Around 51,000 students, including 18% international students from 120+ countries.",
    style: "absolute left-[15%] top-[-7%] w-[35%] text-center",
  },
  {
    text: "Located in Ann Arbor, one of the top college towns in the U.S.",
    style: "absolute left-[54%] top-[20%] w-[40%] text-left",
  },
  {
    text: "#10 globally for graduate employability (QS 2025).",
    style: "absolute left-[40%] top-[80%] w-[26%] text-center",
  },
  {
    text: "Home to 26 Nobel laureates and leaders across technology, medicine, and business.",
