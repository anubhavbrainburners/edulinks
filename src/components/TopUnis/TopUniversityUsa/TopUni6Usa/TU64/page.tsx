...
const REASONS = [
  {
    ...
    text: (
      <> 600-acre residential campus with Gothic and modern architecture.
  ...
  },
  {
    ...
    text: (
      <>
       Advanced research centers in quantum science, energy, and public policy.
  ...
  },
  {
    ...
    text: (
      <>
        Access to collaborative programs with Harvard, Yale, and MIT.
  ...
  },
  {
    ...
    text: (
      <>
         On-campus accommodation for nearly all undergraduates and many postgraduates.
      </>
    ),
  },
];
