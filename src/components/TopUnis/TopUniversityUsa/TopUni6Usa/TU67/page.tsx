...
const faqs = [
  {
    question: "What is Princeton University known for?",
    answer:
      "Princeton is known for excellence in teaching, research, and leadership development across sciences, humanities, and social sciences.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition ranges between US $58,000 - 62,000 per year, depending on the program.",
  },
  {
    question: " Does Princeton offer scholarships for international students?",
    answer:
      "Yes - Princeton offers need-based financial aid and fully funded PhD programs to all admitted students.",
  },
  {
