...
const ITEMS: Item[] = [
  { id: 1, label: <>School of Engineering and Applied Science</> },
  { id: 2, label: <>Princeton School of Public and International Affairs</> },
  { id: 3, label: <>Department of Economics</> },
 
  { id: 4, label: <>Princeton Graduate School</> },
];
