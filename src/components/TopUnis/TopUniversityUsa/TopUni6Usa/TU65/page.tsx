  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
          A balance of rigorous <br/>academics and vibrant campus culture.
    ...
    },
    {
      ...
      body: (
        <>
         Residential college <br/>system that fosters belonging and mentorship.
    ...
    },
    {
      ...
      body: (
        <>
        Graduates placed in<br/> leading firms, academia, and public service globally.
