  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
          Strong emphasis on interdisciplinary programs
        </>
      ),
    },
    {
      ...
      body: (
        <>
       Students from over<br/> 100 countries foster an inclusive community.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         96% of graduates <br/>employed or in graduate programs within six months
        </>
      ),
    },
    {
      ...
      body: (
        <>
           Chicago proximity offers <br/>global corporate, research, and cultural opportunities.
