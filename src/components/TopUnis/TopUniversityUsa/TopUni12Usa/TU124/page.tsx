...
const REASONS = [
  {
    ...
    text: (
      <>Evanston campus (240 acres) on Lake Michigan's shore, offering scenic beauty and cutting-edge
facilities.
  ...
  },
  {
    ...
    text: (
      <>
        Technological Institute, one of the largest academic buildings in the U.S.
  ...
  },
  {
    ...
    text: (
      <>
         Access to Northwestern Memorial Hospital and Feinberg Research Institute for medical studies
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Advanced media and communication facilities through the Medill School.
  ...
  },
  {
    ...
    text: (
      <>
      Over 500 student organizations, research labs, libraries, and performing arts venues.
