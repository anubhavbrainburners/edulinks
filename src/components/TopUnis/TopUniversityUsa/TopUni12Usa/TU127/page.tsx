...
const faqs = [
  {
    question: "What is Northwestern University known for?",
    answer:
      "Northwestern is known for research excellence, innovation, and world-class programs in business, journalism, medicine, and engineering.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      " Tuition ranges between US $63,000 - 81,000 per year, depending on the program.",
  },
  {
    question: " Does Northwestern offer scholarships for international students?",
    answer:
      "Yes - Northwestern provides need-based financial aid and merit-based scholarships for eligible international students.",
  },
  {
