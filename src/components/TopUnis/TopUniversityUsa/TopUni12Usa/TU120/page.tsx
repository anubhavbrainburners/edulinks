  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
       ...
       Founded in 1851, Northwestern University is one of America's leading private research universities,
known for academic excellence, interdisciplinary innovation, and a strong global presence.
Consistently ranked among the top 30 universities worldwide, Northwestern offers a balance of
rigorous academics and creative exploration.
