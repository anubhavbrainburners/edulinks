...
const ITEMS: Item[] = [
  { id: 1, label: <>McCormick School of Engineering</> },
  { id: 2, label: <>Kellogg School of Management</> },
  { id: 3, label: <>Medill School of Journalism</> },
 
  { id: 4, label: <>Feinberg School of Medicine</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Science in Management Studies (MSMS)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 year
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                           GMAT/GRE + Bachelor's in Business
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Fall
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                         GRE + Bachelor's in any discipline
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           Fall
                        </div>
