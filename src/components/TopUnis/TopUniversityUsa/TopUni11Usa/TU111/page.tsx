...
export default function TU111() {
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      ...
      JHU offers over 260 undergraduate and <br/>graduate programs across its nine academic <br/>divisions,
including the Krieger School of Arts<br/> & Sciences, the Whiting School of Engineering,<br/> and the
world-renowned Johns Hopkins School of<br/> Medicine. The university's core philosophy - <br/>'Knowledge
for the world' - drives its emphasis on <br/>real-world impact through research, innovation, and<br/>
collaboration.
