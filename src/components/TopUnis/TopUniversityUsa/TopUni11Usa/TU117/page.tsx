...
const faqs = [
  {
    question: "What is Johns Hopkins University known for?",
    answer:
      "JHU is known for leadership in medicine, public health, engineering, and international research.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition ranges between US $61,000 - 71,000 per year, depending on the program.",
  },
  {
    question: " Does JHU offer scholarships for international students?",
    answer:
      "Yes - JHU provides need-based aid, research fellowships, and merit scholarships.",
  },
  {
