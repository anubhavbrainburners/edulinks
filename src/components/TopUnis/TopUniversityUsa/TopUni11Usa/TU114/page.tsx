...
const REASONS = [
  {
    ...
    text: (
      <>  Homewood Campus in Baltimore, with historic architecture and modern research centers.
  ...
  },
  {
    ...
    text: (
      <>
           Peabody Institute, one of the oldest music conservatories in the U.S.
  ...
  },
  {
    ...
    text: (
      <>
        Johns Hopkins Hospital - ranked among the top 3 hospitals in the U.S. for over 20 years.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        World-class research hubs like the Applied Physics Laboratory (APL) and Bloomberg School of
Public Health.
  ...
  },
  {
    ...
    text: (
      <>
        400+ student clubs, athletic centers, and global study-abroad opportunities
      </>
    ),
  },
];
