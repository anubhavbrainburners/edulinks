...
const ITEMS: Item[] = [
  { id: 1, label: <>Whiting School of Engineering</> },
  { id: 2, label: <>Carey Business School</> },
  { id: 3, label: <>Krieger School of Arts & Sciences</> },
 
  { id: 4, label: <>Johns Hopkins School of Medicine</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Science in Finance (MSF)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years
                        </div>
