  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
         Every student has<br/> access to hands-on research from year one.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        A truly international<br/> community of scholars and professionals.
    ...
    },
    {
      ...
      body: (
        <>
           94% of graduates employed <br/>or pursuing further education within six months.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         Diverse clubs, arts, and recreation across nine schools.
