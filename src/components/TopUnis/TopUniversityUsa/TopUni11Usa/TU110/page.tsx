...
export default function TU110() {
  ...
  return (
    ...
    >
      ...
      Founded in 1876, Johns Hopkins University (JHU) is America's first research university and a global
leader in education, research, and innovation. Known for pioneering medical research and
interdisciplinary learning, JHU consistently ranks among the top 25 universities worldwide and #1 in
the U.S. for research funding
