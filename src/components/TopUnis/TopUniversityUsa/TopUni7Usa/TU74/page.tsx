...
const REASONS = [
  {
    ...
    text: (
      <> Urban campus in Morningside Heights, New York City, with historic and modern facilities.
  ...
  },
  {
    ...
    text: (
      <>
       State-of-the-art research centers in Artificial Intelligence, Data Science, and Climate Studies.
  ...
  },
  {
    ...
    text: (
      <>
         Access to Columbia Global Centers spanning major cities worldwide.
  ...
  },
  {
    ...
    text: (
      <>
        Student housing, athletic centers, and career networking spaces integrated into campus life.
