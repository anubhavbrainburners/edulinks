...
const faqs = [
  {
    question: "What is Columbia University known for",
    answer:
      "Columbia is known for excellence in education, research, journalism, business, and the sciences.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition ranges between US $65,000 - 85,000 per year, depending on the program.",
  },
  {
    question: "  Does Columbia offer scholarships for international students?",
    answer:
      "Yes - Columbia provides need-based financial aid and merit scholarships for international students.",
  },
  {
