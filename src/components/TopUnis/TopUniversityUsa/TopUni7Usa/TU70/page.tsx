  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
       ...
       Founded in 1754, Columbia University is an Ivy League institution recognized for academic
excellence, global research leadership, and its vibrant urban setting in the heart of New York City.
Consistently ranked among the top 20 universities worldwide, Columbia offers students unmatched
opportunities in academics, innovation, and professional development.
