  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
           Study in the heart<br/> of New York City, a global business and cultural hub.
    ...
    },
    {
      ...
      body: (
        <>
          Opportunities to<br/> work on global projects and funded research.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         Students from 150+<br/> countries contribute to an inclusive campus culture.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         94% of graduates<br/> employed or in graduate school within six months.
