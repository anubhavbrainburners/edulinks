  ...
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
       ...
       UW offers over 500 academic programs<br/> through its 18 colleges and schools, including<br/> the College
of Engineering, Foster School of <br/>Business, School of Medicine, and Information<br/> School. Known for
cutting-edge research and<br/> strong ties to tech giants like Microsoft and <br/>Amazon, UW provides
world-class education<br/> and opportunities for innovation.
