...
const faqs = [
  {
    question: "What is the University of Washington known for?",
    answer:
      "UW is globally recognized for its excellence in engineering, medicine, computer science, and environmental studies.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition ranges between US $52,000 - 73,000 per year, depending on the program.",
  },
  {
    question: "Does UW offer scholarships for international students?",
    answer:
      "Yes - UW offers merit-based awards, research assistantships, and need-based aid for international students.",
  },
  {
