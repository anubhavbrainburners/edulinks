  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        Founded in 1861, the University of Washington (UW) is one of the world's leading public research
universities, globally recognized for excellence in technology, healthcare, and environmental
science. With campuses in Seattle, Tacoma, and Bothell, UW is ranked among the top 20
universities worldwide and is a hub of innovation in the Pacific Northwest
