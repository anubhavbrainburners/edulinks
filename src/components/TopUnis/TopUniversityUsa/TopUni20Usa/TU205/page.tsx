  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
           A powerhouse for tech, AI, and environmental research.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Students from 120+ <br/>countries build a culturally rich campus
        </>
      ),
    },
    {
      ...
      body: (
        <>
        96% of graduates<br/> employed or in higher studies within six months.
        </>
      ),
    },
    {
      title: "Pacific Northwest Lifestyle",
      body: (
        <>
         Access to Seattle's<br/> tech industry and breathtaking natural landscapes
