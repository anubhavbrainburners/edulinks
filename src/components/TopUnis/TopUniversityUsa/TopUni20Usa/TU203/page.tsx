...
const ITEMS: Item[] = [
  ...
  { id: 2, label: <>Foster School of Business</> },
  { id: 3, label: <>School of Medicine</> },
 
  { id: 4, label: <>Information School</> },
];
                  ...
                  {id === 1 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                              Master of Science in Electrical & Computer Engineering (ECE)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           2 years
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                           GMAT/GRE + Bachelor's in Math/Business
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           Fall
                        </div>
