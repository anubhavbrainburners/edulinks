...
const faqs = [
  {
    question: "What is Duke University known for?",
    answer:
      "Duke is known for excellence in engineering, business, public policy, and medical sciences",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "  Tuition ranges between US $64,000 - 75,000 per year, depending on the program.",
  },
  {
    question: "Does Duke offer scholarships for international students?",
    answer:
      " Yes - Duke provides need-based aid and merit scholarships for international students.",
  },
  {
