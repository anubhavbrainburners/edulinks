...
const ITEMS: Item[] = [
  { id: 1, label: <>Pratt School of Engineering</> },
  { id: 2, label: <>Fuqua School of Business</> },
  { id: 3, label: <>Trinity College of Arts & Sciences</> },
 
  { id: 4, label: <>Duke University School of Medicine</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold"> Master of Quantitative Management (MQM)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 year
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                           GMAT/GRE + Bachelor's in Business or Math
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Fall
                        </div>
