...
export default function TU161() {
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      ...
      Duke offers over 250 degree programs <br/>through its 10 schools and colleges, including<br/> the Pratt
School of Engineering, Fuqua School<br/> of Business, and Trinity College of Arts &<br/> Sciences. It's known
for its interdisciplinary focus, <br/>global engagement, and commitment to research<br/> that addresses
