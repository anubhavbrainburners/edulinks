...
const REASONS = [
  {
    ...
    text: (
      <>  8,600-acre campus in Durham with Gothic architecture and state-of-the-art facilities
  ...
  },
  {
    ...
    text: (
      <>
          Duke Chapel and Duke Gardens are iconic landmarks on campus.
  ...
  },
  {
    ...
    text: (
      <>
        Advanced research centers such as the Duke Global Health Institute and Nicholas Institute for
Environmental Policy Solutions.
  ...
  },
  {
    ...
    text: (
      <>
       Duke Innovation & Entrepreneurship Initiative fosters startups and applied research.
  ...
  },
  {
    ...
    text: (
      <>
       400+ student clubs, recreation centers, and multicultural organizations.
      </>
    ),
  },
];
