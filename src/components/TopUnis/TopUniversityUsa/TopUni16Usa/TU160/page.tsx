...
export default function TU160() {
  ...
  return (
    ...
    >
      ...
      Founded in 1838, Duke University is a leading private research university globally recognized for
academic excellence, innovation, and leadership. Ranked among the top 25 universities worldwide,
Duke offers world-class education and a vibrant campus culture in the heart of North Carolina's
Research Triangle - one of America's top innovation hubs.
