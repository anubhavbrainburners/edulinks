  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
         Strong interdisciplinary<br/> research and project-based programs.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Students from over <br/>100 countries enrich global campus life.
    ...
    },
    {
      ...
      body: (
        <>
         95% of graduates find<br/> employment or higher study within six months.
    ...
    },
    {
      ...
      body: (
        <>
          Access to Raleigh-Durham's<br/> thriving tech, healthcare, and innovation network.
