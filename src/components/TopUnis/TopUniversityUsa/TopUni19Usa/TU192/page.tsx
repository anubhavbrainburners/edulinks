...
const points = [
  {
    text: "Ranked #63 in QS World University Rankings 2025.",
    style: "absolute left-[-16%] top-[25%] w-[30%] text-right",
  },
  {
    text: "Around 10,700 students, including 21% international students from 100+ countries.",
    style: "absolute left-[15%] top-[-7%] w-[35%] text-center",
  },
  {
    text: "Located in Providence, Rhode Island, a vibrant academic and cultural hub in New England.",
    style: "absolute left-[54%] top-[20%] w-[38%] text-left",
  },
  {
    text: "#14 globally for graduate employability (QS 2025).",
    style: "absolute left-[40%] top-[80%] w-[28%] text-center",
  },
  {
    text: "Home to 8 Nobel laureates and pioneers in science, medicine, and the humanities.",
    style: "absolute right-[-11%] top-[63%] w-[35%] text-left",
  },
];

export default function TU192() {
  return (
