...
export default function TU191() {
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      ...
      Brown offers over 2,000 courses across<br/> its eight schools, including the School of <br/>Engineering,
School of Public Health, and the<br/> renowned Alpert Medical School. Its Open<br/> Curriculum allows
undergraduates to design their <br/>own academic paths, encouraging curiosity,<br/> exploration, and
