  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
         Students design their own<br/> academic journey without required core subjects.
    ...
    },
    {
      ...
      body: (
        <>
          Active undergraduate <br/> participation in faculty research.
    ...
    },
    {
      ...
      body: (
        <>
          94% of graduates secure<br/> jobs or pursue higher education within six months.
