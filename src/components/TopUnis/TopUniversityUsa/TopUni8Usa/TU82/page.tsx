...
const points = [
  {
    text: "Ranked #12 in QS World University Rankings 2025.",
    style: "absolute left-[-16%] top-[25%] w-[30%] text-right",
  },
  {
    text: " Around 13,500 students, including 22% international students from 120+ countries.",
    style: "absolute left-[15%] top-[-7%] w-[35%] text-center",
  },
  {
    text: "Located in New Haven, Connecticut, with close proximity to New York City and Boston.",
    style: "absolute left-[54%] top-[20%] w-[35%] text-left",
  },
  {
    text: " #9 globally for graduate employability (QS 2025).",
    style: "absolute left-[40%] top-[80%] w-[26%] text-center",
  },
  {
    text: "Alumni include 65 Nobel laureates, 5 U.S. Presidents, and leaders in every field.",
    style: "absolute right-[-11%] top-[63%] w-[31%] text-left",
  },
];

export default function TU82() {
  return (
