...
const ITEMS: Item[] = [
  { id: 1, label: <>School of Engineering & Applied Science</> },
  { id: 2, label: <>Yale School of Management</> },
  
 
  { id: 3, label: <>Graduate School of Arts & Sciences</> },
  { id: 4, label: <>Yale School of Medicine</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Advanced Management (MAM)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 year
                        </div>
