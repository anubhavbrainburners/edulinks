...
export default function TU80() {
  ...
  return (
    ...
    >
      ...
      Founded in 1701, Yale University is a member of the Ivy League and one of the world's most
prestigious institutions. Renowned for its tradition of academic excellence, interdisciplinary research,
and global influence, Yale consistently ranks among the top 15 universities worldwide.
