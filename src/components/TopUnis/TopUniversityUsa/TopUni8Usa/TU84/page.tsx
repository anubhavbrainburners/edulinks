...
const REASONS = [
  {
    ...
    text: (
      <>  373-acre Gothic campus in New Haven with historic charm and modern research facilities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Sterling Memorial Library with over 15 million volumes
  ...
  },
  {
    ...
    text: (
      <>
       Home to the Yale Center for Engineering Innovation & Design (CEID) and world-class labs.
  ...
  },
  {
    ...
    text: (
      <>
        Access to Yale University Art Gallery and Peabody Museum of Natural History.
  ...
  },
  {
    ...
    text: (
      <>
        On-campus housing and vibrant student communities across 14 residential colleges.
