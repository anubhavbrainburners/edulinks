  ...
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
       ...
       NYU offers over 400 programs through<br/> its 15 schools and colleges, including the<br/> Stern School of
Business, Tandon School of <br/>Engineering, Tisch School of the Arts, and <br/>the College of Arts &
Science. With a global <br/>network of campuses in Abu Dhabi, Shanghai,<br/> and 12 academic centers
worldwide, NYU <br/>provides a truly international learning<br/> experience.
