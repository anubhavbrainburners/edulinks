...
const REASONS = [
  {
    ...
    text: (
      <>Urban campus located around Washington Square Park and Brooklyn, at the heart of New York
City
      </>
    ),
  },
  {
    ...
    text: (
      <>
       State-of-the-art labs and creative studios at the Tandon School of Engineering and Tisch School of
the Arts
  ...
  },
  {
    ...
    text: (
      <>
       Elmer Holmes Bobst Library - one of the largest academic libraries in the U.S.
      </>
    ),
  },
  {
    ...
    text: (
      <>
         Global academic network with campuses in Abu Dhabi and Shanghai.
  ...
  },
  {
    ...
    text: (
      <>
       300+ student clubs, cultural organizations, and global exchange programs.
      </>
    ),
  },
];
