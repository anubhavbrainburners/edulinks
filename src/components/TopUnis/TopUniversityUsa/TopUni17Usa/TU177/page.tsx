...
const faqs = [
  {
    question: "What is NYU known for?",
    answer:
      "NYU is known for excellence in business, technology, performing arts, and international education.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition ranges between US $60,000 - 84,000 per year, depending on the program.",
  },
  {
    question: "Does NYU offer scholarships for international students?",
    answer:
      "Yes - NYU offers need-based financial aid and merit scholarships for qualified international students",
  },
  {
