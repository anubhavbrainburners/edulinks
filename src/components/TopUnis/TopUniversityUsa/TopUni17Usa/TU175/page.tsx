...
export default function TU175() {
  const cards: Card[] = [
    {
      title: "Global City Experience",
      body: (
        <>
         Study in Manhattan,<br/> surrounded by world-leading companies and culture
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Students from 130+<br/> countries create an inclusive, international campus.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          96% of graduates employed <br/>or in higher studies within six months.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         Perfect environment<br/> for business, technology, and the arts.
