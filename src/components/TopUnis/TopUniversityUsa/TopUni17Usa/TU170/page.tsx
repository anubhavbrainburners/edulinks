    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
         ...
         Founded in 1831, New York University (NYU) is one of the world's largest and most prestigious
private research universities. Known for its global campuses, academic excellence, and industry
connections, NYU ranks among the top 30 universities worldwide and offers unparalleled
opportunities in business, technology, and the arts - right in the heart of New York City
