...
const points = [
  {
    text: "Ranked #27 in QS World University Rankings 2025.",
    style: "absolute left-[-16%] top-[25%] w-[30%] text-right",
  },
  {
    text: "Over 60,000 students, including 24% international students from 130+ countries",
    style: "absolute left-[15%] top-[-7%] w-[35%] text-center",
  },
  {
    text: "Located in Manhattan, New York City - a global hub for finance, tech, and creativity.",
  ...
  {
    text: "Home to 40+ Nobel laureates and renowned alumni in arts, business, and science.",
