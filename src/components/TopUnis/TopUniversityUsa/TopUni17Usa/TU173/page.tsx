...
const ITEMS: Item[] = [
  { id: 1, label: <>Tandon School of Engineering</> },
  { id: 2, label: <>Stern School of Business</> },
  { id: 3, label: <>Tisch School of the Arts</> },
 
  { id: 4, label: <>College of Arts & Science</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Science in Finance</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 year 
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          GMAT/GRE + Bachelor's in Business/Economics
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           Fall
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            Bachelor of Fine Arts (BFA) in Film & Television
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          4 years
