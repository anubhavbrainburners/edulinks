  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
         A culture driven by <br/>curiosity and cross-disciplinary learning.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         Students from 120+<br/> countries, fostering cultural exchange and inclusivity.
        </>
      ),
    },
    {
      ...
      body: (
        <>
       95% of graduates employed <br/>or in higher studies within six months.
    ...
    },
    {
      ...
      body: (
        <>
         One of the most picturesque campuses<br/> in the U.S., blending nature and
technology.
