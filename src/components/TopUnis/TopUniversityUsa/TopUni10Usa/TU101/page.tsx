...
export default function TU101() {
  return (
    <section className="max-w-full py-12 px-40 mt-30">
     ...
     Cornell offers over 4,000 courses across <br/>its eight undergraduate colleges and four<br/> graduate and
professional schools, including<br/> the College of Engineering, the College of <br/>Arts and Sciences, and
the Johnson Graduate<br/> School of Management. The university's <br/>collaborative approach and
world-class<br/> faculty make it one of the most diverse and<br/> forward-thinking campuses in the world.
