...
const faqs = [
  {
    question: "What is Cornell University known for?",
    answer:
      "DCornell is known for academic excellence, research innovation, and offering a wide range of programs across disciplines.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition ranges between US $64,000 - 83,000 per year, depending on the program.",
  },
  {
    question: "Does Cornell offer scholarships for international students?",
    answer:
      "Yes - Cornell provides need-based financial aid and merit scholarships for international students.",
  },
  {
