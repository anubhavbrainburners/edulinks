...
const ITEMS: Item[] = [
  ...
  { id: 2, label: <> SC Johnson College of Business</> },
  { id: 3, label: <>College of Agriculture and Life Sciences</> },
 
  { id: 4, label: <>Cornell Tech (Graduate Campus - NYC)</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Professional Studies (MPS) in Management</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 year 
                        </div>
