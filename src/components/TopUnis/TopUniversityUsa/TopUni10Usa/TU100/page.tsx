  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
       ...
       Founded in 1865, Cornell University is an Ivy League institution known for its unique combination of
academic excellence, research innovation, and inclusivity. With a mission to make education 'any
person... any study,' Cornell ranks among the top 20 universities worldwide and is globally
recognized for its programs in engineering, business, and life sciences.
