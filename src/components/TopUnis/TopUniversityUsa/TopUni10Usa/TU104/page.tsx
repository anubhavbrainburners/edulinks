...
const REASONS = [
  {
    ...
    text: (
      <>2,300-acre campus in Ithaca with waterfalls, lakes, and cutting-edge research labs.
  ...
  },
  {
    ...
    text: (
      <>
         Advanced research centers like the Cornell NanoScale Science & Technology Facility and Cornell
High Energy Synchrotron Source (CHESS).
  ...
  },
  {
    ...
    text: (
      <>
        Carl A. Kroch Library and Cornell Botanic Gardens, combining academics with nature
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Global presence through Cornell Tech in New York City and international partnerships
  ...
  },
  {
    ...
    text: (
      <>
       Extensive housing, student life centers, and over 1,000 student organizations.
