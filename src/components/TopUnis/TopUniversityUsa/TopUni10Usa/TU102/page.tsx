...
const points = [
  ...
  {
    text: "Over 25,000 students, including 24% international students from 120+ countries",
    style: "absolute left-[15%] top-[-7%] w-[37%] text-center",
  },
  {
    text: "Located in Ithaca, New York, one of the most beautiful college towns in the U.S.",
    style: "absolute left-[54%] top-[20%] w-[30%] text-left",
  },
  {
    text: "#15 globally for graduate employability (QS 2025).",
    style: "absolute left-[40%] top-[80%] w-[30%] text-center",
  },
  {
    text: "Home to 61 Nobel laureates and pioneers in science, engineering, and business.",
