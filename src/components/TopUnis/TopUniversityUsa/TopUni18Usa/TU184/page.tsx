...
const REASONS = [
  {
    ...
    text: (
      <>140-acre urban campus in Pittsburgh's Oakland neighborhood, with cutting-edge research labs
and centers.
  ...
  },
  {
    ...
    text: (
      <>
          Robotics Institute and Human-Computer Interaction Institute - world leaders in tech innovation.
  ...
  },
  {
    ...
    text: (
      <>
        Hunt Library and Mellon College of Science Research Facilities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
     Collaboration spaces for entrepreneurship, art, and design through the CMU VentureBridge
accelerator
      </>
    ),
  },
  {
    ...
    text: (
      <>
       400+ student clubs, residence halls, sports facilities, and creative spaces.
