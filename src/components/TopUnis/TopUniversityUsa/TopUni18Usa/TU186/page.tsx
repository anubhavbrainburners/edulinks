            ...
            <div className="absolute top-1/2 left-0 transform -translate-y-1/2 w-full flex justify-end items-center">
              ...
              <div className="text-white text-lg max-w-[380px] leading-relaxed mr-30">
                <ul className="list-disc space-y-1">
                  <li>
                        Academic: High school diploma with top grades in Math, Science, and Computing.
                  </li>
                  <li>
                   ...
                   <li>
                   Documents: Essays, recommendation letters, transcripts, and activity record
        ...
        <div className="relative flex justify-start">
          ...
          <div className="absolute top-1/2 left-0 transform -translate-y-1/2 w-full flex justify-start items-center">
            ...
            <div className="text-black text-lg max-w-[410px] leading-relaxed ml-46">
              <ul className="list-disc space-y-1">
                <li>
                    Academic: Bachelor's degree in a relevant discipline.

                </li>
                <li>
                  Tests: GRE/GMAT depending on program
                </li>
                <li>
                   Documents: SOP, Letters of Recommendation, Resume/CV, and Research/Portfolio (if applicable).
                </li>
              </ul>
            </div>
