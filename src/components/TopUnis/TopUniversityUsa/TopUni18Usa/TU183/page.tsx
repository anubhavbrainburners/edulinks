...
const ITEMS: Item[] = [
  { id: 1, label: <>School of Computer Science</> },
  { id: 2, label: <>Tepper School of Business</> },
  { id: 3, label: <>College of Engineering</> },
 
  { id: 4, label: <>College of Fine Arts</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 1 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                           GRE + Bachelor's in CS/Engineering 
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           Fall
                        </div>
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Science in Business Analytics (MSBA)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 year
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                           GMAT/GRE + Bachelor's in Business/Math
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           Fall
                        </div>
