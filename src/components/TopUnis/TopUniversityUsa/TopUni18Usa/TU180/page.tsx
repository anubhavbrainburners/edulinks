    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
       ...
       Carnegie Mellon University (CMU)
        ...
        Founded in 1900, Carnegie Mellon University (CMU) is a world leader in computer science,
engineering, business, and the arts. Known for its culture of innovation and interdisciplinary
excellence, CMU consistently ranks among the top 25 universities globally, blending technical
expertise with creativity and entrepreneurship.
