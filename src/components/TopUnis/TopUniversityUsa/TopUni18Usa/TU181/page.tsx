  ...
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
       ...
       CMU offers over 200 programs through<br/> its seven academic colleges, including the<br/> School of
Computer Science, College of <br/>Engineering, Tepper School of Business, and <br/>the College of Fine
Arts. The university's<br/> strong focus on research, innovation, and global <br/>collaboration attracts students
and faculty<br/> from over 100 countries.
