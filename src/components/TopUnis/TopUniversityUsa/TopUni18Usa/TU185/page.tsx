  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
         A top destination <br/>for AI, robotics, and data science research.
    ...
    },
    {
      ...
      body: (
        <>
        Students often combine<br/> engineering, business, and design.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        95% of graduates<br/> employed or in higher studies within six months.
    ...
    },
    {
      ...
      body: (
        <>
       Strong ties with<br/> industry leaders like Google, Apple, and IBM.
