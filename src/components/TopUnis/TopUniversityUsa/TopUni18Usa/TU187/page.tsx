...
const faqs = [
  {
    question: "What is Carnegie Mellon University known for?",
    answer:
      "CMU is globally known for excellence in computer science, engineering, business, design, and performing arts",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition ranges between US $60,000 - 74,000 per year, depending on the program.",
  },
  {
    question: "Does CMU offer scholarships for international students?",
    answer:
      "Yes - CMU provides merit-based scholarships and research assistantships for international students.",
  },
  {
