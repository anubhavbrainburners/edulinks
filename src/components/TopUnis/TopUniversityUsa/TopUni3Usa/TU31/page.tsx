  ...
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
       ...
       MIT offers over 100 degree programs across<br/> its five schools - Engineering, Science, Architecture<br/>
and Planning, Management, and Humanities, Arts<br/> & Social Sciences. The institute emphasizes
creativity,<br/> research, and collaboration, fostering a global community<br/> of thinkers, inventors, and
entrepreneurs.
