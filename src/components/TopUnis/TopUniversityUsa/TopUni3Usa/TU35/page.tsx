  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
           A global hub for science, <br/>engineering, and entrepreneurship.
    ...
    },
    {
      ...
      body: (
        <>
         Interdisciplinary learning <br/>and group-driven problem solving.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Students from 150+<br/> countries create a vibrant campus life
        </>
      ),
    },
    {
      ...
      body: (
        <>
        95% of graduates secure<br/> employment or higher studies within six months
        </>
      ),
    },
  ];
