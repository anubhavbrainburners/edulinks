...
const ITEMS: Item[] = [
  ...
  { id: 2, label: <>Sloan School of Management</> },
  { id: 3, label: <>School of Science</> },
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 1 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            MS in Electrical Engineering and Computer Science (EECS)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           2 years
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Finance (MFin)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            Master of Data, Economics, and Development Policy (DEDP)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1.5 years
