...
const faqs = [
  {
    ...
    answer:
      " MIT is known for innovation, research, and entrepreneurship across science and technology.",
  },
  {
    question: " What are the tuition fees for international students?",
    answer:
      "Fees range between US $60,000 - 85,000 per year, depending on the program.",
  },
  {
    question: "Does MIT offer scholarships for international students?",
    answer:
      " Yes - Need-based financial aid and fellowships are available to all admitted students..",
  },
  {
