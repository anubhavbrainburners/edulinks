...
const REASONS = [
  {
    ...
    text: (
      <>168-acre campus along the Charles River with advanced research and learning spaces.
      </>
    ),
  },
  {
    ...
    text: (
      <>
         World-renowned centers like MIT Media Lab, CSAIL, and Lincoln Laboratory
      </>
    ),
  },
  {
    ...
    text: (
      <>
      19 libraries and extensive digital archives for students and researchers.
  ...
  },
  {
    ...
    text: (
      <>
        Strong entrepreneurship ecosystem via the Martin Trust Center for MIT Entrepreneurship
  ...
  },
  {
    ...
    text: (
      <>
        On-campus housing, recreation, and cultural facilities for all students.
      </>
    ),
  },
];
