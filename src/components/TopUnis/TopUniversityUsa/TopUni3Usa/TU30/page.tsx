    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
       ...
       Massachusetts Institute of Technology (MIT)
        ...
        Founded in 1861, the Massachusetts Institute of Technology (MIT) is a world-leading institution
dedicated to advancing knowledge and solving real-world challenges. Known for its culture of
innovation and scientific excellence, MIT consistently ranks #1 globally in higher education.
