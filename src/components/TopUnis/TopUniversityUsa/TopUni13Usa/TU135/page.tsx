  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
          Proximity to Silicon Valley <br/>fosters entrepreneurship and tech collaboration.
        </>
      ),
    },
    {
      ...
      body: (
        <>
       Students from<br/> 100+ countries enrich a diverse campus culture.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Top public university for research funding and impact.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          95% of graduates<br/> secure jobs or further study within six months.
