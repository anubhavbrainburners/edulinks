...
const faqs = [
  {
    question: "What is UC Berkeley known for?",
    answer:
     "UC Berkeley is renowned for excellence in engineering, business, computer science, and social sciences.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Fees range between US $53,000 - 84,000 per year, depending on the program.",
  },
  {
    question: "Does UC Berkeley offer scholarships for international students?",
    answer:
      "Yes - Merit and need-based scholarships, plus research fellowships are available.",
  },
  {
