...
const REASONS = [
  {
    ...
    text: (
      <>1,232-acre campus overlooking the San Francisco Bay.
  ...
  },
  {
    ...
    text: (
      <>
          World-class research facilities such as the Lawrence Berkeley National Laboratory.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Doe Library and Bancroft Library, housing millions of volumes and digital resources
      </>
    ),
  },
  {
    ...
    text: (
      <>
      Cutting-edge innovation ecosystem through Berkeley SkyDeck Accelerator and startup initiatives.
  ...
  },
  {
    ...
    text: (
      <>
   Vibrant student life with 1,200+ clubs, performing arts, and cultural events.
      </>
    ),
  },
];
