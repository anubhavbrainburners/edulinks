  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
       ...
       Founded in 1868, the University of California, Berkeley is one of the world's premier public
universities and a global center for research, innovation, and social impact. Ranked among the top
10 universities globally, UC Berkeley is celebrated for its academic rigor, groundbreaking research,
and vibrant campus life in the heart of the San Francisco Bay Area
