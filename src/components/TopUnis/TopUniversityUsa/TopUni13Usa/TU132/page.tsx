...
const points = [
  {
    text: "Ranked #10 in QS World University Rankings 2025",
    style: "absolute left-[-16%] top-[25%] w-[30%] text-right",
  },
  {
    text: " Around 43,000 students, including 17% international students from 100+ countries.",
    style: "absolute left-[15%] top-[-7%] w-[36%] text-center",
  },
  {
    text: "Located in the San Francisco Bay Area - a global hub for technology and innovation.",
    style: "absolute left-[54%] top-[20%] w-[36%] text-left",
  },
  {
    text: " #5 globally for graduate employability (QS 2025).",
    style: "absolute left-[40%] top-[80%] w-[26%] text-center",
  },
  {
    text: "Home to 114 Nobel laureates and pioneers in science, technology, and entrepreneurship",
