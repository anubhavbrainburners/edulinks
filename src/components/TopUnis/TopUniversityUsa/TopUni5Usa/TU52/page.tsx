...
const points = [
  {
    text: "Ranked #9 in QS World University Rankings 2025.",
    style: "absolute left-[-16%] top-[25%] w-[30%] text-right",
  },
  {
    text: " Over 18,000 students, including 26% international students.",
    style: "absolute left-[15%] top-[-7%] w-[30%] text-center",
  },
  {
    text: "Located in Chicago, Illinois - a global financial, cultural, and innovation hub",
  ...
  {
    text: "Home to 100+ Nobel laureates and distinguished faculty across all fields.",
