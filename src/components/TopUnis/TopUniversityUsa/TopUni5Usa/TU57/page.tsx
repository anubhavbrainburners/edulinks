...
const faqs = [
  {
    question: "What is the University of Chicago known for?",
    answer:
      "Chicago is known for research excellence, academic rigor, and producing leaders in economics,law, science, and business.",
  },
  {
  ...
  {
    question: "  Does UChicago offer scholarships for international students?",
    answer:
