...
export default function TU55() {
  const cards: Card[] = [
    {
      title: "Academically Intense",
      body: (
        <>
         Renowned for<br/> intellectual curiosity and rigorous programs.
    ...
    },
    {
      ...
      body: (
        <>
          Students from 100+<br/> countries form a vibrant international community.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Among top U.S. universities<br/> for post-graduate employment and salaries.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Access to Chicago's <br/>thriving business, culture, and tech ecosystems
