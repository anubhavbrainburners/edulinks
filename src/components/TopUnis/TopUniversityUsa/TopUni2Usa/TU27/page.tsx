...
const faqs = [
  {
    question: "What is Stanford University known for?",
    answer:
      "Stanford is known for technology, innovation, entrepreneurship, and world-leading research.",
  },
  {
    question: " What are the tuition fees for international students?",
    answer:
      "Fees range between $60,000 and $80,000 per year depending on the program.",
  },
  {
    question: "Does Stanford offer scholarships for international students?",
    answer:
      "Yes - Need-based financial aid and merit-based fellowships are available.",
  },
  {
