    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          ...
          Founded in 1885, Stanford University is one of the world's leading research and innovation-driven
universities. Known for its academic excellence, entrepreneurial culture, and strong ties to Silicon
Valley, Stanford consistently ranks among the top 5 universities globally
            </span>
        </p>
