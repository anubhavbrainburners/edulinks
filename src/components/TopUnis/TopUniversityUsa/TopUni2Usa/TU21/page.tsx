      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
           Stanford offers over 200 degree programs <br/>across its seven schools, including Engineering,<br/>
Business, Law, Medicine, Humanities, and<br/> Education. The university promotes interdisciplinary<br/>
collaboration and cutting-edge research, making it a<br/> global hub for technology, science, and
innovation.
