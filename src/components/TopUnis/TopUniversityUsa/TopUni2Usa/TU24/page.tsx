...
const REASONS = [
  {
    ...
    text: (
      <>
         8,180-acre campus with world-class architecture, research facilities, and art museums.
  ...
  },
  {
    ...
    text: (
      <>
           Stanford Libraries house over 9 million volumes and digital archives
      </>
    ),
  },
  {
    ...
    text: (
      <>
           Home to research centers like SLAC National Accelerator Laboratory and Hoover Institution
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Advanced startup and innovation resources through the Stanford Technology Ventures Program
  ...
  },
  {
    ...
    text: (
      <>
        On-campus residences, recreation centers, and multicultural student organizations.
      </>
    ),
  },
];
