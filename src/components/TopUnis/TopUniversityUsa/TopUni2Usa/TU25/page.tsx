  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <> Hub for global technology <br/>and entrepreneurship.
Students from 120+ countries
    ...
    },
    {
      ...
      body: (
        <>
          Ranked among top<br/> universities for graduate employability.
    ...
    },
    {
      ...
      body: (
        <>
          Extensive arts, sports, and research opportunities
        </>
      ),
    },
  ];
