...
const ITEMS: Item[] = [
  { id: 1, label: <>School of Engineering</> },
  { id: 2, label: <>Graduate School of Business</> },
  { id: 3, label: <>School of Humanities and Sciences</> },
 
  { id: 4, label: <>School of Medicine</> },
  { id: 5, label: <>School of Law</> },
                  ...
                  {id === 1 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                           Requirement: GRE + Bachelor's in Engineering
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                            Intake: Fall
                        </div>
