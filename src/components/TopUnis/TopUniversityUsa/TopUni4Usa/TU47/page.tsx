...
const faqs = [
  {
    question: " What is Caltech known for?",
    answer:
      "Caltech is known for cutting-edge research in science, technology, and engineering, and for managing NASA's Jet Propulsion Laboratory.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition is approximately US $65,622/year, with total annual costs around US $93,900 including living expenses.",
  },
  {
    question: " Does Caltech offer scholarships for international students?",
    answer:
      "Yes - Caltech provides need-based financial aid and research fellowships for qualified international students.",
  },
  {
