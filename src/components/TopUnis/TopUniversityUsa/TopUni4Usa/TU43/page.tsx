...
const ITEMS: Item[] = [
  { id: 1, label: <>Division of Engineering and Applied Science</> },
  { id: 2, label: <>Division of Physics, Mathematics, and Astronomy</> },
  { id: 3, label: <>Division of Chemistry and Chemical Engineering</> },
 
  { id: 4, label: <>Division of Biology and Biological Engineering</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">PhD in Astrophysics</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          5 years
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          GRE + Bachelor's in Chemistry/Engineering 
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           Intake: Fall
