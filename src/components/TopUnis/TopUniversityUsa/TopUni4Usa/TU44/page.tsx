...
const REASONS = [
  {
    ...
    text: (
      <>124-acre campus in Pasadena, California, with world-class labs and research centers.
  ...
  },
  {
    ...
    text: (
      <>
        Home to NASA's Jet Propulsion Laboratory (JPL) - managed by Caltech
  ...
  },
  {
    ...
    text: (
      <>
       Millikan Library and numerous specialized science libraries and archives
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Advanced research facilities in quantum computing, space science, and robotics.
  ...
  },
  {
    ...
    text: (
      <>
        On-campus housing, modern labs, and student innovation spaces.
      </>
    ),
  },
];
