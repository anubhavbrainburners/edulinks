  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
         Focused on exploration, discovery, and innovation.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Small student body<br/> fosters close collaboration with professors
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Research partnerships <br/>with NASA, JPL, and tech leaders worldwide.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Among the highest<br/> global graduate employability rates.
