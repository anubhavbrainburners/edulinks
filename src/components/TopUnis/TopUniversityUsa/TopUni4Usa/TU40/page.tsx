    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
         ...
         Founded in 1891, the California Institute of Technology (Caltech) is one of the world's most
prestigious universities, renowned for its strength in science, engineering, and technology. With a
strong focus on research, innovation, and discovery, Caltech consistently ranks among the top 10
