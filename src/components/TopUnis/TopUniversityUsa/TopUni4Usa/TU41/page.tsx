  ...
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        Caltech offers a wide range of programs in science<br/> and engineering, focusing on hands-on
research, <br/>innovation, and academic excellence. With a student<br/>-to-faculty ratio of 3:1, Caltech
provides an intimate <br/>learning environment that encourages creativity, <br/>collaboration, and critical
thinking.
