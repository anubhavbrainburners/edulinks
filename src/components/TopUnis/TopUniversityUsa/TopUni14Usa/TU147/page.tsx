...
const faqs = [
  {
    ...
    answer:
      " UCLA is known for world-class research, innovation, and programs in engineering, business, film, medicine, and the arts.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition ranges between US $43,000 - 79,000 per year, depending on the program.",
  },
  {
    question: "Does UCLA offer scholarships for international students?",
    answer:
      "Yes - UCLA offers merit-based awards and research fellowships for exceptional international students",
  },
  {
