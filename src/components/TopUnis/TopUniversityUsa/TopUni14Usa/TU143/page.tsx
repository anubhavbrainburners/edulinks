...
const ITEMS: Item[] = [
  { id: 1, label: <>Henry Samueli School of Engineering</> },
  { id: 2, label: <>UCLA Anderson School of Management</> },
  { id: 3, label: <>College of Letters & Science</> },
 
  { id: 4, label: <>David Geffen School of Medicine</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold"> Master of Financial Engineering (MFE)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                         1 year
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                           GRE/GMAT + Bachelor's in Math/Finance
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           Fall
                        </div>
