  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
        Students from 120+ <br/>countries bring diverse perspectives to campus life.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         Top-ranked public<br/> university for research productivity and innovation.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          94% of graduates<br/> secure jobs or further study within six months.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         Access to Hollywood, <br/>Silicon Beach, and major global industries.
