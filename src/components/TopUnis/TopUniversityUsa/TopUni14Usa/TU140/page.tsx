  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        Founded in 1919, the University of California, Los Angeles (UCLA) is a world-renowned public
research university celebrated for academic excellence, global diversity, and innovation. Ranked
among the top 20 universities worldwide, UCLA is known for its strong programs in engineering,
business, film, and medicine - and its location in one of the most dynamic cities on Earth.
      ...
      >
        <button className="px-8 py-2.5 rounded-full text-white bg-[#37D7D9] font-medium hover:bg-[#00B7C1] hover:shadow-md hover:shadow-gray-400 transition-shadow duration-300 ease-in-out">
          Apply Now
        </button>
      </div>
    </section>
