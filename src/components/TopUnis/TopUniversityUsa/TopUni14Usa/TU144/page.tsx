...
const REASONS = [
  {
    ...
    text: (
      <> 419-acre campus in Westwood, Los Angeles - a blend of iconic architecture and cutting-edge
research centers.
  ...
  },
  {
    ...
    text: (
      <>
        UCLA Library System holds over 12 million volumes and digital collections.
  ...
  },
  {
    ...
    text: (
      <>
         Advanced facilities such as the California NanoSystems Institute and Ronald Reagan UCLA
Medical Center.
      </>
    ),
  },
  {
    ...
    text: (
      <>
      UCLA Anderson Venture Accelerator supporting startups and entrepreneurship.
  ...
  },
  {
    ...
    text: (
      <>
      1,000+ student organizations, cultural centers, and athletic programs.
      </>
    ),
  },
];
