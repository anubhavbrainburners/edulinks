...
const REASONS = [
  {
    ...
    text: (
      <> 299-acre campus in Philadelphia with state-of-the-art labs and green spaces.
  ...
  },
  {
    ...
    text: (
      <>
          Van Pelt-Dietrich Library Center housing millions of volumes.
  ...
  },
  {
    ...
    text: (
      <>
       Advanced research institutes including Pennovation Works and The Singh Center for
Nanotechnology.
      </>
    ),
  },
  {
    ...
    text: (
      <>
         UPenn Health System, one of the top-ranked academic medical centers in the U.S.
  ...
  },
  {
    ...
    text: (
      <>
       Extensive student housing, dining halls, and recreation facilities.
