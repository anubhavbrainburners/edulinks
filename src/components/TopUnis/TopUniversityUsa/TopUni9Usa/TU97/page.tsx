...
const faqs = [
  {
    question: "What is UPenn known for?",
    answer:
      "UPenn is known for its world-class business education, medical research, and interdisciplinary innovation.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition ranges between US $63,000 - 87,000 per year, depending on the program.",
  },
  {
    question: " Does UPenn offer scholarships for international students?",
    answer:
      "Yes - UPenn provides need-based financial aid and merit scholarships for international students.",
  },
  {
