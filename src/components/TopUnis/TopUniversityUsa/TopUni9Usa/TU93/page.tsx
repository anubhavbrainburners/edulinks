...
const ITEMS: Item[] = [
  { id: 1, label: <>Wharton School of Business</> },
  { id: 2, label: <>School of Engineering and Applied Science</> },
  { id: 3, label: <>Perelman School of Medicine</> },
 
  { id: 4, label: <>School of Design</> },
];
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            Bachelor of Science in Economics (Wharton Undergraduate)
                          </h3>
                        </div>
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                            GRE + Bachelor's in Science/Engineering
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           Fall
                        </div>
