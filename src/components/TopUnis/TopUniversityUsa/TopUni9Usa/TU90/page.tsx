  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        Founded in 1740 by Benjamin Franklin, the University of Pennsylvania (UPenn) is a member of the
Ivy League and one of the world's most prestigious research universities. Known for combining
academic rigor with innovation and entrepreneurship, UPenn consistently ranks among the top 15
