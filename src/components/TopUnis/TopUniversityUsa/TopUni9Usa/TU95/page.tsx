  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
         Strong integration<br/> across business, tech, and humanities.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         Students from 130+ <br/>countries form a vibrant international environment.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        96% of graduates<br/> employed or in further study within six months.
    ...
    },
    {
      ...
      body: (
        <>
           Access to Philadelphia's<br/> cultural, business, and research landscape.
