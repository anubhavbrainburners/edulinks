  ...
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
       ...
       UPenn offers over 400 programs across its <br/>12 schools, including the Wharton School of Business,<br/>
the School of Engineering and Applied Science,<br/> and the Perelman School of Medicine. The
university <br/>emphasizes interdisciplinary education, blending<br/> business, technology, and liberal arts to
prepare<br/> students for leadership in a rapidly changing <br/>world.
