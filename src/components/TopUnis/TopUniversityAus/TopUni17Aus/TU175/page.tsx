...
const REASONS = [
  {
    ...
    text: (
      <>
        Melbourne (Bundoora) Campus – large, modern main campus with advanced facilities and student housing.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Sydney Campus – centrally located with business-focused programs.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       La Trobe Research & Innovation Precinct – interdisciplinary research hub with industry collaboration.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Sports & Fitness Centre – Olympic pool, gyms, and health facilities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Library & Student Hub – open 24/7 with collaborative and digital learning spaces.
      </>
    ),
  },
];

export default function TU175 () {
  return (
