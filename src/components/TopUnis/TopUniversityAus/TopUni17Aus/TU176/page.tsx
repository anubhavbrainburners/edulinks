  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
          Over 7,000 international students from 110+<br/> countries.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Real-world internships and skill development built <br/>into programs.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Safe, multicultural city with top employment<br/> opportunities.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          100+ clubs, societies, and volunteering initiatives.
        </>
      ),
    },
  ];
