...
const ITEMS: Item[] = [
  { id: 1, label: <>School of Engineering & <br/>Mathematical Sciences</> },
  { id: 2, label: <>La Trobe Business School</> },
  { id: 3, label: <>School of Health &<br/> Biomedical Sciences</> },
  { id: 4, label: <>School of Humanities &<br/> Social Sciences</> },
];

export default function TU174() {
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Management (Project Management)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years (full-time)
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s in Science/Health + IELTS 7.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February
                        </div>
