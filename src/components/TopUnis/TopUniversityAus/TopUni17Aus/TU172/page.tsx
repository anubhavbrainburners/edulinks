      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
            Ranked among the top 1% of universities worldwide, La Trobe<br/> University is recognised for academic excellence, real-world <br/>learning, and graduate employability. With over 36,000 students,<br/> including 7,000+ international learners, La Trobe combines world-<br/>class facilities, industry partnerships, and community engagement<br/> to deliver a truly modern education experience.
            </p>
          {/* Button */}
