...
const faqs = [
  {
    ...
    answer:
      "La Trobe is recognised for strong programs in health, business, engineering, and applied sciences.",
  },
  {
    question: "Is La Trobe good for international students?",
    answer:
      "Yes — La Trobe offers excellent support, diverse student life, and global employability programs.",
  },
  {
    question: "What is the average tuition fee range?",
    answer:
      "Tuition fees range from AUD $37,000 – $44,000 per year, depending on the course.",
  },
  {
    question: "Does La Trobe University offer scholarships?",
    answer:
      "Yes — international students can apply for merit-based scholarships, including La Trobe International and Regional Scholarships.",
  },
];

export default function TU178() {
