...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Science, Engineering &<br/> Built Environment</> },
  { id: 2, label: <>Faculty of Business &<br/> Law</> },
  { id: 3, label: <>Faculty of Health</> },
  { id: 4, label: <>Faculty of Arts &<br/> Education</> },
];
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Approx. AUD $43,500/Year (estimate)
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s degree (any field) + IELTS 6.5
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Approx. AUD $42,000/Year (estimate)
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s degree in Science/Health + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February& July
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Approx. AUD $40,000/Year (estimate)
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
