...
const REASONS = [
  {
    ...
    text: (
      <>
        Melbourne Burwood Campus – modern, technology-enhanced learning spaces.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Geelong Waterfront & Waurn Ponds Campuses – research-focused hubs with engineering and health facilities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Warrnambool Campus – coastal setting with strong community focus.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Library & Innovation Centre – 24/7 study spaces, collaborative tech labs.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Student Life & Housing – on-campus accommodation, clubs, and career workshops.
      </>
    ),
  },
];
