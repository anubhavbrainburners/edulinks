      ...
      <div className="space-y-16 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.1fr] items-center relative">
          ...
          <div className="relative flex justify-end">
            ...
            <div className="absolute top-1/2 left-0 transform -translate-y-1/2 w-full flex justify-end items-center">
              ...
              {/* Right Side Text */}
              <div className="text-white text-lg max-w-[380px] leading-relaxed mr-40">
                <ul className="list-disc space-y-1">
                  <li>
                    Academic: Completion Of High School /<br/> Grade 12 (Or Equivalent)
                  </li>
                  <li>
                    English Proficiency: IELTS 6.5 (No Band<br/> Less Than 6.0) / TOEFL
                    IBT 83
                  </li>
                </ul>
              </div>
        ...
        <div className="relative flex justify-start">
          ...
          <div className="absolute top-1/2 left-0 transform -translate-y-1/2 w-full flex justify-start items-center">
            {/* Left Side Text */}
            <div className="text-black text-lg max-w-[410px] leading-relaxed ml-58">
              <ul className="list-disc space-y-1">
                <li>
                  Academic: Bachelor’s Degree In Relevant Field<br/> From A Recognised
                  Institution
                </li>
                <li>
                  English Proficiency: IELTS 6.5 (No Band Less<br/> Than 6.0) / TOEFL
                  IBT 83
                </li>
              </ul>
            </div>
            ...
            {/* Right Circle Text */}
            <div className="ml-13 text-center text-xl text-white font-semibold">
              <p>Postgraduate</p>
              <p>Programs</p>
            </div>
          </div>
