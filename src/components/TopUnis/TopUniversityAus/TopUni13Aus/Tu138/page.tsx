...
const faqs = [
  {
    ...
    answer:
      "Deakin is recognised for innovation, employability, and student satisfaction, especially in health, business, and technology.",
  },
  {
    question: "What is the average tuition fee for international students?",
    answer:
      "Most programs range between AUD $38,000 – $45,000 per year, depending on the degree.",
  },
  {
    question: "Does Deakin offer scholarships for international students?",
    answer:
      "Yes, Deakin offers merit-based and destination scholarships for high-achieving international students.",
  },
  {
    question: "Is Deakin University good for employability?",
    answer:
      "Absolutely — Deakin graduates are highly sought after, with one of Australia’s best career service networks.",
  },
];

export default function TU138() {
