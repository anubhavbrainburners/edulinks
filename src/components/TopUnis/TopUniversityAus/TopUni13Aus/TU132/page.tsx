      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
            Deakin University combines academic quality with a strong focus <br/>on employability and global learning. Ranked among the top 1% of <br/>universities worldwide, Deakin stands out for its flexible learning<br/> options, advanced research facilities, and student satisfaction. Its<br/> programs in business, engineering, health, and technology are<br/> globally recognised for practical, real-world relevance.
            </p>
          {/* Button */}
