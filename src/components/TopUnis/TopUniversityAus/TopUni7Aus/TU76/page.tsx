  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
          With over 21,000 international students from more<br/> than 140 countries, UQ offers a genuinely global<br/> campus experience.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Over 220 student clubs and societies across <br/>academics, culture, sports, leadership and <br/>innovation.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Located in Australia’s third-largest city, enjoy <br/>subtropical climate, vibrant cultural life, coastal<br/> access and strong job prospects.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Regular research expos, cultural festivals, industry<br/> networking events and student leadership programs<br/> keep the community active and engaged.
        </>
      ),
    },
  ];
