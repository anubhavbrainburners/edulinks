...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Engineering, Architecture &<br/> Information Technology</> },
  { id: 2, label: <>Faculty of Business, Economics &<br/> Law</> },
  { id: 3, label: <>Faculty of Science</> },
  { id: 4, label: <>Faculty of Medicine, Health &<br/> Behavioural Sciences</> },
  { id: 5, label: <>Faculty of Humanities, Arts & <br/>Social Sciences</> },
];
                  ...
                  {id === 3 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            Bachelor of Science (Biological & Environmental Sciences)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          3 Years (Full-Time)
