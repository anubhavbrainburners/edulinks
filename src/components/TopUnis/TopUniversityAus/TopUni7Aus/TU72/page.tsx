      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
            The University of Queensland (UQ), based in Brisbane,<br/> Queensland, is a major research-intensive institution and a <br/>founding member of Australia’s Go8 group. With more than<br/> 55,000 students and multi-campus reach including St Lucia,<br/> Gatton and Herston, UQ offers a broad spectrum of programs,<br/> world-leading research and a vibrant campus experience in<br/> Queensland.
            </p>
          {/* Button */}
