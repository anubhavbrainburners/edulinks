...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Engineering &<br/> Technology</> },
  { id: 2, label: <>QUT Business School</> },
  { id: 3, label: <>Faculty of Health</> },
  { id: 4, label: <>Faculty of Creative Industries,<br/> Education & Social Justice</> },
];
                  ...
                  {id === 1 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s in IT/Computer Science + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           Intake: February & July
                        </div>
                  ...
                  {id === 2 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            Bachelor of Business (Marketing/Finance/Management)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          3 years (full-time)
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Business (International Business)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years (full-time)
                        </div>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Professional Accounting</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years (full-time)
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Approx. AUD $42,500/Year (estimate)
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                  ...
                  {id === 3 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Approx. AUD $39,000/Year
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Class 12 (Biology/Chemistry) + IELTS 7.0 (no band less than 6.5)
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February
                        </div>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Approx. AUD $43,000/Year (estimate)
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s in Psychology + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            Bachelor of Communication (Digital Media/Journalism)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          3 years (full-time)
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Approx. AUD $38,000/Year (estimate)
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Class 12 + IELTS 6.5
                        </div>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Digital Communication</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years (full-time)
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Approx. AUD $41,000/Year (estimate)
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s in Communication/Media + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          February & July
                        </div>
