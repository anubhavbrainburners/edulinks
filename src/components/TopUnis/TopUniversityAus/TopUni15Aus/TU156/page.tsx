  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
          10,000+ students from over 120 countries.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Affordable, sunny, and globally connected city.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Industry placements and startup opportunities.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          100+ clubs, cultural events, and innovation<br/> challenges.
        </>
      ),
    },
  ];
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-6">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 flex flex-col justify-center px-8 items-start text-left">
              ...
              <p className="text-lg leading-relaxed pb-13">{cards[2].body}</p>
            </div>
          </div>
