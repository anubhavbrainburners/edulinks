...
const faqs = [
  {
    ...
    answer:
      "QUT is known for real-world learning, strong industry connections, and innovation in technology and business.",
  },
  {
    question: "Is QUT good for international students?",
    answer:
      "Yes — QUT ranks highly for student satisfaction and international support services.",
  },
  {
    question: "What are the average tuition fees?",
    answer:
      "Fees typically range between AUD $38,000 – $45,000 per year, depending on the program.",
  },
  {
    question: "Does QUT offer scholarships for international students?",
    answer:
      "Yes — QUT offers merit-based scholarships and country-specific international bursaries.",
  },
];

export default function TU158() {
