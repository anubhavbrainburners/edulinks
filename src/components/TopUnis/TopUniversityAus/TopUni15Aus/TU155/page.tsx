...
const REASONS = [
  {
    ...
    text: (
      <>
        Gardens Point Campus – located in Brisbane CBD with advanced academic and research facilities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Kelvin Grove Campus – creative hub for design, education, and health sciences.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       HiQ Learning Centres – integrated digital support for students 24/7.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        QUT Library & Research Hubs – modern study zones and technology labs.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Student Accommodation – secure on-campus housing near city attractions.
      </>
    ),
  },
];

export default function TU155 () {
  return (
