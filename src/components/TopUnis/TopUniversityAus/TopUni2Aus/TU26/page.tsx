  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
          Join a vibrant community of students from 150+<br/> countries at Australia’s top university.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Hundreds of student-run clubs, cultural groups,<br/> academic groups, sports teams offering rich campus life.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         Live in Melbourne — Australia’s culture and<br/> innovation hub — with cafés, arts, transport, and<br/> part-time job opportunities.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Regular cultural, arts, research, and student events<br/> across campus and city, enhancing your experience.
        </>
      ),
    },
  ];
