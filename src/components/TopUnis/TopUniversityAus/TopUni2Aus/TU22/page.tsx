      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
            The University of Melbourne, located in Melbourne, Victoria, is <br/>Australia’s leading research university and consistently ranked at <br/>the very top nationally and globally. With a student body of over<br/> 53,000 including many international learners, it’s recognised for <br/>its cutting-edge research, strong industry and global partnerships,<br/> and its role in innovation and leadership.
          </p>
