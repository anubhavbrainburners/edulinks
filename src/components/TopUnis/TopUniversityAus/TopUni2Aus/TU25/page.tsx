...
const REASONS = [
  {
    ...
    text: (
      <>
        Historic Parkville campus + multiple specialised campuses (Burnley, Southbank, Werribee) with modern infrastructure.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Advanced research libraries, collaborative learning spaces, over 3.5 million items in library collections.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Student accommodation + dining + support services with access to city amenities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Sport & recreation facilities: gyms, indoor pool, numerous student sports clubs.
      </>
    ),
  },
];
