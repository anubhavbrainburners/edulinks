  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
          7,000+ international students from 110+ countries.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Internships, industry placements, and research<br/> projects.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Relaxed lifestyle, beaches, and outdoor<br/> recreation.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Cultural clubs, sports, and community engagement<br/> programs.
        </>
      ),
    },
  ];
