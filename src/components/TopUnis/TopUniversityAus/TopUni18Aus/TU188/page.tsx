...
const faqs = [
  {
    ...
    answer:
      "UON is known for excellence in engineering, medicine, and business programs with strong research outcomes.",
  },
  {
    question: "Is Newcastle affordable for students?",
    answer:
      "Yes — living costs are lower than major cities like Sydney or Melbourne, making it ideal for international students.",
  },
  {
    question: "What are the average tuition fees?",
    answer:
      "Tuition ranges between AUD $37,000 – $44,000 per year, depending on the course.",
  },
  {
    question: "Does the University of Newcastle offer scholarships?",
    answer:
      "Yes — international students can apply for merit-based scholarships such as the International Excellence Scholarship.",
  },
];

export default function TU188() {
