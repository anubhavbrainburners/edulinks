...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Engineering & Built<br/> Environment</> },
  { id: 2, label: <>Faculty of Business &<br/> Law</> },
  { id: 3, label: <>Faculty of Health &<br/> Medicine</> },
  { id: 4, label: <>Faculty of Education &<br/> Arts</> },
];

export default function TU184() {
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Business Administration (MBA)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Approx. AUD $41,500/Year (estimate)
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s degree (any field) + IELTS 6.5
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s in Science (Chemistry/Biology) + IELTS 7.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Social Change and Development</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years (full-time)
                        </div>
