...
const faqs = [
  {
    ...
    answer:
      "Curtin is recognised globally for innovation, engineering, business, and data science.",
  },
  {
    question: " Is Curtin good for international students?",
    answer:
      " Yes, Curtin is one of Australia’s most multicultural universities, with strong global partnerships.",
  },
  {
    question: "What are the average tuition fees?",
    answer:
      "Tuition typically ranges from AUD $38,000 – $45,000 per year, depending on the course.",
  },
  {
    question: "Does Curtin University offer scholarships?",
    answer:
      "Yes — Curtin provides international merit scholarships, women in STEM awards, and research grants.",
  },
];

export default function TU128() {
