...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Science &<br/> Engineering</> },
  { id: 2, label: <>Curtin Business School</> },
  { id: 3, label: <>Faculty of Health<br/> Sciences</> },
  { id: 4, label: <>Faculty of Humanities & Design</> },
];

export default function TU124() {
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of International Business and Entrepreneurship</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years (full-time)
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Approx. AUD $4p0,000/Year (estimate)
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s in Health/Science + IELTS 7.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Approx. AUD $39,500/Year (estimate)
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Class 12 (Portfolio required) + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February & July
                        </div>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Urban & Regional Planning</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years (full-time)
                        </div>
