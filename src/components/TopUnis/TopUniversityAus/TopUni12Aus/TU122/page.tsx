      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
            Curtin University, located in Perth, is renowned for its forward-<br/>thinking approach to education and research. Hosting over 58,000<br/> students — including 15,000+ international students — Curtin<br/> offers globally recognised programs in business, engineering, IT,<br/> health, and design. Its modern campuses and strong partnerships <br/>with industry leaders provide students with real-world learning<br/> opportunities and exceptional career outcomes.
            </p>
          {/* Button */}
