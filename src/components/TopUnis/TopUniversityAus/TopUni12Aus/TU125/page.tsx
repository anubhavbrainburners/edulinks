...
const REASONS = [
  {
    ...
    text: (
      <>
        Bentley Campus (Perth) – Curtin’s main campus, featuring advanced facilities, research labs, and collaborative study spaces.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Curtin Stadium & Recreation Centre – modern fitness, sporting, and wellness facilities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Libraries & Innovation Hubs – 24/7 access, digital labs, and maker spaces.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Global Campuses – campuses in Singapore, Dubai, Malaysia, and Mauritius.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Student Accommodation – on-campus residences, dining options, and international student services.
      </>
    ),
  },
];

export default function TU125 () {
  return (
