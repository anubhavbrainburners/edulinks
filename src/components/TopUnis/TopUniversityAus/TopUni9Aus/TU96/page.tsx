  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
          Students from a wide range of countries enrich the<br/> global campus atmosphere.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          A variety of student-led groups, cultural clubs,<br/> sports teams and interest communities enhance<br/> extracurricular life.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Study in Adelaide — a city known for its<br/> affordability, arts culture, beaches and relaxing<br/> student environment.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Regular academic seminars, industry networking,<br/> cultural festivals and research showcases make for<br/> an engaging student journey.
        </>
      ),
    },
  ];
