...
const faqs = [
  {
    ...
    answer:
      "Yes — the university is a member of the Go8 and is known for high research output and international partnerships. Wikipedia",
  },
  {
    question: "What is the typical international tuition fee range?",
    answer:
      "For many programs, tuition ranges from approximately AUD $35,000 to $52,000 per year, depending on discipline. Executive Study Abroad+1",
  },
  {
    question: " Can international students work while studying at Adelaide?",
    answer:
      " Yes — international students on a valid Australian student visa may work part-time during study sessions (within visa rules).",
  },
  {
    question: "Are scholarships available for international students at this university?",
    answer:
      "Yes — there are scholarships and support mechanisms for international students across undergraduate and postgraduate levels.",
  },
];

export default function TU98() {
