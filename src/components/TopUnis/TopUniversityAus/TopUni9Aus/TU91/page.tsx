      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
            Established in 1874, the University of Adelaide is a prestigious research institution and one of Australia’s oldest universities, with a modern global focus and strong academic reputation.
            </span>
        </p>
