...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Engineering, Computer &<br/> Mathematical Sciences</> },
  { id: 2, label: <>Faculty of Business, Law &<br/> Economics</> },
  { id: 3, label: <>Faculty of Sciences</> },
  { id: 4, label: <>Faculty of Health &<br/> Medical Sciences</> },
  { id: 5, label: <>Faculty of Arts &<br/> Social Sciences</> },
];

export default function TU94() {
