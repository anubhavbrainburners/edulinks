      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
            The University of Adelaide, located in Adelaide, South Australia, is<br/> a member of the Go8 group and known for its high research <br/>output, global partnerships and strong student experience. With<br/> over 30,000 students and an expansive campus in the heart of<br/> Adelaide, it offers vibrant academic programs and a supportive<br/> environment for international learners.
            </p>
          {/* Button */}
