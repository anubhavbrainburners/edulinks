...
const REASONS = [
  {
    ...
    text: (
      <>
        Main city-campus located on North Terrace in Adelaide CBD — a blend of historic architecture and modern facilities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Well-equipped libraries, research institutes and student services tailored for international learners.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       On-campus accommodation, dining, support services and student recreation options enhance campus life.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Proximity to Adelaide’s cultural precincts, technology hubs and startup ecosystem adds value to the student experience.
      </>
    ),
  },
];
