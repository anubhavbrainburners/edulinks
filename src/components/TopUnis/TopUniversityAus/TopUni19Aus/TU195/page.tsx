...
const REASONS = [
  {
    ...
    text: (
      <>
        Hobart Campus – main campus overlooking the harbour, with research and academic hubs.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Launceston Campus – home to maritime and logistics programs.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Cradle Coast Campus – modern regional learning and innovation centre.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        IMAS (Institute for Marine & Antarctic Studies) – globally recognised research facility.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Student Accommodation – affordable housing with scenic locations and community life.
      </>
    ),
  },
];

export default function TU195 () {
  return (
