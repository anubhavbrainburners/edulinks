...
const faqs = [
  {
    ...
    answer:
      "UTAS is renowned for its programs in marine and Antarctic science, health, and environmental research.",
  },
  {
    question: "Is Tasmania affordable for international students?",
    answer:
      "Yes — Tasmania offers one of the most cost-effective living and study options in Australia.",
  },
  {
    question: "What is the average tuition fee range?",
    answer:
      "Most programs cost between AUD $36,000 – $43,000 per year, depending on the course.",
  },
  {
    question: "Does UTAS offer scholarships for international students?",
    answer:
      "Yes — the university offers international merit scholarships and destination-based discounts.",
  },
];

export default function TU198() {
