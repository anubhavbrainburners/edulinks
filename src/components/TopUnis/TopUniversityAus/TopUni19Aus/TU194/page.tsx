...
const ITEMS: Item[] = [
  { id: 1, label: <>College of Sciences &<br/> Engineering</> },
  { id: 2, label: <>Tasmanian School of Business &<br/> Economics</> },
  { id: 3, label: <>College of Health & <br/>Medicine</> },
  { id: 4, label: <>College of Arts, Law &<br/> Education</> },
];

export default function TU194() {
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 3 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Approx. AUD $41,000/year
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s in Science (Biology/Chemistry) + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Education</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years (full-time)
                        </div>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of International Relations</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years (full-time)
                        </div>
