...
export default function TU196() {
  const cards: Card[] = [
    {
      title: "Global Community",
      body: (
        <>
          6,000+ students from 100+ countries.  
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Work placements and research internships.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Nature, adventure, and sustainability-focused<br/> living.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Outdoor clubs, student societies, and cultural<br/> events.
        </>
      ),
    },
  ];
    ...
    <main className="px-6 py-12 mt-35">
      <div className="max-w-[1100px] mx-auto">
        <h1 className="text-center text-4xl font-bold mb-18 text-[#545454]">
          Life at University of Tasmania
        </h1>
