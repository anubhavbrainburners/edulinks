  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
          Students from over 130 nationalities create a<br/> diverse and inclusive campus.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Internships, placements, and professional<br/> mentorship.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Enjoy beaches, sunshine, and a relaxed<br/> environment.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Festivals, clubs, and innovation challenges<br/> throughout the year.
        </>
      ),
    },
  ];
