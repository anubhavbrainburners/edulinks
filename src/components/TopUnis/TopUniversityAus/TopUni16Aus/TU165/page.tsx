...
const REASONS = [
  {
    ...
    text: (
      <>
        Gold Coast Campus – state-of-the-art facilities, close to beaches and city life.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Nathan Campus (Brisbane) – major research and innovation hub.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       South Bank Campus – creative hub for arts, film, and design.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Modern Labs & Studios – advanced learning spaces and research infrastructure.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Student Support & Accommodation – on-campus housing, career guidance, and wellbeing programs.
      </>
    ),
  },
];
