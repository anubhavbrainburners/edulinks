...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Engineering &<br/> Information Technology</> },
  { id: 2, label: <>Griffith Business School</> },
  { id: 3, label: <>Faculty of Health</> },
  { id: 4, label: <>Arts, Education & <br/>Law Faculty</> },
];

export default function TU164() {
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 1 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s in IT/Science + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           Intake: February & July
                        </div>
                  ...
                  {id === 2 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            Bachelor of Business (Marketing/Management/Finance)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          3 years (full-time)
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of International Business</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years (full-time)
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Education (Leadership & Management)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years (full-time)
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Approx. AUD $39,000/Year (estimate)
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s in Education/Related Field + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          February & July
                        </div>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Law (International Law and Global Governance)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years (full-time)
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s in Law or Related Field + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          February
                        </div>
