...
const faqs = [
  {
    ...
    answer:
      "Griffith is known for strong programs in health, business, law, and environmental science, along with industry partnerships.",
  },
  {
    question: "Is Griffith good for international students?",
    answer:
      "Yes — Griffith consistently ranks among Australia’s best for student support and campus experience",
  },
  {
    question: "What is the tuition fee range?",
    answer:
      "Most programs range between AUD $38,000 – $45,000 per year, depending on the course.",
  },
  {
    question: "Does Griffith offer scholarships for international students?",
    answer:
      "Yes — Griffith provides international scholarships, including the Griffith Remarkable Scholarship and Academic Merit Scholarships.",
  },
];

export default function TU168() {
