      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
            Established in 1887, RMIT University is a globally recognized university with a strong focus on design, innovation and industry engagement. Located in the heart of Melbourne, it offers practical and future-oriented education for diverse international students.
            </span>
        </p>
