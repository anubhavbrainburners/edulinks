...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Engineering & <br/> IT</> },
  { id: 2, label: <>Faculty of Business & <br/>Economics</> },
  { id: 3, label: <>Faculty of Design & <br/>Social Context</> },
                  ...
                  {id === 1 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          AUD $45,000/Year (estimate) Yocket Study Abroad+1
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          AUD $46,000/Year (estimate) Shiksha+1
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                  ...
                  {id === 2 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Approx. AUD $42,000/Year (estimate) Yocket Study Abroad
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Class 12 + IELTS 6.5
                        </div>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Approx. AUD $44,000/Year (estimate)
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                  ...
                  {id === 3 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s in any relevant field + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Approx. AUD $46,000/Year (estimate)
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s in IT/Maths/Science + IELTS 6.5
                        </div>
