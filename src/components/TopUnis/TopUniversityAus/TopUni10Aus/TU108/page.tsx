...
const faqs = [
  {
    ...
    answer:
      "RMIT is ranked among Australia’s top universities and continues to appear in global rankings for design, technology and business education. University Living",
  },
  {
    question: "What is the tuition fee range for international students at RMIT?",
    answer:
      " International tuition fees vary by program; many undergraduate programs range from approx. AUD $20,000-45,000/Year and postgraduate from AUD $22,000-50,000/Year. Yocket Study Abroad+1",
  },
  {
    question: "Can international students work while studying at RMIT?",
    answer:
      "Yes — as with other Australian universities, international students on a valid student visa may work part-time during their studies (as per visa conditions).",
  },
  {
