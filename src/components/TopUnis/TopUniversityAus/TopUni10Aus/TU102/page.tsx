      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
            RMIT University, based in Melbourne, combines academic research<br/> with hands-on industry experience. With a strong reputation in<br/> design, technology and business, RMIT offers modern campuses,<br/> large international cohorts and extensive global partnerships. It is<br/> ranked among Australia’s prominent universities.
            </p>
          {/* Button */}
