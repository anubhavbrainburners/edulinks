  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
          International students from many countries create a<br/> culturally diverse and globally connected<br/> environment.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Wide range of student-led clubs, design and media<br/> groups, tech and business societies provide vibrant<br/> campus life.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Study in Melbourne—one of Australia’s most<br/> vibrant cities with arts, technology, business,<br/> cafés, culture and opportunity.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Regular industry guest talks, design expos,<br/> hackathons and networking events link students<br/> with professional worlds.
        </>
      ),
    },
  ];
