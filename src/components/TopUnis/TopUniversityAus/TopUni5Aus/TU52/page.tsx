      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
            ANU, based in Canberra, is one of Australia’s leading research<br/> universities and a member of the elite Group of Eight. The<br/> university has strong global links, rigorous academic standards<br/> and international student representation. International <br/>undergraduate tuition fees are typically in the range of AUD<br/> $39,000+ per year for many programs.
          </p>
