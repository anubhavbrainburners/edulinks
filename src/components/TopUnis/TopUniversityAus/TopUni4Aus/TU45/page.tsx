...
const REASONS = [
  {
    ...
    text: (
      <>
        Main campus in Kensington, Sydney, with modern learning spaces, specialist research centres and a parkland setting.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Advanced libraries and research infrastructure supporting engineering, science, medicine and design innovation.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       On-campus accommodation, dining, student support and recreation facilities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Extensive sports and student life facilities including fitness centres, courts and student clubs.
      </>
    ),
  },
];
