      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
            UNSW Sydney, based in Kensington, Sydney, is a premier research-<br/>intensive institution and a founding member of the Go8 group.<br/> With more than 50,000 students and around 40% international<br/> enrolment, it offers cutting-edge education, strong employer<br/> engagement and a vibrant global campus.
          </p>
