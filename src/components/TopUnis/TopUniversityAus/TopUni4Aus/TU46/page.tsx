  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
          A large cohort of international students (~39%)<br/> brings global perspectives and networks.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Over 300 clubs and societies covering culture,<br/> academics, sports, and entrepreneurship.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         Study in one of Australia’s most vibrant cities —<br/> beaches, business hubs, start-up culture and high <br/>quality of life.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Regular cultural events, innovation hackathons,<br/> research showcases and international student <br/>meet-ups.
        </>
      ),
    },
  ];
