      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
            Established in 1949, UNSW Sydney is a world-leading research university located in Sydney with over 50,000 students including a large international cohort. Ranked in the global top 20 and renowned for innovation, industry connections, and strong graduate outcomes.
            </span>
        </p>
