      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
            Macquarie University, based in Sydney, is ranked among the <br/>world’s top 1%. With more than 45,000 students, including 12,000<br/> international learners, the university is renowned for its research-<br/>driven approach, strong industry partnerships, and focus on <br/>graduate employability. Its modern campus and diverse <br/>community make it one of Australia’s most attractive destinations<br/> for international students.
          </p>
