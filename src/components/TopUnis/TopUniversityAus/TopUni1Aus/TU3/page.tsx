...
const REASONS = [
  {
    ...
    text: (
      <>
        Library & Research Hubs – One of Australia’s most high-tech libraries with collaborative study spaces.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Labs & Innovation Centers – Advanced laboratories and research facilities supporting cutting-edge learning.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        On-Campus Accommodation – Affordable student housing with modern amenities, dining, and support services.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Student Support & Career Services – Dedicated international student office, career workshops, and employability support.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Sports & Recreation – Olympic-sized swimming pool, fitness center, and multi-sport courts.
      </>
    ),
  },
];
