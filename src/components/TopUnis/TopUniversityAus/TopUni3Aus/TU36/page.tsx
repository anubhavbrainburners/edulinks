  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
          Students from 140+ countries contribute to A<br/> diverse and global campus culture.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Hundreds of student-run clubs and societies covering<br/> culture, hobbies, academics and sports.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         Enjoy living in Sydney – vibrant city life, beaches,<br/> café culture, part-time opportunities and global<br/> networking.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Regular cultural festivals, career fairs, research<br/> presentations and student gatherings across<br/> campus.
        </>
      ),
    },
  ];
