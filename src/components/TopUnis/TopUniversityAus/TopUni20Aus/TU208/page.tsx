...
const faqs = [
  {
    ...
    answer:
      "Swinburne is renowned for technology, innovation, and design-focused education with global industry links.",
  },
  {
    question: "Is Swinburne good for international students??",
    answer:
      "Yes — it’s consistently ranked among Australia’s best for international student satisfaction.",
  },
  {
    question: "What is the average tuition fee range?",
    answer:
      "Most programs range from AUD $38,000 – $44,000 per year, depending on the course.",
  },
  {
    question: "Does Swinburne University offer scholarships?",
    answer:
      "Yes — Swinburne offers international merit scholarships and postgraduate excellence awards.",
  },
];

export default function TU208() {
