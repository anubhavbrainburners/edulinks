  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
          Over 12,000 international students from 100+<br/> countries.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Industry placements, co-op programs, and <br/>networking events.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Safe, diverse, and ranked among the world’s top<br/> student cities.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          100+ clubs, cultural festivals, and leadership<br/> activities.
        </>
      ),
    },
  ];
    ...
    <main className="px-6 py-12 mt-35">
      <div className="max-w-[1100px] mx-auto">
        <h1 className="text-center text-4xl font-bold mb-18 text-[#545454]">
          Life at Swinburne University of Technology
        </h1>
