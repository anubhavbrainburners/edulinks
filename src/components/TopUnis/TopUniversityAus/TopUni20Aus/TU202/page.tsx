      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
            Ranked among the top 250 universities worldwide, Swinburne<br/> stands out for its focus on technology, business, design, and<br/> engineering. With over 60,000 students, including 12,000+ <br/>international learners, the university integrates real-world learning<br/> and research with global industry connections, ensuring graduates <br/>are ready for tomorrow’s workforce.
            </p>
          {/* Button */}
