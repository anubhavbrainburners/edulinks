...
const REASONS = [
  {
    ...
    text: (
      <>
        Hawthorn Campus – main Melbourne campus with modern labs and innovation centres.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Wantirna & Croydon Campuses – strong focus on health and applied sciences.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Advanced Labs & Studios – equipped for design, tech, and engineering research.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Innovation Precinct – collaboration hub for startups, research, and industry projects.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Student Accommodation – modern apartments near campus with vibrant community life.
      </>
    ),
  },
];

export default function TU205 () {
  return (
