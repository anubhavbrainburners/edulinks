...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Science, Engineering &<br/> Technology</> },
  { id: 2, label: <>Swinburne Business School</> },
  { id: 3, label: <>Faculty of Health, Arts &<br/> Design</> },
  { id: 4, label: <>Faculty of Health Sciences</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 1 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            Master of Engineering (Civil/Mechanical/Electronics)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 Years (Full-Time)
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Entrepreneurship and Innovation</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years (full-time)
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Class 12 (Portfolio may be required) + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February & July
                        </div>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor’s in Architecture + Portfolio + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February & July
                        </div>
