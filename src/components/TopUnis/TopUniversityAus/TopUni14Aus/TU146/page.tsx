  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
          Join 7,000+ international students from 160+<br/> countries.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Cultural festivals, innovation expos, and networking <br/>fairs.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Coastal living with beaches, nature, and vibrant<br/> culture.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Industry-based internships and job mentoring.
        </>
      ),
    },
  ];
