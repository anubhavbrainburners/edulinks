...
const faqs = [
  {
    ...
    answer:
      "UOW is known for its excellence in engineering, IT, business, and health sciences.",
  },
  {
    question: " What is the average tuition fee for international students?",
    answer:
      "Tuition fees range between AUD $38,000 – $45,000 per year, depending on the program.",
  },
  {
    question: "Is UOW good for employability?",
    answer:
      "Yes, UOW graduates are among the most employable in Australia, with strong industry ties.",
  },
  {
    question: "Does UOW offer scholarships?",
    answer:
      "Yes — UOW offers international merit scholarships and tuition discounts for outstanding students.",
  },
];

export default function TU148() {
