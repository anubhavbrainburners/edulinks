      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
            Established in 1951, The University of Wollongong is a globally recognised institution known for its excellence in teaching, research, and graduate employability. Located on Australia’s beautiful South Coast, UOW offers a world-class learning environment just 90 minutes from Sydney.
            </span>
        </p>
