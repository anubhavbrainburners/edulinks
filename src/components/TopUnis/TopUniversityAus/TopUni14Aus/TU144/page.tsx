...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Engineering &<br/> Information Sciences</> },
  { id: 2, label: <>Faculty of Business &<br/> Law</> },
  { id: 3, label: <>Faculty of Science, Medicine &<br/> Health</> },
  { id: 4, label: <>Faculty of Arts, Social Sciences &<br/> Humanities</> },
];

export default function TU144() {
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Applied Finance</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years (full-time)
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Class 12 (Biology/Chemistry) + IELTS 7.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February
                        </div>
