      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
            The University of Wollongong (UOW) ranks among the top 1% of <br/>universities worldwide and is highly regarded for its strong links to<br/> industry and focus on real-world learning. Home to over 34,000<br/> students, including 7,000+ international students, UOW provides<br/> innovative programs in business, engineering, information<br/> sciences, health, and creative industries.
            </p>
          {/* Button */}
