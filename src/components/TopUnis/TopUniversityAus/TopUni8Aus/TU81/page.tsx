    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        <p className="text-[#6F6F6F] text-md leading-relaxed text-center" style={{ fontFamily: "DM Sans" }}>
            Perth, Western Australia, Australi
        </p>
      ...
      >
        <button className="px-10 py-2.5 -translate-y-6 rounded-full text-white bg-[#37D7D9] font-medium hover:bg-[#00B7C1] hover:shadow-md hover:shadow-gray-400 transition-shadow duration-300 ease-in-out">
          Apply Now
        </button>
      </div>
    </section>
