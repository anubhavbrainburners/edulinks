...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Engineering & <br/>Mathematical Sciences</> },
  { id: 2, label: <>Faculty of Business, Economics &<br/> Law</> },
  { id: 3, label: <>Faculty of Science</> },
  { id: 4, label: <>Faculty of Medicine, Dentistry &<br/> Health Sciences</> },
  { id: 5, label: <>Faculty of Arts, Humanities &<br/> Social Sciences</> },
];

export default function TU84() {
