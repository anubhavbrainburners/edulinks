      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
            The University of Western Australia (UWA), based in Perth, is one <br/>of Australia’s oldest universities and a founding member of the<br/> prestigious Go8 network. With more than 29,000 students—<br/>including a growing international cohort—UWA offers a broad<br/> spectrum of disciplines, high impact research, and a spacious<br/> riverside campus in a vibrant city.
            </p>
          {/* Button */}
