      ...
      <div className="space-y-16 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.1fr] items-center relative">
          ...
          <div className="relative flex justify-end">
            ...
            <div className="absolute top-1/2 left-0 transform -translate-y-1/2 w-full flex justify-end items-center">
              ...
              {/* Right Side Text */}
              <div className="text-white text-lg max-w-[380px] leading-relaxed mr-38">
                <ul className="list-disc space-y-1">
                  <li>
                    Academic: Completion of Class 12 / High<br/> School (equivalent to Australian Year 12)
                  </li>
                  <li>
                    English: IELTS 6.5 (no band less than <br/>6.0) / TOEFL iBT 79
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="relative flex justify-start">
          ...
          <div className="absolute top-1/2 left-0 transform -translate-y-1/2 w-full flex justify-start items-center">
            {/* Left Side Text */}
            <div className="text-black text-lg max-w-[410px] leading-relaxed ml-59">
              <ul className="list-disc space-y-1">
                <li>
                  Academic: Bachelor’s degree from a<br/> recognised institution
                </li>
                <li>
                  English: IELTS 6.5 (no band less than 6.0) / <br/> TOEFL iBT 79
                </li>
              </ul>
            </div>
