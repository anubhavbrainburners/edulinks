  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
          Join 15,000+ international students from 120+ <br/>countries.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Industry placements and graduate employment<br/> support.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Beaches, culture, nightlife, and global networking<br/> opportunities.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Academic fairs, innovation summits, and student<br/> festivals.
        </>
      ),
    },
  ];
