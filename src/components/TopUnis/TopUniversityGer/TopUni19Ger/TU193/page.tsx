...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Medicine</> },
  { id: 2, label: <>Faculty of Science</> },
  { id: 3, label: <>Faculty of Humanities</> },
 
  { id: 4, label: <>Faculty of Computer Science and Mathematics</> },
];
                  ...
                  {id === 2 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                          Bachelor of Science (Biology / Physics / Chemistry)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                        3 years
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold"> Master of Science (Molecular Cell Biology)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years
                        </div>
