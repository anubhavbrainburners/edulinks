  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        Founded in 1402, the University of Würzburg is one of Germany's oldest and most prestigious
research universities. Renowned for excellence in science, medicine, and humanities, JMU has
produced 14 Nobel laureates and is a key player in global research collaborations.
