...
const points = [
  ...
  {
    text: "Historic legacy of academic excellence and Nobel Prize-winning research",
    style: "absolute left-[54%] top-[20%] w-[30%] text-left",
  },
  {
    text: " Strong in medicine, natural sciences, and humanities",
    style: "absolute left-[40%] top-[80%] w-[28%] text-center",
  },
  {
    text: " Located in Würzburg, a safe and vibrant university city",
