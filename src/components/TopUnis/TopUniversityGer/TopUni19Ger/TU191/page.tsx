  ...
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
       ...
       Ranked among the Top 250 universities worldwide,<br/> the University of Würzburg hosts over 28,000
students,<br/> including 3,000 international students. It offers a wide<br/> range of academic programs across
10 faculties, <br/>emphasizing research-driven learning and innovation <br/>in a student-friendly Bavarian city.
