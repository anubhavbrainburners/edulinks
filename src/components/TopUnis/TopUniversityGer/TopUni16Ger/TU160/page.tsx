    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
         ...
         Founded in 1828, TU Dresden is one of Germany's largest and most prestigious technical
universities. Known for its research excellence and interdisciplinary education, it is part of the
German Excellence Strategy and a member of the TU9 Alliance of top German technical
universities.
            </span>
        </p>
