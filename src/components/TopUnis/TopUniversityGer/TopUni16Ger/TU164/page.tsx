...
const REASONS = [
  {
    ...
    text: (
      <> Main Campus (Südvorstadt) - Historic architecture blended with modern research buildings.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Advanced laboratories, innovation centres, and tech startups..
  ...
  },
  {
    ...
    text: (
      <>
        Libraries, co-working hubs, and global research networks.
  ...
  },
  {
    ...
    text: (
      <>
       Affordable student housing and excellent transport facilities.
  ...
  },
  {
    ...
    text: (
      <>
        Partnerships with Fraunhofer and Max Planck research institutions.
      </>
    ),
  },
];
