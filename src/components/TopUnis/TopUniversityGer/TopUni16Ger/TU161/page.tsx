...
export default function TU161() {
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      ...
      Ranked among the Top 200 universities globally,<br/> TU Dresden has over 32,000 students, including<br/>
more than 8,000 international students from over<br/> 120 countries. The university excels in
engineering, <br/>natural sciences, computer science, and medicine, <br/>with strong connections to industry
