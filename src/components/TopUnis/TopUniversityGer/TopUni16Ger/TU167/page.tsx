...
const faqs = [
  {
    question: "What is TU Dresden known for?",
    answer:
      "TU Dresden is known for excellence in engineering, computer science, and research innovation.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "TU Dresden is tuition-free; students only pay a semester contribution of approximately EUR 280",
  },
  {
    question: "Does TU Dresden offer scholarships for international students?",
    answer:
      "Yes - DAAD scholarships, Erasmus+, and TU Dresden merit awards are available.",
  },
  {
