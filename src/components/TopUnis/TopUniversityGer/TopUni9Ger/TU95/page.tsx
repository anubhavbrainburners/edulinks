...
export default function TU95() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
        Study in one of<br/> Europe's most dynamic and creative cities.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Collaboration with industry and global startups.
    ...
    },
    {
      ...
      body: (
        <>
          250+ clubs, networking events, and cultural programs.
        </>
      ),
    },
  ];
