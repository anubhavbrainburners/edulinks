...
const REASONS = [
  {
    ...
    text: (
      <> Central Campus (Charlottenburg) - Located in Berlin's academic and innovation district.
  ...
  },
  {
    ...
    text: (
      <>
          Modern laboratories, digital research hubs, and co-working spaces.
  ...
  },
  {
    ...
    text: (
      <>
       Startup incubators and innovation centres supporting student entrepreneurs.
  ...
  },
  {
    ...
    text: (
      <>
        Student housing, career support, and extensive sports facilities
  ...
  },
  {
    ...
    text: (
      <>
       Partnerships with Berlin's research clusters and global technology firms.
      </>
    ),
  },
];
