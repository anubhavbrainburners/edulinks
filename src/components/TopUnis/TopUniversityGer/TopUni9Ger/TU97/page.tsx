...
const faqs = [
  {
    question: " What is TU Berlin known for?",
    answer:
      "TU Berlin is known for excellence in engineering, computer science, and research-driven innovation.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "TU Berlin is tuition-free; students only pay a semester contribution of approximately EUR 310",
  },
  {
    question: "Does TU Berlin offer scholarships for international students?",
    answer:
      " Yes - TU Berlin offers DAAD scholarships, Erasmus+ funding, and merit-based awards",
  },
  {
