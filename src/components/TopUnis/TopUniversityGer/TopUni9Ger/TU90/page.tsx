    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
       ...
       Technical University of Berlin (TU Berlin)
        ...
        Founded in 1879, the Technical University of Berlin is one of Germany's leading institutions for
science, engineering, and technology. Known for its strong focus on innovation, entrepreneurship,
and international collaboration, TU Berlin is a hub for research and industry partnerships in Europe's
