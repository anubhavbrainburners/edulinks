...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Electrical Engineering and Computer Science</> },
  { id: 2, label: <>Faculty of Mechanical Engineering and Transport Systems</> },
  { id: 3, label: <>Faculty of Planning, Building, and Environment</> },
 
  { id: 4, label: <>Faculty of Economics and Management</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Automotive Systems</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                           Bachelor's in Architecture/Planning + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           Intake: April & October
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Science (Innovation Management)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                         2 years
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                           Bachelor's in Business/Engineering + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: April & October
                        </div>
