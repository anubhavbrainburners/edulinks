...
const points = [
  ...
  {
    text: "Member of TU9 - Germany's leading network of technical universities",
    style: "absolute left-[15%] top-[-7%] w-[30%] text-center",
  },
  {
    text: " Located in Berlin - Europe's startup and innovation capital",
    style: "absolute left-[54%] top-[20%] w-[30%] text-left",
  },
  {
    text: "Tuition-free education with semester contribution (~EUR 310)",
    style: "absolute left-[40%] top-[80%] w-[26%] text-center",
  },
  {
    text: "Strong research collaborations with Siemens, BMW, and Fraunhofer Institutes",
    style: "absolute right-[-11%] top-[63%] w-[34%] text-left",
  },
];
...
export default function TU92() {
  return (
    <section className="relative w-full flex flex-col items-center py-10 mt-20">
      ...
      Why Technical University of Berlin?
