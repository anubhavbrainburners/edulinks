  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        Founded in 1810, Humboldt University of Berlin is one of Germany's oldest and most prestigious
universities, widely regarded as the "Mother of Modern Universities." Known for its excellence in the
humanities, natural sciences, and social sciences, it has produced over 50 Nobel laureates,
including Albert Einstein and Max Planck.
            </span>
        </p>
