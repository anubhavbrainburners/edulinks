...
const REASONS = [
  {
    ...
    text: (
      <>Main Campus (Unter den Linden) - Historic architecture with modern facilities in central Berlin
      </>
    ),
  },
  {
    ...
    text: (
      <>
         Adlershof Campus - Science and technology hub with world-class labs.
  ...
  },
  {
    ...
    text: (
      <>
       Extensive libraries, innovation hubs, and interdisciplinary research centres.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Student housing, cultural centres, and recreation areas
  ...
  },
  {
    ...
    text: (
      <>
       Partnerships with Berlin's tech ecosystem and research institutes
      </>
    ),
  },
];
