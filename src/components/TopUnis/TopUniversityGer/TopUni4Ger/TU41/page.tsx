  ...
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        Ranked among the Top 120 universities globally, <br/>Humboldt University enrolls over 35,000 students,<br/>
including more than 6,000 international students <br/>from 120+ countries. It offers a broad range of
academic<br/> programs in arts, sciences, and law, emphasizing <br/>research-led teaching and innovation.
