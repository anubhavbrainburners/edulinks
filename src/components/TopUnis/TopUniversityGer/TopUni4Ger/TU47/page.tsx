...
const faqs = [
  {
    question: "What is Humboldt University of Berlin known for?",
    answer:
      "Humboldt is known for its contributions to modern education, world-class research, and its Nobel laureate legacy.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "  HU Berlin is tuition-free; students only pay a semester contribution of approximately EUR 150.",
  },
  {
    question: "Does Humboldt offer scholarships for international students?",
    answer:
      " Yes - DAAD scholarships, Erasmus+, and Humboldt Research Fellowships are available.",
  },
  {
