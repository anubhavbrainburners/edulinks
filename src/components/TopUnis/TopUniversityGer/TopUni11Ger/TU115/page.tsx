...
export default function TU115() {
  const cards: Card[] = [
    ...
    {
      title: "Historic University Town",
      body: (
        <>
        Study in one of Germany's oldest student cities
        </>
      ),
    },
    {
    ...
    },
    {
      ...
      body: (
        <>
        150+ student <br/>clubs, research groups, and cultural associations.
  ...
  return (
    <main className="px-6 py-12 mt-35">
     ...
     Life at University of Göttingen
