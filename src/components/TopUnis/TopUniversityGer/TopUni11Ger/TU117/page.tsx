...
const faqs = [
  {
    question: " What is the University of Göttingen known for?",
    answer:
      "Göttingen is known for its excellence in natural sciences, humanities, and global research.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      " Göttingen is tuition-free; students only pay a semester contribution of approximately EUR 380.",
  },
  {
    question: "  Does Göttingen offer scholarships for international students?",
    answer:
      "Yes - DAAD scholarships, Erasmus+, and university merit awards are available.",
  },
  {
