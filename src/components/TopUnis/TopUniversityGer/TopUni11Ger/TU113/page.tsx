...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Natural Sciences</> },
  { id: 2, label: <>Faculty of Economics and Social Sciences</> },
  { id: 3, label: <>Faculty of Humanities</> },
 
  { id: 4, label: <>Faculty of Computer Science</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Science (Development Economics)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            Master of Arts (Theology / Cultural Studies)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years 
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Applied Data Science</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                         2 years
                        </div>
