    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
         ...
         Founded in 1737, the University of Göttingen is one of Germany's most historic and
research-intensive universities. Known for its leadership in natural sciences, humanities, and law, it
has a strong tradition of innovation, with 47 Nobel laureates associated with the university.
