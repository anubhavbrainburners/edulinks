...
const REASONS = [
  {
    ...
    text: (
      <>  Central Campus - Historic academic buildings with modern research centres.
  ...
  },
  {
    ...
    text: (
      <>
          Göttingen State and University Library - One of the largest academic libraries in Germany.
  ...
  },
  {
    ...
    text: (
      <>
        Laboratories, innovation hubs, and technology centres.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Affordable student housing, recreation centres, and international student services.
  ...
  },
  {
    ...
    text: (
      <>
        Partnerships with Max Planck Institutes and global universities
      </>
    ),
  },
];
