  ...
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
       ...
       Ranked among the Top 200 universities globally,<br/> the University of Göttingen hosts over 30,000<br/>
students, including 4,000 international students<br/> from more than 130 countries. It offers a wide range<br/>
of programs with a strong focus on interdisciplinary<br/> research and global academic cooperation.
