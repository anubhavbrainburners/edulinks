...
const points = [
  ...
  {
    text: " Tuition-free education with semester contribution (~EUR 320)",
    style: "absolute left-[15%] top-[-7%] w-[30%] text-center",
  },
  {
    text: "Strong programs in law, business, medicine, and natural sciences",
    style: "absolute left-[54%] top-[20%] w-[30%] text-left",
  },
  {
    text: "Member of Germany's Excellence Strategy",
    style: "absolute left-[40%] top-[80%] w-[30%] text-center",
  },
  {
    text: " Located in Münster, one of Germany's most livable and student-friendly cities",
