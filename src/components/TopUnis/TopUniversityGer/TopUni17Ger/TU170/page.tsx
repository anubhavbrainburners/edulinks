  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
        University of Münster (Westfälische Wilhelms-Universität Münster - WWU Münster)
        </h1>
        ...
        Founded in 1780, the University of Münster is one of Germany's largest and most prestigious
universities. Known for academic excellence, innovation, and global engagement, it offers a broad
range of programs across disciplines, with particular strength in law, business, medicine, and natural
sciences
