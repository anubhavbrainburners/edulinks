...
const REASONS = [
  {
    ...
    text: (
      <> Central Münster Campus - Located across the historic and modern city areas
  ...
  },
  {
    ...
    text: (
      <>
          State-of-the-art research laboratories and libraries
      </>
    ),
  },
  {
    ...
    text: (
      <>
         Innovation hubs and entrepreneurship centres.
  ...
  },
  {
    ...
    text: (
      <>
         Affordable student accommodation and strong international student support.
  ...
  },
  {
    ...
    text: (
      <>
       Sports facilities, cultural events, and international networking
      </>
    ),
  },
];
