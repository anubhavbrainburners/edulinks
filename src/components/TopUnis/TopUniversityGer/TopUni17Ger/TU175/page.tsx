...
export default function TU175() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
         Study in Münster,<br/> ranked among Germany's best cities to live in.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Focused on science, medicine, and law.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        200+ student <br/>organizations, clubs, and social initiatives.
        </>
      ),
    },
  ];
