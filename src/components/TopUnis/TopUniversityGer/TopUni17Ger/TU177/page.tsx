...
const faqs = [
  {
    question: "What is the University of Münster known for?",
    answer:
      "Münster is known for academic excellence in law, medicine, business, and science.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "The University of Münster is tuition-free; students only pay a semester contribution of approximately EUR 320.",
  },
  {
    question: " Does Münster offer scholarships for international students?",
    answer:
      "Yes - DAAD scholarships, Erasmus+, and university merit programs are available..",
  },
  {
