...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Biosciences</> },
  { id: 2, label: <>Faculty of Engineering and Computer Science</> },
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold"> Master of Data and Computer Science</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                             Bachelor of Science (Computer Science/Physics/Biology)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          4 years
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          BBachelor's in Health/Science + IELTS 6.5 
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: September
                        </div>
