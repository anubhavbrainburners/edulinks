...
export default function TU35() {
  const cards: Card[] = [
    ...
    {
      title: "Vancouver Lifestyle",
      body: (
        <>
         Safe, vibrant, and consistently<br/>  ranked among the world's best cities.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         Access to world-class labs<br/>  and partnerships with global industries
        </>
      ),
    },
    {
      ...
      body: (
        <>
           Over 350 student clubs, cultural<br/>  events, and community engagement programs.
        </>
      ),
    },
  ];
