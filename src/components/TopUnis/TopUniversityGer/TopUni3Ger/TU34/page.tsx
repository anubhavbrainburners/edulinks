...
const REASONS = [
  {
    ...
    text: (
      <>Vancouver Campus - world-renowned research campus located near the Pacific Ocean and
coastal mountains Vancouver Campus
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Okanagan Campus - modern and community-focused with smaller class sizes and research
opportunities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Cutting-edge laboratories, libraries, and sustainability research centres
      </>
    ),
  },
  {
    ...
    text: (
      <>
         UBC Innovation Hub for entrepreneurship and tech startups.
  ...
  },
  {
    ...
    text: (
      <>
        Comprehensive student housing, sports, and wellness facilities
      </>
    ),
  },
];
