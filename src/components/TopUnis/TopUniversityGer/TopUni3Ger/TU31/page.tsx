  ...
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        Ranked among the Top 50 universities worldwide,<br/> Heidelberg University has over 29,000 students,<br/>
including 6,000 international students from more<br/> than 120 countries. It offers programs in medicine,<br/>
natural sciences, humanities, and social sciences <br/>with a strong focus on interdisciplinary research<br/>
and innovation
          </p>
