...
const faqs = [
  {
    question: "What is UBC known for?",
    answer:
      "UBC is known for research excellence, sustainability, and strong programs in business,engineering, and health sciences.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      " Tuition fees range between CAD $46,000 - $68,000 per year depending on the program.",
  },
  {
    question: " Does UBC offer scholarships for international students?",
    answer:
      "Yes - UBC offers the International Major Entrance Scholarship (IMES) and the Outstanding International Student Award (OIS).",
  },
  {
    question: "Can international students work while studying?",
    answer:
      "Yes, students can work up to 20 hours per week during studies and full-time during scheduled breaks.",
  },
];

export default function TU37() {
