  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
       ...
       Founded in 1386, Heidelberg University is Germany's oldest university and one of Europe's most
prestigious institutions for research and higher learning. Known for academic excellence, innovation,
and a global research network, it consistently ranks among the top universities in the world.
            </span>
        </p>
