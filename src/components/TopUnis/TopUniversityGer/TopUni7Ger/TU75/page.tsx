...
export default function TU75() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
         One of Germany's most charming university towns.
        </>
      ),
    },
    {
      ...
      body: (
        <>
           Leading research<br/> in medicine and environmental studies
        </>
      ),
    },
    {
      ...
      body: (
        <>
       200+ student<br/> groups, sports clubs, and cultural events.
  ...
  return (
    ...
    Life at University of Tübingen
