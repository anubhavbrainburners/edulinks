...
const faqs = [
  {
    question: "What is the University of Tübingen known for?",
    answer:
      " Tübingen is known for medicine, natural sciences, and humanities, and is one of Germany's oldest universities.",
  },
  {
    question: " What are the tuition fees for international students?",
    answer:
      "Tübingen is tuition-free; students only pay a semester contribution of approximately EUR 150.",
  },
  {
    question: "Does Tübingen offer scholarships for international students?",
    answer:
      "Yes - DAAD, Baden-Württemberg, and university-specific scholarships are available.",
  },
  {
