...
export default function TU71() {
  return (
    <section className="max-w-full py-12 px-40 mt-30">
     ...
     Ranked among the Top 180 universities worldwide, <br/>the University of Tübingen hosts more than
28,000 <br/>students, including 4,800 international students from<br/> over 130 countries. It is part of the
German Excellence<br/> Strategy, known for its cutting-edge research and <br/>interdisciplinary academic
environment.
