  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        Founded in 1477, the University of Tübingen is one of Germany's oldest and most prestigious
universities. It is globally recognized for its excellence in medicine, natural sciences, humanities, and
social sciences. Located in a picturesque university town, Tübingen offers a unique blend of
tradition, research, and innovation.
