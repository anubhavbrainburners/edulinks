...
const ITEMS: Item[] = [
  ...
  { id: 4, label: <>Faculty of Economics and Social Sciences</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold"> Master of Science (Molecular Medicine)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                         2 years
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor's in Life Sciences + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                            Intake: April & October
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">  Master of Economics</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                        2 year
                        </div>
