...
const REASONS = [
  {
    ...
    text: (
      <>Central Campus - A mix of historic and modern academic buildings in Tübingen's old town.
  ...
  },
  {
    ...
    text: (
      <>
           State-of-the-art laboratories, research hospitals, and digital learning centres.
  ...
  },
  {
    ...
    text: (
      <>
       Strong ties with Max Planck Institutes and German research foundations
  ...
  },
  {
    ...
    text: (
      <>
        Student accommodation, libraries, and cultural clubs
  ...
  },
  {
    ...
    text: (
      <>
        Green surroundings with hiking trails, cafés, and cultural venues nearby
      </>
    ),
  },
];
