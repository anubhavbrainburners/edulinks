...
const points = [
  ...
  {
    text: "Tuition-free education with semester contribution (~EUR 340)",
    style: "absolute left-[54%] top-[20%] w-[30%] text-left",
  },
  {
    text: "Known for sustainability, climate, and marine research",
    style: "absolute left-[40%] top-[80%] w-[26%] text-center",
  },
  {
    text: " Located in Hamburg - Germany's second-largest and most international city",
