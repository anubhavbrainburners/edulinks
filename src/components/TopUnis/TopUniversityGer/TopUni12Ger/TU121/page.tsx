  ...
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
       ...
       Ranked among the Top 200 universities globally,<br/> the University of Hamburg hosts more than 44,000<br/>
students, including 6,000 international students from<br/> over 130 countries. It offers diverse programs
across <br/>humanities, sciences, law, business, and medicine, with<br/> a focus on innovation and global
collaboration.
