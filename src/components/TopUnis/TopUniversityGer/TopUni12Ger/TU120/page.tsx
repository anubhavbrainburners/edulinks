  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        Founded in 1919, the University of Hamburg is one of Germany's largest and most comprehensive
universities. It is known for its strong emphasis on sustainability, climate research, and
interdisciplinary studies, and is a member of the German Excellence Strategy.
