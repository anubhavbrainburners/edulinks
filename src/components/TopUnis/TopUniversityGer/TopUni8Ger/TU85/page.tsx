...
export default function TU85() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
         Study in<br/> Germany's environmental capital near the Alps.
    ...
    },
    {
      ...
      body: (
        <>
           Strong focus on sustainability and life sciences.
    ...
    },
    {
      ...
      body: (
        <>
         180+ student<br/> groups, outdoor clubs, and cultural societies
