...
const ITEMS: Item[] = [
  ...
  { id: 2, label: <>Faculty of Environment and Natural Resources</> },
  { id: 3, label: <>Faculty of Engineering</> },
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold"> Master of Environmental Governance</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                          Bachelor of Arts (Philosophy / German Studies)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          3 years 
