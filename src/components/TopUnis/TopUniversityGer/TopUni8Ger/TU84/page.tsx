...
const REASONS = [
  {
    ...
    text: (
      <>  Central Freiburg Campus - Historic yet modern campus near the Black Forest
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Advanced laboratories, libraries, and research centres in sustainability and technology.
  ...
  },
  {
    ...
    text: (
      <>
       Close cooperation with Max Planck and Fraunhofer research institutes.
  ...
  },
  {
    ...
    text: (
      <>
         Affordable student housing, green spaces, and international community.
  ...
  },
  {
    ...
    text: (
      <>
        Focus on eco-friendly initiatives and student-driven innovation projects
      </>
    ),
  },
];
