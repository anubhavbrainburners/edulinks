...
const points = [
  ...
  {
    text: "Tuition-free education with minimal semester fee (~EUR 155)",
    style: "absolute left-[15%] top-[-7%] w-[30%] text-center",
  },
  {
    text: " Recognized for excellence in sustainability, medicine, and life sciences",
    style: "absolute left-[54%] top-[20%] w-[33%] text-left",
  },
  {
    text: " Located in one of Germany's most environmentally conscious cities",
    style: "absolute left-[40%] top-[80%] w-[30%] text-center",
  },
  {
    text: "Multidisciplinary learning with strong research collaboration",
