...
export default function TU81() {
  return (
    ...
    Ranked among the Top 200 universities worldwide,<br/> the University of Freiburg has over 25,000
students,<br/> including 4,000 international students from 120+ <br/>countries. It is part of the German
Excellence Strategy<br/> and maintains close ties with major research institutions <br/>like the Max Planck
and Fraunhofer Societies.
