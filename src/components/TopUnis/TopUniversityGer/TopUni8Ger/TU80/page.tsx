...
export default function TU80() {
  ...
  return (
    ...
    Founded in 1457, the University of Freiburg is one of Germany's oldest and most prestigious
universities. Known for its world-class research, academic freedom, and innovation, Freiburg is a
leader in sustainability, life sciences, and humanities. The university combines tradition with
cutting-edge science in one of Europe's greenest cities
