...
const faqs = [
  {
    question: "What is the University of Freiburg known for?",
    answer:
      " Freiburg is known for environmental science, medicine, and humanities, and for being a leader in sustainability and research.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Freiburg is tuition-free; students only pay a semester contribution of approximately EUR 155.",
  },
  {
    question: "Does Freiburg offer scholarships for international students?",
    answer:
      "Yes - DAAD scholarships, Baden-Württemberg scholarships, and merit-based awards are available.",
  },
  {
