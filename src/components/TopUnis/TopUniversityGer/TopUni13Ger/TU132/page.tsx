...
const points = [
  ...
  {
    text: "Member of Germany's TU9 Alliance of top technical universities",
    style: "absolute left-[15%] top-[-7%] w-[30%] text-center",
  },
  {
    text: "Tuition-free education with a semester contribution (~EUR 300)",
    style: "absolute left-[54%] top-[20%] w-[30%] text-left",
  },
  {
    text: " Strong industry collaboration in automotive and aerospace fields",
    style: "absolute left-[40%] top-[80%] w-[26%] text-center",
  },
  {
    text: "  Located in Stuttgart - a hub of innovation and engineering",
