...
export default function TU130() {
  ...
  return (
    ...
    >
      ...
      Founded in 1829, the University of Stuttgart is one of Germany's leading technical universities,
known for its excellence in engineering, architecture, and computer science. It combines strong
academic foundations with applied research and industry collaboration, particularly in the automotive
