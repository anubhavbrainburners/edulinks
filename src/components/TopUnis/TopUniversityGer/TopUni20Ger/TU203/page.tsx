...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Life Sciences</> },
  { id: 2, label: <>Faculty of Economics and Management Science</> },
  { id: 3, label: <>Faculty of Humanities and Social Sciences</> },
 
  { id: 4, label: <>Faculty of Medicine</> },
];
                  ...
                  {id === 2 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                         Bachelor of Science (Economics / Business Studies)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                        3 years 
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Science (International Economics)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                            Bachelor's in Business/Economics + IELTS 6.5 
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           Intake: April & October
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            Master of Arts (Cultural Studies / Global Studies)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years 
