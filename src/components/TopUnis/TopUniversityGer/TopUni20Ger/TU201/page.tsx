...
export default function TU201() {
  return (
   ...
   Ranked among the Top 300 universities worldwide, <br/>the University of Leipzig hosts over 30,000
students,<br/> including 4,000 international students from more <br/> than 120 countries. It offers diverse
programs and  <br/>interdisciplinary research in collaboration with  <br/>global institutions.
