...
export default function TU200() {
  ...
  return (
    ...
    >
      ...
      Founded in 1409, the University of Leipzig is one of the oldest universities in Germany and Europe.
Known for its excellence in research and teaching, it has a rich academic tradition, with notable
alumni including Goethe, Nietzsche, and Angela Merkel. The university is globally recognized for its
programs in life sciences, humanities, and social sciences.
