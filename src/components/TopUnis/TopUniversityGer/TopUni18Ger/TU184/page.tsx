...
const REASONS = [
  {
    ...
    text: (
      <> Erlangen Campus - Main site with state-of-the-art research centres and engineering facilities.
  ...
  },
  {
    ...
    text: (
      <>
          Nuremberg Campus - Home to business, economics, and law faculties.
  ...
  },
  {
    ...
    text: (
      <>
         Innovation labs and startup incubators promoting entrepreneurship.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       International student office, modern housing, and cultural events
  ...
  },
  {
    ...
    text: (
      <>
        Research partnerships with Siemens, Adidas, and Fraunhofer Institutes.
      </>
    ),
  },
];
