...
export default function TU181() {
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      ...
      Ranked among the Top 250 universities globally,<br/> FAU has more than 39,000 students, including
over<br/> 6,000 international students from 120+ countries.<br/> The university is well-known for its close
collaboration <br/>with industries such as Siemens, Adidas, and Bosch, <br/>and its leadership in artificial
intelligence and materials<br/> science
