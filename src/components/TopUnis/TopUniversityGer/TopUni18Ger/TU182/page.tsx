...
const points = [
  ...
  {
    text: "Tuition-free education with semester contribution (~EUR 140)",
  ...
  {
    text: "Strong reputation in engineering, business, and sciences",
    style: "absolute left-[43%] top-[80%] w-[26%] text-center",
  },
  {
    text: "Located in Bavaria - a hub for technology and research",
...
export default function TU182() {
  return (
    <section className="relative w-full flex flex-col items-center py-10 mt-20">
     ...
     Why Friedrich-Alexander University Erlangen-Nuremberg?
