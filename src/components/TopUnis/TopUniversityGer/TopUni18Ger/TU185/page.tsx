...
export default function TU185() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
         Study in Bavaria's high-tech corridor.
        </>
      ),
    },
    {
      title: "Research & Industry Links ",
      body: (
        <>
    ...
    },
    {
      ...
      body: (
        <>
        200+ clubs,<br/> student associations, and innovation programs.
  ...
  return (
    <main className="px-6 py-12 mt-35">
     ...
     Life at FAU Erlangen-Nuremberg
