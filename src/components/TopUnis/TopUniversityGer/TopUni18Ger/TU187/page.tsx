...
const faqs = [
  {
    question: "What is FAU Erlangen-Nuremberg known for?",
    answer:
      " FAU is known for innovation, engineering, and research collaboration with top global industries.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "FAU is tuition-free; students only pay a semester contribution of approximately EUR 140.",
  },
  {
    question: "Does FAU offer scholarships for international students?",
    answer:
      "Yes - DAAD scholarships, Erasmus+, and FAU Excellence Scholarships are available",
  },
  {
