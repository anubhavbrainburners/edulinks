  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
       ...
       Founded in 1743, Friedrich-Alexander University Erlangen-Nuremberg (FAU) is one of Germany's
top public research universities. Renowned for innovation, entrepreneurship, and interdisciplinary
education, FAU ranks among Europe's leading institutions for engineering, science, and business
studies.
