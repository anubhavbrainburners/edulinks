...
const faqs = [
  {
    question: " What is Free University of Berlin known for?",
    answer:
      "FU Berlin is known for its strong research focus in social sciences, natural sciences, and humanities",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "FU Berlin is tuition-free; students only pay a semester contribution of around EUR 300.",
  },
  {
    question: "Does Free University of Berlin offer scholarships for international students?",
    answer:
      " Yes - DAAD scholarships, Erasmus+, and FU merit scholarships are available",
  },
  {
