...
const REASONS = [
  {
    ...
    text: (
      <>Dahlem Campus - Main campus featuring historic buildings and modern research facilities.
  ...
  },
  {
    ...
    text: (
      <>
           Cutting-edge laboratories, digital learning centres, and libraries.
  ...
  },
  {
    ...
    text: (
      <>
       Student housing, language centres, and cafes spread across Berlin.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Research partnerships with the Max Planck Society and Charité Medical School.
  ...
  },
  {
    ...
    text: (
      <>
        Dedicated international office for visa and residence support.
