  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
       ...
       Established in 1948, the Free University of Berlin is one of Germany's top-ranked research
institutions, known for its excellence in humanities, social sciences, and natural sciences. Founded
on the principles of academic freedom, it remains a global leader in innovation, international
