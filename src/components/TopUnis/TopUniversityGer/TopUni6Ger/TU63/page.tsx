...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Political and Social Sciences</> },
  { id: 2, label: <>Faculty of Natural and Life Sciences</> },
  { id: 3, label: <>Faculty of Law and Business</> },
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Science (Physics / Biochemistry)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                           achelor's in Business/Economics + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           Intake: April & October
                        </div>
