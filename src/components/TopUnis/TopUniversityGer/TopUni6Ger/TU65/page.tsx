...
export default function TU65() {
  const cards: Card[] = [
    ...
    {
      title: "Berlin Lifestyle",
      body: (
        <>
        Study in Germany's <br/>most international and creative city
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Excellence in <br/>social sciences, politics, and natural sciences
        </>
      ),
    },
    {
      ...
      body: (
        <>
         200+ student<br/> societies, research groups, and cultural clubs.
  ...
  return (
    <main className="px-6 py-12 mt-35">
      ...
      Life at Free University of Berlin ?
