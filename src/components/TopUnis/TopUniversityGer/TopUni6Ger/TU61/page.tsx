  ...
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
       ...
       Ranked among the Top 100 universities worldwide,<br/> FU Berlin has more than 33,000 students,
including<br/> over 6,000 international students from 130+ countries.<br/> It is a member of the German
Excellence Initiative and <br/>a part of the Berlin University Alliance, fostering top-<br/>tier research and
education standards.
