...
export default function TU5() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
         Study in Germany's tech and cultural capital.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         Collaboration with BMW, Siemens, and research labs
        </>
      ),
    },
    {
      ...
      body: (
        <>
          International clubs, startup events, and festivals.
        </>
      ),
    },
  ];
    ...
    <main className="px-6 py-12 mt-35">
      <div className="max-w-[1100px] mx-auto">
        <h1 className="text-center text-4xl font-bold mb-18 text-[#545454]">
          Life at Technical University of Munich
