...
const faqs = [
  {
    question: "What is TUM known for?",
    answer:
      "TUM is Germany's top-ranked university, known for engineering, computer science, and technology research.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      " TUM is tuition-free; students only pay a semester contribution of around EUR 150.",
  },
  {
    question: "Does TUM offer scholarships for international students?",
    answer:
      "Yes - TUM provides merit scholarships, DAAD scholarships, and international aid programs.",
  },
  {
