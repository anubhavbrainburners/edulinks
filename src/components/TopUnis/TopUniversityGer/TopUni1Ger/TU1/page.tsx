      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
           Ranked among the Top 30 universities globally,<br/> TUM is home to over 50,000 students, including
more<br/>  than 15,000 international students from 130+<br/>  countries. The university is renowned for its
pioneering<br/>  research in engineering, computer science, medicine, and<br/>  natural sciences. TUM has
close collaborations with major<br/>  global industries like BMW, Siemens, and Airbus.
