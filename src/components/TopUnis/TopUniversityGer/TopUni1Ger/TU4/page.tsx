...
const REASONS = [
  {
    ...
    text: (
      <>
          Campuses in Munich, Garching, Freising, and Heilbronn - equipped with advanced labs, libraries,
and research centres.
  ...
  },
  {
    ...
    text: (
      <>
         Innovation and Entrepreneurship Centre (TUM Venture Labs) supporting 70+ startups annually
      </>
    ),
  },
  {
    ...
    text: (
      <>
          High-tech infrastructure in AI, robotics, and life sciences.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Student residences, cafes, and athletic facilities.
  ...
  },
  {
    ...
    text: (
      <>
        Global partnerships with over 500 universities and corporations.
      </>
    ),
  },
];
