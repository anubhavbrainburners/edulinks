      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
           Founded in 1868, the Technical University of Munich (TUM) is one of Europe's leading universities,
recognized globally for its excellence in science, engineering, technology, and innovation. Located
in the heart of Germany's industrial and research hub, TUM is a hub for forward-thinking education
