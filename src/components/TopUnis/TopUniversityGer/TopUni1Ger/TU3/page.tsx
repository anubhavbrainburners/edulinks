...
const ITEMS: Item[] = [
  { id: 1, label: <>School of Engineering and Design</> },
  { id: 2, label: <>School of Computation, Information and Technology</> },
  { id: 3, label: <>School of Life Sciences</> },
 
  { id: 4, label: <>TUM School of Management</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 1 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          High School (Maths/Physics) + English/German proficiency
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: October
                        </div>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor's in Engineering + IELTS 6.5 / TestDaF 
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Data Engineering & Analytics</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor's in Science/IT + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                         Intake: April & October
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Management</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years
                        </div>
