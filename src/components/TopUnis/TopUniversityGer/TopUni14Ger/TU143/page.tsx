...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Management, Economics and Social Sciences</> },
  { id: 2, label: <>Faculty of Law</> },
  { id: 3, label: <>Faculty of Medicine</> },
 
  { id: 4, label: <>Faculty of Arts and Humanities</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Laws (LLM International Law)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                          Bachelor of Arts (Philosophy / History / Linguistics)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          3 years 
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold"> Master of Arts (Media and Cultural Studies)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                         2 years
                        </div>
