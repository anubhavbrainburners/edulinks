  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        Founded in 1388, the University of Cologne is one of Europe's oldest and largest universities.
Known for its academic excellence and research impact, the university is particularly strong in
economics, law, medicine, and social sciences. It is a member of Germany's Excellence Strategy for
