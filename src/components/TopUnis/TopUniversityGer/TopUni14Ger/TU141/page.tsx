...
export default function TU141() {
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      ...
      Ranked among the Top 200 universities globally,<br/> the University of Cologne has over 50,000
students,<br/> including 8,000 international students from more than<br/> 130 countries. Its central location in
Cologne provides <br/>access to global business networks, cultural diversity,<br/> and vibrant student life.
