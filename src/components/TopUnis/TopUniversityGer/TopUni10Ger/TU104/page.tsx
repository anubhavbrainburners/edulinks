...
const REASONS = [
  {
    ...
    text: (
      <>Central Bonn Campus - Located along the Rhine River with historic and modern facilities.
  ...
  },
  {
    ...
    text: (
      <>
        Advanced research laboratories, digital learning centres, and libraries.
  ...
  },
  {
    ...
    text: (
      <>
        Student residences, cafes, sports complexes, and international student offices.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Collaborations with UN agencies and German research centres.
  ...
  },
  {
    ...
    text: (
      <>
      A peaceful, green, and student-friendly city.
      </>
    ),
  },
];
