...
export default function TU101() {
  return (
    <section className="max-w-full py-12 px-40 mt-30">
     ...
     Ranked among the Top 100 universities worldwide,<br/> the University of Bonn hosts over 35,000
students,<br/> including 5,500 international students from more <br/>than 130 countries. The university is
celebrated for <br/>its research excellence, strong interdisciplinary <br/>programs, and global academic
collaborations.
