...
export default function TU105() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
      Study in Bonn, Germany's former capital city.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        Leading academic excellence in multiple disciplines.
    ...
    },
    {
      ...
      body: (
        <>
         200+ student<br/> groups, language clubs, and research societies.
