...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Mathematics and Natural Sciences</> },
  { id: 2, label: <> Faculty of Economics and Social Sciences</> },
  { id: 3, label: <>Faculty of Medicine</> },
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 1 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                         High School (Maths/Science) + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           Intake: October
                        </div>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor's in Science/Engineering + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Science (Economics)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor's in Economics + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           Intake: April & October
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            Bachelor of Medicine (Human Medicine)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                         6 years
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                        High School (Biology/Chemistry) + TestDaF 
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: October
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                         Bachelor of Arts (Philosophy / History)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          3 years
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold"> Master of Arts (Cultural Studies)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                         2 years
                        </div>
