    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          ...
          Founded in 1472, Ludwig Maximilian University of Munich (LMU Munich) is one of Europe's oldest
and most prestigious research universities. Known for academic excellence, world-class research,
and a strong international focus, LMU is consistently ranked among the top universities in Europe
and globally.
            </span>
        </p>
