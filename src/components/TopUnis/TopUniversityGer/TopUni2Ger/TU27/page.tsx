...
const faqs = [
  {
    question: "What is LMU Munich known for?",
    answer:
      "LMU is known for its academic excellence in science, medicine, and humanities, and its world-class research collaborations.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      " LMU is tuition-free; students only pay a semester contribution fee of approximately EUR 150.",
  },
  {
    question: "Does LMU offer scholarships for international students?",
    answer:
      "Yes - LMU offers merit scholarships, DAAD programs, and research funding",
  },
  {
