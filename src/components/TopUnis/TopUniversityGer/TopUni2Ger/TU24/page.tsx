...
const REASONS = [
  {
    ...
    text: (
      <>
       Central Munich Campus - Historic yet modern, located in the heart of the city
  ...
  },
  {
    ...
    text: (
      <>
         Research centres in AI, life sciences, and environmental sustainability
      </>
    ),
  },
  {
    ...
    text: (
      <>
          - Advanced libraries, laboratories, and student workspaces.
  ...
  },
  {
    ...
    text: (
      <>
        Residences, cafes, sports complexes, and cultural hubs
  ...
  },
  {
    ...
    text: (
      <>
       International Office providing strong support for global students.
      </>
    ),
  },
];
