...
const ITEMS: Item[] = [
  ...
  { id: 2, label: <>Faculty of Business Administration (Munich School of Management)</> },
  { id: 3, label: <>Faculty of Medicine</> },
 
  { id: 4, label: <>Faculty of Social Sciences</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Arts (Economics)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                         2 years
                        </div>
