...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Mechanical Engineering</> },
  { id: 2, label: <>Faculty of Electrical Engineering and Information Technology</> },
  { id: 3, label: <>Faculty of Computer Science</> },
 
  { id: 4, label: <>Faculty of Civil Engineering, Geo, and Environmental Sciences</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Science (Electrical Engineering and Information Technology)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years
                        </div>
                    ...
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                       ...
                       <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                         Bachelor's in Engineering/Environment + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: April & October
                        </div>
