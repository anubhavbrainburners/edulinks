...
export default function TU151() {
  return (
    <section className="max-w-full py-12 px-40 mt-30">
      ...
      Ranked among the Top 150 universities worldwide,<br/> KIT has over 24,000 students, including 5,000<br/>
international students from 120+ countries. It is<br/> part of the German Excellence Strategy and is
known<br/> for its strong ties to industry and pioneering work in <br/>sustainability, energy systems, and digital
technology.
