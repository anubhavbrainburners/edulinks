  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        Established in 2009 through the merger of the University of Karlsruhe and the Karlsruhe Research
Center, the Karlsruhe Institute of Technology (KIT) is one of Europe's top universities for
engineering, natural sciences, and computer science. It is globally recognized for its innovation and
contribution to cutting-edge technology and research.
