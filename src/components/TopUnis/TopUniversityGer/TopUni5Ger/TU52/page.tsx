...
const points = [
  ...
  {
    text: "Germany's top technical university for Engineering and Technology",
    style: "absolute left-[15%] top-[-7%] w-[30%] text-center",
  },
  {
    text: "Tuition-free education with a semester contribution of ~EUR 300",
    style: "absolute left-[54%] top-[20%] w-[30%] text-left",
  },
  {
    text: " Industry-oriented programs and applied research collaboration",
    style: "absolute left-[40%] top-[80%] w-[30%] text-center",
  },
  {
    text: "Location near Belgium and the Netherlands offering European exposure",
