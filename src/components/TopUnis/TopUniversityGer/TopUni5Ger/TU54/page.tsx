...
const REASONS = [
  {
    ...
    text: (
      <> Central Campus - Cutting-edge laboratories, modern lecture halls, and research facilities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Innovation hubs and technology parks with strong industry collaboration.
  ...
  },
  {
    ...
    text: (
      <>
       Libraries, startup incubators, and design studios for engineering and technology.
  ...
  },
  {
    ...
    text: (
      <>
        On-campus housing, international student support, and sports complexes.
  ...
  },
  {
    ...
    text: (
      <>
        Cross-border access to Belgium and the Netherlands for internships and study programs.
      </>
    ),
  },
];
