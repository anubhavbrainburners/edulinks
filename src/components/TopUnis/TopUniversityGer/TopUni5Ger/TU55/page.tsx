...
export default function TU55() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
       Partnerships with BMW, Bosch, and Siemens.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         Study in a<br/> dynamic border city close to major European hubs
        </>
      ),
    },
    {
      ...
      body: (
        <>
         250+ clubs,<br/> student tech societies, and international events.
  ...
  return (
   ...
   Life at RWTH Aachen University?
