...
const faqs = [
  {
    question: "What is RWTH Aachen known for?",
    answer:
      " RWTH Aachen is Germany's top-ranked technical university, known for engineering, computer science, and industrial research.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "RWTH is tuition-free; students only pay a semester contribution of approximately EUR 300.",
  },
  {
    question: "Does RWTH Aachen offer scholarships for international students?",
    answer:
      "Yes - RWTH offers DAAD scholarships, research funding, and industrial fellowships.",
  },
  {
