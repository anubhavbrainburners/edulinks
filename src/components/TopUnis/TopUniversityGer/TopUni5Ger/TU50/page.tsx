...
export default function TU50() {
  ...
  return (
    ...
    >
     ...
     Founded in 1870, RWTH Aachen University is one of Europe's leading science and technology
universities. Renowned for engineering, mechanical sciences, and applied research, RWTH is a hub
for innovation and industry collaboration in Germany's "Engineering Capital."
