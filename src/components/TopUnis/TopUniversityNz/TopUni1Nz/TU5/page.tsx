...
const REASONS = [
  {
    ...
    text: (
      <>
         City Campus - Central Auckland hub with state-of-the-art labs, libraries, and innovation centres.
      </>
    ),
  },
  {
    ...
    text: (
      <>
         Grafton Campus - Home to the Faculty of Medicine and Health Sciences.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Modern student accommodation, sports centres, and cultural clubs.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Entrepreneurial hubs and global research collaborations.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Dedicated international office for support and career services.
      </>
    ),
  },
];

export default function TU5 () {
  return (
