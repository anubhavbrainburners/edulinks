  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
           8,000+ international students from 120+<br/> countries.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Study in Auckland, New Zealand's economic and <br/>cultural capital.
        </>
      ),
    },
    {
      ...
      body: (
        <>
        World-leading research in sustainability, technology,<br/> and healthcare.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          200+ student clubs, festivals, and community<br/> events.
        </>
      ),
    },
  ];
