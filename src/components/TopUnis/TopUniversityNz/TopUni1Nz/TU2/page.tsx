      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
            With over 40,000 students, including 8,000 international<br/> students from 120+ countries, the
 University of Auckland offers<br/> a dynamic and inclusive learning environment. It's located in<br/> New
 Zealand's largest and most vibrant city, providing excellent<br/> opportunities for study, work, and
 lifestyle balance.
            </p>
          {/* Button */}
