  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
           3,000+ international students from 100+<br/> countries.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Dunedin is New Zealand's ultimate student town with a<br/> vibrant social scene.
        </>
      ),
    },
    {
      ...
      body: (
        <>
         Leading in medicine, health, and environmental<br/> sciences.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          150+ clubs, events, and international student <br/>associations.
        </>
      ),
    },
  ];
