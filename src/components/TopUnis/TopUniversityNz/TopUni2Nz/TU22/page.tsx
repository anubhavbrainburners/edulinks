      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
            Ranked among the Top 200 universities worldwide, the <br/>University of Otago has over 21,000
 students, including 3,000 <br/>international students from 100+ countries. The university<br/> emphasizes
 hands-on learning and community engagement<br/> in a supportive, inclusive environment.
            </p>
          {/* Button */}
