...
export default function TU36() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
          Study in Wellington, close to decision-makers and<br/> innovators.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Strong focus on sustainability, law, and policy<br/> studies.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          150+ student clubs, cultural events, and entrepreneurship<br/> programs.
        </>
      ),
    },
  ];
