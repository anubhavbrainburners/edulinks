      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
            Ranked among the Top 250 universities globally, Victoria<br/> University of Wellington has more than
 22,000 students,<br/> including 3,000 international students from 100+ countries.<br/> The university
 combines academic excellence with real-<br/>world opportunities through internships, research, and<br/>
 innovation.
            </p>
          {/* Button */}
