...
const ITEMS: Item[] = [
  { id: 1, label: <> Faculty of Business and<br/> Government</> },
  { id: 2, label: <>Faculty of Law</> },
  { id: 3, label: <>Faculty of Science</> },
  { id: 4, label: <>Faculty of Humanities and Social<br/> Sciences</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Laws (LLM)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 year (full-time)
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor's in Science/Policy + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            Bachelor of Arts (International Relations / Media Studies)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          3 years (full-time)
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Strategic Studies</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years (full-time)
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor's in Arts/Politics + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          February
                        </div>
