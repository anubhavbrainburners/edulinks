      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
            Ranked among the Top 250 universities globally, the University <br/>of Canterbury has over 18,000
 students, including 2,000<br/> international students from 100+ countries. Located in Christchurch<br/> - the
 "Garden City" - UC offers a perfect balance of academic<br/> excellence, modern infrastructure, and
 quality of life.
            </p>
          {/* Button */}
