                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold"> Master of Business Management (MBM)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1.5 years (full-time)
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            Bachelor of Arts (Psychology / Communication Studies)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          3 years (full-time)
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Strategic Communication</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years (full-time)
                        </div>
