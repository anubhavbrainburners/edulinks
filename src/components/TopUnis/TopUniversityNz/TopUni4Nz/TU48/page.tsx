...
const faqs = [
  {
    ...
    answer:
      "UC is known for excellence in engineering, business, and environmental sciences.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range from NZD 40,000 to NZD 47,000 per year, depending on the program.",
  },
  {
    question: " Does UC offer scholarships for international students?",
    answer:
      "Yes - UC International First-Year Scholarships and New Zealand Government awards are available",
  },
  {
