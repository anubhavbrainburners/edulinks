  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
           2,000+ international students from 100+ <br/>countries.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Study in Christchurch, New Zealand's centre for innovation and sustainability.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Focus on engineering, sustainability, and<br/> technology.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          130+ student clubs, events, and entrepreneurship<br/> networks.
        </>
      ),
    },
  ];
    ...
    <main className="px-6 py-12 mt-35">
      <div className="max-w-[1100px] mx-auto">
        <h1 className="text-center text-4xl font-bold mb-18 text-[#545454]">
          Life at the University of Canterbury
        </h1>
