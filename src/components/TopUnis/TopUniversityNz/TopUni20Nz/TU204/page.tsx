...
const ITEMS: Item[] = [
  { id: 1, label: <>School of Health and Social <br/>Services</> },
  { id: 2, label: <>School of Business and <br/>IT</> },
  { id: 3, label: <>School of Creative Industries</> },
  { id: 4, label: <>School of Engineering and <br/>Construction</> },
  { id: 5, label: <> School of Performing Arts</> },
];
                  ...
                  {id === 5 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                            High School + Audition + IELTS 6.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February
                        </div>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Graduate Diploma in Performing Arts</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                           Bachelor's in Arts/Drama + IELTS 6.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          February
                        </div>
