...
const ITEMS: Item[] = [
  { id: 1, label: <> Faculty of Agriculture and Life<br/> Sciences</> },
  { id: 2, label: <>Faculty of Environment, Society and<br/> Design</> },
  { id: 3, label: <>Faculty of Commerce</> },
  { id: 4, label: <>Faculty of Science</> },
];

export default function TU74() {
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 1 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          High School (Science subjects) + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                            Bachelor's in Agriculture + IELTS 6.5 
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                           Intake: February
                        </div>
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Environmental Policy and Planning</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years (full-time)
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor's in Environment/Policy + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            Bachelor of Commerce (Agribusiness / Accounting)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          3 Years (Full-Time)
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            Master of Business (Global Management & Marketing)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1.5 years (Full-Time)
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor's in Business + IELTS 6.5
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            Bachelor of Science (Food Science / Biotechnology)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          3 years (full-time)
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Science (Conservation Biology)</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years (full-time)
                        </div>
