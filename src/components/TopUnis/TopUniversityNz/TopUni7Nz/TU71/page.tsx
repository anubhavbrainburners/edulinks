      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
              Established in 1878, Lincoln University is New Zealand's specialist land-based university, renowned
 for agriculture, environment, and sustainability programs. It is one of the world's top small
 universities, offering hands-on learning and strong research partnerships with global industries.
            </span>
        </p>
