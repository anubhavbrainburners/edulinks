      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
             Established in 1964, the University of Waikato is a leading <br/>New Zealand university recognized for
 excellence in research,<br/> teaching, and innovation. With campuses in Hamilton and<br/> Tauranga, it offers
 strong programs in business, computer<br/> science, education, and environmental studies.
            </p>
          {/* Button */}
