...
const faqs = [
  {
    ...
    answer:
      "Waikato is known for its excellence in business, IT, and education, and for its research innovation.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range from NZD 40,000 to NZD 46,000 per year, depending on the program.",
  },
  {
    question: "Does Waikato offer scholarships for international students?",
    answer:
      "Yes - Waikato International Excellence Scholarships are available for both undergraduate and postgraduate students.",
  },
  {
