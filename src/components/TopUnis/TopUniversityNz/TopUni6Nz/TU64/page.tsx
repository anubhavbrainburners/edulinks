...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Computing and Mathematical<br/> Sciences</> },
  { id: 2, label: <>Waikato Management School</> },
  { id: 3, label: <>Faculty of Science and Engineering</> },
  { id: 4, label: <>Faculty of Education</> },
];

export default function TU64() {
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Business and Management</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1.5 years (full-time)
                        </div>
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor's in Education + IELTS 7.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          February
                        </div>
