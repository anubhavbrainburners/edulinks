      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
              Established in 1964, the University of Waikato is a leading New Zealand university recognized for
 excellence in research, teaching, and innovation. With campuses in Hamilton and Tauranga, it offers
 strong programs in business, computer science, education, and environmental studies.
            </span>
        </p>
