...
export default function TU136() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
          Among New Zealand's most affordable <br/>institutions.
        </>
      ),
    },
    {
      ...
      body: (
        <>
            Practical programs designed for immediate<br/> employment.
        </>
      ),
    },
    {
      ...
      body: (
        <>
           Friendly student community with clubs, events, and<br/> outdoor adventures.
        </>
      ),
    },
  ];
