...
const faqs = [
  {
    ...
    answer:
      "SIT is known for affordable, practical education and its strong links with industries across New Zealand.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range from NZD 30,000 to NZD 37,000 per year, depending on the program.",
  },
  {
    question: "Does SIT offer scholarships for international students?",
    answer:
      "Yes - SIT offers International Excellence Scholarships and accommodation grants.",
  },
  {
