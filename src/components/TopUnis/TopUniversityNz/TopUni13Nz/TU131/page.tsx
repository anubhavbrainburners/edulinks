      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
              Established in 1971, Southern Institute of Technology (SIT) is one of New Zealand's most affordable
 and practical tertiary education providers. Known for its Zero Fees Scheme for domestic students
 and affordable tuition for international students, SIT delivers high-quality, industry-focused programs
