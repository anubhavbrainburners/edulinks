...
export default function TU186() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
           Competitive tuition fees and low living<br/> costs.
        </>
      ),
    },
    {
      ...
      body: (
        <>
            Internships and work placements in regional<br/> industries.
        </>
      ),
    },
    {
      ...
      body: (
        <>
            Study in scenic Northland, close to beaches and nature.
        </>
      ),
    },
  ];
