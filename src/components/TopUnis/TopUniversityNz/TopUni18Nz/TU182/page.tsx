      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
                 Located in Whangarei, with learning centres across the <br/>Northland region, NorthTec provides
 students with quality<br/> education and hands-on learning opportunities. It offers<br/> affordable tuition, small
 class sizes, and personalized support, <br/>making it a popular choice for international students seeking<br/>
 real-world skills.
            </p>
          {/* Button */}
