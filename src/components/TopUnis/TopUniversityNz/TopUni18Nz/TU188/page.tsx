...
const faqs = [
  {
    ...
    answer:
      "NorthTec is known for practical education, small class sizes, and its strong connection to New Zealand's industries and communities.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range from NZD 32,000 to NZD 36,000 per year, depending on the program.",
  },
  {
    question: "Does NorthTec offer scholarships for international students?",
    answer:
      "Yes - NorthTec offers International Excellence Scholarships for eligible students.",
  },
  {
