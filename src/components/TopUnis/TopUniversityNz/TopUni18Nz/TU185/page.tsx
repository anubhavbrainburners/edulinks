...
const REASONS = [
  {
    ...
    text: (
      <>
         Whangarei Campus - Main hub with labs, studios, workshops, and student services.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Regional Learning Centres - Smaller campuses across Northland for community learning.
      </>
    ),
  },
  {
    ...
    text: (
      <>
           On-campus accommodation, cafés, and libraries.
      </>
    ),
  },
  {
    ...
    text: (
      <>
            Innovation and sustainability-focused training facilities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
           Career and visa support services for international students.
      </>
    ),
  },
];

export default function TU185 () {
  return (
