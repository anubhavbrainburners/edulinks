      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
               Established in 1978, NorthTec is Northland's premier tertiary education provider. Now part of Te
 Pukenga - New Zealand Institute of Skills and Technology, it offers practical, career-focused
 programs designed to meet the needs of New Zealand's growing industries, particularly in trades,
 health, IT, and business.
            </span>
        </p>
