...
const ITEMS: Item[] = [
  { id: 1, label: <>School of Business and <br/>Computing</> },
  { id: 2, label: <>School of Nursing and Health<br/> Sciences</> },
  { id: 3, label: <>School of Engineering and <br/>Trades</> },
  { id: 4, label: <>School of Creative Industries</> },
  { id: 5, label: <>School of Primary Industries</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Graduate Diploma in Health and Wellbeing</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
