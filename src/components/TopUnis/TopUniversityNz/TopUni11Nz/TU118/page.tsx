...
const faqs = [
  {
    ...
    answer:
      "Otago Polytechnic is known for its strong focus on practical learning, sustainability, and high employability outcomes.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range from NZD 33,000 to NZD 38,000 per year, depending on the program.",
  },
  {
    question: "Does Otago Polytechnic offer scholarships for international students?",
    answer:
      "Yes - Otago Polytechnic International Excellence Scholarships are available for outstanding students.",
  },
  {
