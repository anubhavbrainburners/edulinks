      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
             Founded in 1966, Otago Polytechnic is one of New Zealand's leading institutes of applied learning.
 Known for its focus on hands-on education, sustainability, and innovation, it provides globally
 recognized qualifications that prepare students for real-world success. Otago Polytechnic is now
 part of Te Pukenga - New Zealand Institute of Skills and Technology.
            </span>
        </p>
