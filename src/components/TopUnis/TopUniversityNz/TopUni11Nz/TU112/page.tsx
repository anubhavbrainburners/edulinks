      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
               Located in Dunedin, with campuses in Auckland and Central<br/> Otago, Otago Polytechnic offers over
 100 programs in business,<br/> engineering, design, healthcare, and information technology.<br/> With more
 than 7,000 students, it provides personalized <br/>learning and strong links with local and global
 industries.
            </p>
          {/* Button */}
