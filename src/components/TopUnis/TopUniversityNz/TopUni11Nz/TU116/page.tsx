...
export default function TU116() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
          Strong focus on internships and real-world<br/> projects.
        </>
      ),
    },
    {
      ...
      body: (
        <>
           Friendly, supportive atmosphere in Dunedin, NZ's<br/> student capital.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Globally recognized for sustainable education<br/> practices.
        </>
      ),
    },
  ];
