      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
               Established in 1975, the Eastern Institute of Technology (EIT) is one of New Zealand's top tertiary
 education providers, offering applied and career-focused learning. Now part of Te Pukenga - New
 Zealand Institute of Skills and Technology, EIT has built a strong reputation for practical education
