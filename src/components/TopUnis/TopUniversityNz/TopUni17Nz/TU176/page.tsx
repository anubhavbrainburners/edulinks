...
export default function TU176() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
           Strong internship and industry placement<br/> opportunities.
        </>
      ),
    },
    {
      ...
      body: (
        <>
            Campuses in Napier and Gisborne near beaches and<br/> wineries.
        </>
      ),
    },
    {
      ...
      body: (
        <>
            Dedicated international student services and <br/>mentorship.
        </>
      ),
    },
  ];
