...
const faqs = [
  {
    ...
    answer:
      "EIT is known for practical, industry-based education and its strong community focus.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes - EIT offers International Student Scholarships based on merit and need.",
  },
  {
