      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
                EIT operates campuses in Hawke's Bay (Napier), Tairawhiti<br/> (Gisborne), and Auckland. With more
 than 10,000 students,<br/> including international learners from over 40 countries, EIT<br/> delivers quality
 programs in business, IT, health, engineering,<br/> design, and primary industries, emphasizing
 real-world<br/> skills and employability.
            </p>
          {/* Button */}
