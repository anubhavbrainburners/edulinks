...
const ITEMS: Item[] = [
  { id: 1, label: <>School of Business</> },
  { id: 2, label: <>School of Computing and<br/> IT</> },
  { id: 3, label: <>School of Health and Sport<br/> Science</> },
  { id: 4, label: <>School of Engineering and Primary <br/>Industries</> },
  { id: 5, label: <>School of Arts and<br/> Design</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Graduate Diploma in Engineering</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
                  ...
                  {id === 5 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Graduate Diploma in Creative Practices</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
