  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
         Open Polytechnic of New Zealand | Te Pukenga
        ...
        >
          <span className="block text-lg">
               Established in 1946, the Open Polytechnic of New Zealand is the country's leading provider of
 online and distance learning. Now part of Te Pukenga - New Zealand Institute of Skills and
 Technology, it offers flexible, career-oriented education designed for learners worldwide who prefer
 online or blended study options.
            </span>
        </p>
