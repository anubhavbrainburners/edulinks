      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
                 Open Polytechnic provides more than 100 qualifications, <br/>including certificates, diplomas, and
 degrees across business,<br/> IT, health, education, and social sciences. It focuses on flexible<br/> learning,
 allowing students to balance study with work and<br/> personal commitments while gaining qualifications
 recognized globally.
            </p>
          {/* Button */}
