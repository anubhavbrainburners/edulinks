...
export default function TU196() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
           Students from 60+ countries enrolled <br/>online.
        </>
      ),
    },
    {
      ...
      body: (
        <>
            Qualifications aligned with real industry<br/> needs.
        </>
      ),
    },
    {
      ...
      body: (
        <>
             Academic and technical help available 24/7.
        </>
      ),
    },
  ];
