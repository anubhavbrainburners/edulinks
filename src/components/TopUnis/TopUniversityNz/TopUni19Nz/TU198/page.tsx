...
const faqs = [
  {
    ...
    answer:
      "It is known for being New Zealand's leading provider of flexible, online tertiary education.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range from NZD 29,000 to NZD 33,000 per year, depending on the program.",
  },
  {
    question: "Does Open Polytechnic offer scholarships for international students?",
    answer:
      "Yes - Scholarships are available through Te Pukenga and selected study programs.",
  },
  {
    question: "Can international students study fully online?",
    answer:
      "Yes, most programs are fully online, allowing students to study remotely from any location.",
  },
];
