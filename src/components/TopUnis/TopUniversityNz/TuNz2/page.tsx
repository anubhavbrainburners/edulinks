...
const IMAGES = [
  { src: "/images/tunz2Img1.png", alt: "Feature pill 1" },
  { src: "/images/tunz2Img2.png", alt: "Feature pill 2" },
  { src: "/images/tunz2Img3.png", alt: "Feature pill 3" },
  { src: "/images/tunz2Img4.png", alt: "Feature pill 4" },
];

export default function TuNz2() {
  return (
      ...
      <div className="max-w-[1400px] mx-auto px-6 py-20">
        ...
        <header className="text-center mb-20">
          <h1 className="text-3xl md:text-4xl font-semibold text-gray-800">
            Why Choose New Zealand's Top Universities
          </h1>
        </header>
