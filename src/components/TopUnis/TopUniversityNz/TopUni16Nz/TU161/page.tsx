      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
               Established in 1970, Manukau Institute of Technology (MIT) is one of New Zealand's largest and
 most respected institutes of technology. Located in South Auckland, MIT is part of Te Pukenga 
New Zealand Institute of Skills and Technology and is known for providing career-focused, hands-on
