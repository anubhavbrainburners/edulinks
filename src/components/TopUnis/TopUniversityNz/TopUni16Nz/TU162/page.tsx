      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
                MIT offers a wide range of programs across business, engineering,<br/>   IT, nursing, maritime, and
 trades. With modern facilities and a<br/> practical approach to learning, MIT ensures students gain the<br/>
 skills and experience needed to thrive in global careers. Its <br/>multicultural campus community
 represents over 80 nationalities.
            </p>
          {/* Button */}
