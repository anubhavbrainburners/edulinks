...
const faqs = [
  {
    ...
    answer:
      "MIT is known for practical, industry-led education, particularly in engineering, maritime studies, IT, and healthcare.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range from NZD 33,000 to NZD 37,000 per year, depending on the program.",
  },
  {
    question: "Does MIT offer scholarships for international students?",
    answer:
      "Yes - MIT International Scholarships are available for high-performing students.",
  },
  {
