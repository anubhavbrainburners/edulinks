...
const ITEMS: Item[] = [
  { id: 1, label: <>School of Engineering and <br/>Trades</> },
  { id: 2, label: <>School of Business and Digital<br/> Technologies</> },
  { id: 3, label: <>School of Nursing and Health <br/>Studies</> },
  { id: 4, label: <>School of Maritime Education</> },
  { id: 5, label: <>School of Creative Arts and<br/> Media</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Graduate Diploma in Maritime Management</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
                  ...
                  {id === 5 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Graduate Diploma in Design and Visual Arts</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
