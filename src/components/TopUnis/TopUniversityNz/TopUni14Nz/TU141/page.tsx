      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
              Established in 1904, Nelson Marlborough Institute of Technology (NMIT) is a government-owned
 tertiary education provider offering applied, career-focused programs. It is part of Te Pukenga - New
 Zealand Institute of Skills and Technology and is known for high-quality teaching, innovation, and
