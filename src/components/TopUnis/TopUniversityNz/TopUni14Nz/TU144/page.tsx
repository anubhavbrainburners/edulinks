...
const ITEMS: Item[] = [
  { id: 1, label: <>School of Aquaculture and Marine <br/>Conservation</> },
  { id: 2, label: <>School of Business and<br/> IT</> },
  { id: 3, label: <>School of Engineering and <br/>Construction</> },
  { id: 4, label: <>School of Health and Social<br/> Services</> },
  { id: 5, label: <> School of Arts, Media and<br/> Design</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Graduate Diploma in Health and Wellbeing Practice</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
                  ...
                  {id === 5 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Graduate Diploma in Creative Practice</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor's in Arts/Design + IELTS 6.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          February
                        </div>
