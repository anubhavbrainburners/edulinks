...
const REASONS = [
  {
    ...
    text: (
      <>
         Nelson Campus - Modern facilities with labs, workshops, and student accommodation.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Marlborough Campus - Focused on viticulture, aviation, and aquaculture.
      </>
    ),
  },
  {
    ...
    text: (
      <>
            On-campus library, cafés, and recreational facilities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
           Innovation and research hubs with strong industry partnerships.
      </>
    ),
  },
  {
    ...
    text: (
      <>
            Support services for international students, including visa and career guidance.
      </>
    ),
  },
];
