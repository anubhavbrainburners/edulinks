...
export default function TU146() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
          Real-world projects and internships with <br/>local employers.
        </>
      ),
    },
    {
      ...
      body: (
        <>
            Safe, scenic environment near beaches and<br/> mountains.
        </>
      ),
    },
    {
      ...
      body: (
        <>
            Industry partnerships and work placements integrated<br/> into study.
        </>
      ),
    },
  ];
