...
export default function TU106() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
          Focus on real-world learning and<br/> internships.
        </>
      ),
    },
    {
      ...
      body: (
        <>
           Direct links with employers in Canterbury<br/> region.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Inclusive, vibrant student community with cultural events and clubs.
        </>
      ),
    },
  ];
