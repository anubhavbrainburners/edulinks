      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
              Founded in 2016 through the merger of CPIT and Aoraki Polytechnic, Ara Institute of Canterbury is
 one of New Zealand's largest tertiary institutions. It is known for its hands-on, career-oriented
 education and close partnerships with industries across New Zealand.
            </span>
        </p>
