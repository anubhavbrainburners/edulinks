      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
               Ara offers practical and industry-aligned qualifications across<br/> a wide range of disciplines including
 business, engineering,<br/> hospitality, nursing, IT, and creative arts. With over 17,000 students<br/> and a
 strong focus on innovation and applied learning, Ara <br/>equips graduates with real-world skills to
 succeed globally.
            </p>
          {/* Button */}
