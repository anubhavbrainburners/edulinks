...
const ITEMS: Item[] = [
  { id: 1, label: <>Engineering and Architecture</> },
  { id: 2, label: <>Business and Information <br/>Technology</> },
  { id: 3, label: <>Health and Nursing</> },
  { id: 4, label: <>Creative Industries</> },
  { id: 5, label: <>Hospitality and Tourism</> },
];

export default function TU104() {
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Graduate Diploma in Information and Communication Technologies</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            Graduate Diploma in Health Practice
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (Full-Time)
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Graduate Diploma in Creative Industries</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
                  ...
                  {id === 5 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Graduate Diploma in Event Management</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor's in Business/Arts + IELTS 6.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          February
                        </div>
