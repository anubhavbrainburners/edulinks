...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Engineering and <br/>Technology</> },
  { id: 2, label: <>Faculty of Business and<br/> IT</> },
  { id: 3, label: <>Faculty of Health and <br/>Nursing</> },
  { id: 4, label: <>Faculty of Tourism and<br/> Hospitality</> },
  { id: 5, label: <>Faculty of Forestry and Environmental<br/> Science</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Graduate Diploma in Information Technology</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                              Graduate Diploma in Health and Wellbeing
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (Full-Time)
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Graduate Diploma in Hotel and Resort Management</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor's in Business/Hospitality + IELTS 6.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          February
                        </div>
                  ...
                  {id === 5 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                            High School (Science subjects) + IELTS 6.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          Intake: February
                        </div>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Graduate Diploma in Environmental Management</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
                        ...
                        <div className="text-sm text-[#545454] flex items-center">
                          Bachelor's in Science + IELTS 6.0
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          February
                        </div>
