      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
               Established in 2016 through the merger of five regional institutes, Toi Ohomai Institute of
 Technology is one of New Zealand's largest tertiary providers. Now part of Te Pukenga - New
 Zealand Institute of Skills and Technology, it is known for applied learning, sustainability, and strong
