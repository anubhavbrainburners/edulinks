      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
               Toi Ohomai serves more than 14,000 students across<br/> multiple campuses in the Bay of Plenty and
 central North <br/>Island. It offers programs in business, engineering, tourism, <br/>forestry, and health
 sciences, emphasizing practical <br/>training and community engagement.
            </p>
          {/* Button */}
