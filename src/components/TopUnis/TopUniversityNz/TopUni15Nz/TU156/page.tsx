...
export default function TU156() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
          Real-world internships and project<br/> work.
        </>
      ),
    },
    {
      ...
      body: (
        <>
            Strong commitment to environmental <br/>responsibility.
        </>
      ),
    },
    {
      ...
      body: (
        <>
            Outdoor activities, cultural events, and community <br/>involvement.
        </>
      ),
    },
  ];
