...
const ITEMS: Item[] = [
  { id: 1, label: <>School of Engineering and <br/>Industrial Design</> },
  { id: 2, label: <>School of Business and IT</> },
  { id: 3, label: <>School of Health and Social<br/> Practice</> },
  { id: 4, label: <>School of Media Arts</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 3 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                             Graduate Diploma in Health and Social Practice
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (Full-Time)
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Graduate Diploma in Communication</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
