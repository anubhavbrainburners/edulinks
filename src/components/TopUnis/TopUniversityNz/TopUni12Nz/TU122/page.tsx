      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
               Located in Hamilton, Wintec offers practical and career-<br/>focused programs in engineering, business,
 nursing, media<br/> arts, and information technology. With modern facilities and <br/>strong industry
 relationships, Wintec helps students gain<br/> the skills and experience employers value most.
            </p>
          {/* Button */}
