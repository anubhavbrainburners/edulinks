...
const REASONS = [
  {
    ...
    text: (
      <>
        Hamilton City Campus - Modern learning spaces, labs, and collaborative hubs.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Rotokauri Campus - Focused on engineering, trades, and health sciences.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Student accommodation, cafés, and libraries available on campus.
      </>
    ),
  },
  {
    ...
    text: (
      <>
           Innovation hubs and strong industry partnerships for real-world training.
      </>
    ),
  },
  {
    ...
    text: (
      <>
           International student support and career services.
      </>
    ),
  },
];
