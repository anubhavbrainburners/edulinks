      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
              Established in 1924, Waikato Institute of Technology (Wintec) is one of New Zealand's leading
 institutes of applied education. Now part of Te Pukenga - New Zealand Institute of Skills and
 Technology, Wintec is known for its hands-on, industry-connected programs that prepare students
 for global careers.
            </span>
        </p>
