...
export default function TU126() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
          Industry placements and project-based<br/> education.
        </>
      ),
    },
    {
      ...
      body: (
        <>
           Social events, clubs, and student activities<br/> in Hamilton.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Training that leads directly to<br/> employment.
        </>
      ),
    },
  ];
