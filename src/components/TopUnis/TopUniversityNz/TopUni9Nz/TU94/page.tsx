...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Engineering and<br/> Applied Technology</> },
  { id: 2, label: <>Faculty of Creative Industries and <br/>Business</> },
  { id: 3, label: <>Faculty of Health and <br/>Community</> },
  { id: 4, label: <> Faculty of Computing and<br/> IT</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Business</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1.5 years (full-time)
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            Graduate Diploma in Healthcare and Social Practice
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (Full-Time)
                  ...
                  {id === 4 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Graduate Diploma in Computing</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1 years (full-time)
                        </div>
