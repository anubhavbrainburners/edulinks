...
export default function TU96() {
  const cards: Card[] = [
    ...
    },
    {
      ...
      body: (
        <>
          Strong focus on practical, industry-ready<br/> education.
        </>
      ),
    },
    {
      ...
      body: (
        <>
           Work placements and internships included in<br/> many programs.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Clubs, student events, and multicultural activities<br/> in Auckland
        </>
      ),
    },
  ];
    ...
    <main className="px-6 py-12 mt-35">
      <div className="max-w-[1100px] mx-auto">
        <h1 className="text-center text-4xl font-bold mb-18 text-[#545454]">
          Life at Unitec Institute of Technology
        </h1>
