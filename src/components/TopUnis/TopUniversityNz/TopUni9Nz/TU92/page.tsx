      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
               Located in Auckland, Unitec provides practical and affordable<br/> education with strong links to
 employers. With more than 10,000<br/> students, including international learners from 80+ countries,<br/> the
 institute emphasizes employability, innovation, and<br/> real-world skills.
            </p>
          {/* Button */}
