      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
             Established in 1976, Unitec Institute of Technology is one of New Zealand's leading institutes for
 applied learning and vocational education. Now part of Te Pukenga - New Zealand Institute of Skills
 and Technology, Unitec offers career-focused programs that blend academic theory with hands-on
 industry experience.
            </span>
        </p>
