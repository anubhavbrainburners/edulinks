...
const REASONS = [
  {
    ...
    text: (
      <>
         Auckland Campus - Focused on business, creative arts, and engineering.
      </>
    ),
  },
  {
    ...
    text: (
      <>
           Wellington Campus - Known for design, communication, and health sciences.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Manawatu Campus (Palmerston North) - Home to veterinary, agriculture, and aviation programs.
      </>
    ),
  },
  {
    ...
    text: (
      <>
          Modern labs, innovation hubs, and research centres.
      </>
    ),
  },
  {
    ...
    text: (
      <>
         Accommodation, libraries, sports facilities, and international student support.
      </>
    ),
  },
];
