...
const faqs = [
  {
    ...
    answer:
      "Massey is known for aviation, veterinary science, and creative arts, as well as flexible learning.",
  },
  {
    question: "What are the tuition fees for international students?",
    answer:
      "Tuition fees range from NZD 42,000 to NZD 47,000 per year, depending on the program.",
  },
  {
    question: " Does Massey offer scholarships for international students?",
    answer:
      "Yes - Massey University International Excellence Scholarships are available for undergraduate and postgraduate students.",
  },
  {
