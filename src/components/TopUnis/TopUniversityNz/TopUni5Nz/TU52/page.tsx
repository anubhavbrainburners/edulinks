      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#000000] mb-16 md:text-2xl whitespace-nowrap"style={{ fontFamily: "DM Sans" }}>
            Ranked among the Top 300 universities worldwide, Massey<br/> University has over 30,000 students,
 including 5,000<br/> international students from more than 100 countries. The <br/>university is recognized for
 its practical approach to education <br/>and strong industry partnerships.
            </p>
          {/* Button */}
