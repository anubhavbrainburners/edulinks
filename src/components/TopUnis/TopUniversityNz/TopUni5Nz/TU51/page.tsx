      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
              Established in 1927, Massey University is one of New Zealand's leading universities with a strong
 reputation for applied research, innovation, and flexible learning. It offers a wide range of programs
 across business, aviation, engineering, health sciences, and creative arts, with campuses in three
