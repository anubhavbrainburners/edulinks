  ...
  const cards: Card[] = [
    {
      ...
      body: (
        <>
           5,000+ international students from 100+<br/> countries.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          Strong links with global industries and research<br/> institutions.
        </>
      ),
    },
    {
      ...
      body: (
        <>
           Practical internships and work-integrated <br/>learning.
        </>
      ),
    },
    {
      ...
      body: (
        <>
          150+ clubs, events, and multicultural community<br/> activities.
        </>
      ),
    },
  ];
