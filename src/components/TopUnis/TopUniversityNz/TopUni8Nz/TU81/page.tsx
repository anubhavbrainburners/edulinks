      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-lg">
             Established in 2000, Auckland University of Technology (AUT) is one of New Zealand's most
 modern and innovative universities. Known for its strong focus on technology, creativity, and
 practical learning, AUT ranks among the top 1% of universities worldwide for its industry
 connections and research excellence.
            </span>
        </p>
