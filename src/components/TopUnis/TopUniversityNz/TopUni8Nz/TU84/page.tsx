...
const ITEMS: Item[] = [
  { id: 1, label: <>Faculty of Design and Creative<br/> Technologies</> },
  { id: 2, label: <>Faculty of Business, Economics and<br/> Law</> },
  { id: 3, label: <>Faculty of Health and Environmental<br/> Sciences</> },
  { id: 4, label: <> Faculty of Culture and<br/> Society</> },
];
                ...
                <div key={id} className="space-y-10">
                  ...
                  {id === 2 && (
                    <>
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Business Management</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          1.5 years (full-time)
                        </div>
                  ...
                  {id === 3 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                            Bachelor of Health Science (Nursing / Public Health)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          3 Years (Full-Time)
                  ...
                  {id === 4 && (
                    <>
                      <div className="grid grid-cols-5 gap-4 items-start">
                        <div className="col-span-1">
                          <h3 className="font-semibold">
                             Bachelor of Arts (Communication Studies / Education)
                          </h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          3 years (full-time)
                      ...
                      <div className="grid grid-cols-5 gap-4 items-start mt-4">
                        <div className="col-span-1">
                          <h3 className="font-semibold">Master of Professional Language Studies</h3>
                        </div>
                        <div className="text-sm text-[#545454] flex items-center">
                          2 years (full-time)
                        </div>
