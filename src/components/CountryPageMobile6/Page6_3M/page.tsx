...
export default function Page6_3M() {
  return (
    <section className="max-w-full flex flex-col relative z-20 -mt-20 items-center py-12 px-4 bg-white">
      ...
      <h2 className="text-3xl font-semibold text-[#545454] mb-8 text-center">
        Cost of Studying in<br/> Germany
      </h2>
      ...
      <div className="relative w-full max-w-md rounded-xl mb-5 overflow-hidden">
        ...
        <div className="relative border-2 border-[#37D7D9] rounded-xl">
          ...
          <p className="text-[#000000] translate-x-23 -translate-y-3 text-[10px]">
            €0 – €3,500/year (most public universities are tuition-<br/>free; private universities may charge more)
          </p>
        </div>
      </div>
      ...
      <div className="relative w-full max-w-md rounded-xl mb-5 overflow-hidden">
        ...
        <div className="relative border-2 border-[#37D7D9] rounded-xl">
          ...
          <p className="text-[#000000] translate-x-60 -translate-y-3 text-[10px]">
             €800 – €1,200/month
          </p>
        </div>
      </div>
      ...
      <div className="relative w-full max-w-md rounded-xl mb-10 overflow-hidden">
        ...
        <div className="relative border-2 border-[#37D7D9] rounded-xl">
          ...
          <p className="text-[#000000] translate-x-64 -translate-y-3 text-[10px]">€75 (student visa)</p>
        </div>
      </div>
