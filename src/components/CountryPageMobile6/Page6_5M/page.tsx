...
const steps: Step[] = [
  { id: 1, title: "Academic transcripts (high school diploma or bachelor’s degree depending on program)" },
  { id: 2, title: "Proof of English proficiency: IELTS / TOEFL (or German language proficiency for German-taught programs: TestDaF / DSH)" },
  { id: 3, title: "Statement of Purpose (SOP)" },
  { id: 4, title: "Resume + Recommendation Letters (for postgraduate applicants)" },
  { id: 5, title: "Valid passport" },
];

export default function Page6_5M() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const totalLength = sectionHeight - 255;
