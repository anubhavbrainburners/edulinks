...
export default function Page6_2M () {
  return (
    <section className="relative w-full bg-white py-12 -mt-6 flex flex-col items-center">
      ...
      <div className="relative z-20 w-full max-w-9xl h-[300px] text-sm">
        ...
        <div className="absolute top-46 left-3 bg-[#DFFFFF] rounded-2xl shadow-lg px-4 py-2 font-bold text-center">
          Natural Sciences (Biology,<br/> Chemistry, Physics)
        </div>

        <div className="absolute bottom-20 left-58 bg-[#DFFFFF] rounded-2xl shadow-lg px-2 py-2 font-bold max-w-[85%] text-center">
          Architecture & Design
        </div>
