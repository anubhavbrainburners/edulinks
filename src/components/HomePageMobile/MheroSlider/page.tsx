...
const MheroSlider: React.FC = () => {
  ...
  const testimonials: Testimonial[] = [
    ...
    },
    {
      name: "Zaid Khan",
      text:
        "Before I found EduLinks, I had no idea what career path to choose. but neither felt right. The psychometric test on EduLinks opened my eyes.",
    },
    {
      name: "Shefali Shirodkar",
      text:
        "Thanks to EduLinks, I got complete guidance on the college admission process, entrance exams. I felt confident every step of the way!",
    },
    {
      name: "Preeti Singh",
      text:
