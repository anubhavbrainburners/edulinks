...
const steps: Step[] = [
  { id: 1, title: "Academic transcripts (minimum GPA/grades vary by program)" },
  { id: 2, title: "English proficiency test: IELTS / PTE / TOEFL (UKVI approved for some programs)" },
  { id: 3, title: "Personal Statement / Statement of Purpose (SOP)" },
  { id: 4, title: "Resume + Recommendation Letters (for postgraduate applicants)" },
  { id: 5, title: "Valid passport" },
];

export default function Page4_5M() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const totalLength = sectionHeight - 250;
