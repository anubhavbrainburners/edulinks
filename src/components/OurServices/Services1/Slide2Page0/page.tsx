...
export default function Slide2Page0 () {
  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-base sm:text-lg">
            Evaluate your English communication skills before taking official exams. Our AI-powered English Language 
          </span>
          <span className="block text-base sm:text-lg">
            Assessment helps you understand your proficiency level in reading, writing, listening, and speaking — giving you 
          </span>
          <span className="block text-base sm:text-lg">
            the confidence to excel in international admission tests and academic environments.
          </span>
        </p>
      ...
      >
        <button className="px-6 py-2.5 translate-y-8 rounded-full text-white bg-[#37D7D9] font-medium hover:bg-[#00B7C1] hover:shadow-md hover:shadow-gray-400 transition-shadow duration-300 ease-in-out">
          Start Exploring
        </button>
      </div>
    </section>
