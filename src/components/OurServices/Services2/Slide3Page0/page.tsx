...
export default function Slide3Page0 () {
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-base sm:text-lg">
            Connect, share, and learn with students, alumni, and mentors through the Edulinks Community Hub. Get real 
          </span>
          <span className="block text-base sm:text-lg">
            insights, real stories, and real guidance from people who’ve already experienced the study-abroad journey — all 
          </span>
          <span className="block text-base sm:text-lg">
            in one place designed for genuine connection and support.
          </span>
        </p>
