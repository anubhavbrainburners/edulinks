...
export default function Slide4Page0 () {
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-base sm:text-lg">
            Get instant, data-driven support for your entire study-abroad journey. The Edulinks AI Counselor helps you with  
          </span>
          <span className="block text-base sm:text-lg">
            everything — from university shortlisting and visa queries to scholarship advice — all available 24/7 with 
          </span>
          <span className="block text-base sm:text-lg">
            accurate, personalized guidance that feels human but works faster.
          </span>
        </p>
