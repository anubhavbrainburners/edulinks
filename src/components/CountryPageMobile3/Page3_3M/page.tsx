...
export default function Page3_3M() {
  return (
    <section className="w-full flex flex-col relative z-20 -mt-20 items-center py-12 px-4 bg-white">
      ...
      <div className="relative w-full max-w-md rounded-xl mb-5 overflow-hidden">
        ...
        <div className="relative border-2 border-[#37D7D9] rounded-xl">
          ...
          <p className="text-[#000000] translate-x-25 -translate-y-3 text-[10px]">
            CAD $15,000 – $40,000/year (depending on course)
          </p>
        </div>
      </div>
      ...
      <div className="relative w-full max-w-md rounded-xl mb-5 overflow-hidden">
        ...
        <div className="relative border-2 border-[#37D7D9] rounded-xl">
          ...
          <p className="text-[#000000] translate-x-54 -translate-y-3 text-[10px]">
      ...
      <div className="relative w-full max-w-md rounded-xl mb-10 overflow-hidden">
        ...
        <div className="relative border-2 border-[#37D7D9] rounded-xl">
          ...
          <p className="text-[#000000] translate-x-75 -translate-y-3 text-[10px]">CAD $150</p>
        </div>
      </div>
