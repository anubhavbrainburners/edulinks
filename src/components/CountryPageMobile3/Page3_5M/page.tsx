...
const steps: Step[] = [
  { id: 1, title: "Academic transcripts (minimum GPA varies by program)" },
  { id: 2, title: "English proficiency test: IELTS / TOEFL / PTE (French test for Quebec programs if applicable)" },
...
export default function Page3_5M() {
