...
export default function Page3_2M () {
  return (
    <section className="relative w-full bg-white py-12 -mt-6 flex flex-col items-center">
      ...
      <div className="relative z-20 w-full max-w-9xl h-[300px] text-sm">
        ...
        <div className="absolute top-22 -right-28 transform -translate-x-1/2 bg-[#DFFFFF] rounded-2xl shadow-lg px-3 py-2 font-bold text-center">
          Computer Sci. &amp; Data Analytics 
        </div>
