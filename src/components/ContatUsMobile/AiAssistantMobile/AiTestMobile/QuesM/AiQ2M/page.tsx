...
export default function AiQ2M() {
  ...
  function handleNext() {
    if (selected !== null) {
      router.push("/aiassistant/universitycourse?step=interest-areas"); // <-- replace with your next route (e.g. "/CountrySelMobile2")
    }
  }
  ...
  return (
    <main className="min-h-screen bg-[#DFFFFF] text-[#545454] flex flex-col">
      ...
      <section className="flex-1 w-full bg-white rounded-t-4xl shadow-lg px-5 pt-6 pb-12">
