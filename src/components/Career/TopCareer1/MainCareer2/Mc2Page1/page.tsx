...
const REASONS = [
  {
    ...
    text: (
      <>
        Globally recognised MBAs and business<br/> degrees accredited by AACSB, EQUIS, and<br/> AMBA.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Practical, case-based learning with<br/> internships and consulting projects.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        High graduate employability in management,<br/> marketing, finance, and analytics.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Opportunity to work part-time while <br/>studying and full-time after graduation.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Strong pathways to PR for in-demand<br/> business and analytics roles.
      </>
    ),
  },
];
