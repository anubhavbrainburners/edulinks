...
const REASONS = [
  {
    ...
    text: (
      <>
        Australia is a top 10 global tourism <br/>destination with high job demand<br/> in hospitality and events.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Practical learning through internships, work <br/>placements, and training at leading<br/> hospitality brands.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Strong post-study work opportunities and<br/> PR pathways for skilled graduates.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Modern, industry-focused programs aligned<br/> with global service standards.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Multicultural learning environment with real <br/>customer-facing experience.
      </>
    ),
  },
];
