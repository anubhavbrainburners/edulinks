  ...
  return (
    ...
    >
      ...
      <div className="text-center -mt-5 relative z-20 max-w-6xl">
        ...
        >
          Hospitality & Tourism in Australia
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Experience world-class hospitality and tourism education in one of the world’s top travel destinations — with <br/>hands-on training, global exposure, and career-ready skills.
          </span>
        </p>
