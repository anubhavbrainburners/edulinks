        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-12">
            <h1 className="mb-6 text-3xl lg:text-4xl font-bold text-[#545454]">
              About Health Sciences in <br/> Australia
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-12">
              Health Sciences programs in Australia focus on <br/>practical training, advanced research, and clinical<br/> exposure. With an ageing population and rising global<br/> health needs, careers in nursing, allied health, <br/>medicine, and public health are among the most in-<br/>demand fields across the country.
            </p>
            <button
