      ...
      <div className="text-center -mt-5 relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-base sm:text-lg">
            Explore Australia’s world-class medical and health education — from nursing and public health to biomedical<br/> research — with strong career outcomes and global recognition.
          </span>
        </p>
