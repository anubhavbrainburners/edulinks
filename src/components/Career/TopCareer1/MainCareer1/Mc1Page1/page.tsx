...
const REASONS = [
  {
    ...
    text: (
      <>
        Australia’s health programs are globally<br/> accredited and recognised by international<br/> health bodies.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Hands-on learning through hospital<br/> placements, clinics, and research labs.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Growing demand for healthcare professionals<br/> across urban and regional Australia.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Excellent graduate employability and PR<br/> pathways in nursing, medicine, and allied<br/> health.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Opportunity to work during and after studies <br/>in Australia’s healthcare sector.
      </>
    ),
  },
];
