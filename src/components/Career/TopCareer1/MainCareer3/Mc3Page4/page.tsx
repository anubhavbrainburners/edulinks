      ...
      <div className="text-center -mt-5 relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-base sm:text-lg">
            Discover Australia’s rapidly growing tech industry — from AI and data science to cybersecurity and software <br/>development — and prepare for the future of work with globally recognised IT programs.
          </span>
        </p>
