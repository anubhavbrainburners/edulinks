        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-10">
            <h1 className="mb-6 leading-15 text-3xl lg:text-4xl font-bold text-[#545454]">
              About Information Technology & <br/> AI in Australia
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-8">
              Australia is at the forefront of digital transformation, <br/>offering cutting-edge education in IT, computer <br/> science, and artificial intelligence. With rising demand<br/>for tech professionals across industries, universities <br/>combine theory, coding, and innovation with hands-on <br/>industry projects and internships.
            </p>
            <button
