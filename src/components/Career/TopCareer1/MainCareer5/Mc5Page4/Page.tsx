...
export default function MC5Page4 () {
  ...
  return (
    ...
    >
      ...
      <div className="text-center -mt-5 relative z-20 max-w-6xl">
        ...
        >
          Education & Teaching in Australia
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Inspire the next generation with Australia’s world-class teaching programs — focused on innovation, inclusivity, <br/>and real classroom experience.
          </span>
        </p>
