        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-10">
            <h1 className="mb-6 leading-15 text-3xl lg:text-4xl font-bold text-[#545454]">
             About Education & Teaching in <br/>Australia
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-8">
              Australia’s hospitality and tourism sector is among its <br/>largest industries, contributing billions to the economy <br/> each year. Universities and colleges offer globally <br/>recognised programs that combine theory with  <br/>practical experience in hotels, resorts, event  <br/>management, and travel operations.
            </p>
            <button
