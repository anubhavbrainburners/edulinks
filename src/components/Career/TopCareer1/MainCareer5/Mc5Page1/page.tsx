...
const REASONS = [
  {
    ...
    text: (
      <>
        Australian teaching degrees are<br/> internationally recognised and accredited.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Strong demand for qualified teachers across<br/> Australia and globally.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Extensive classroom placements and real-<br/>world teaching practice.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Opportunity to specialise in inclusive and<br/> digital education.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Pathways to PR through skilled teacher <br/>occupations in Australia.
      </>
    ),
  },
];
