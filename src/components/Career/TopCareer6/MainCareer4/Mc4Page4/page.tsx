  ...
  return (
    ...
    >
      ...
      <div className="text-center -mt-5 relative z-20 max-w-6xl">
        ...
        >
         Hospitality & Tourism in the United States
        </h1>
        ...
        >
          ...
          Experience world-class hospitality education in one of the world’s most visited and service-driven countries —<br/> where opportunity meets experience.
          </span>
        </p>
