...
const REASONS = [
  {
    ...
    text: (
      <>
      Study in one of the world’s largest<br/> hospitality and tourism markets.
      </>
    ),
  },
  {
    ...
    text: (
      <>
      Access to paid internships and co-op <br/>programs with global hotel chains.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Practical experience through real-world <br/>projects and industry placements.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        3-year OPT (STEM-designated extension) for<br/> hospitality analytics and management<br/> programs.
  ...
  },
  {
    ...
    text: (
      <>
      High employability across travel, food, And <br/>hospitality sectors.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-20">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#545454]">
          Why Study Hospitality & Tourism In US
        </h1>
      </div>
