    ...
    <main className="min-h-screen bg-white py-20 ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-12">
            <h1 className="mb-6 text-3xl lg:text-4xl font-bold text-[#545454]">
              About Business & Management <br/>In The USA
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-12">
            The United States is the world’s most dynamic business <br/>and innovation hub — home to Fortune 500 companies,<br/> leading startups, and top-ranked business schools.<br/> Business and management programs in the U.S. emphasize<br/> leadership, entrepreneurship, and strategic thinking, <br/>preparing graduates for global careers in finance,<br/> consulting, technology, and management.
            </p>
            <button
      ...
      <section className="mx-auto max-w-screen-xl text-center mt-20">
        ...
        <div className="flex justify-center mt-16">
          <Image
            src="/images/mc2usapage0Img2.png"
