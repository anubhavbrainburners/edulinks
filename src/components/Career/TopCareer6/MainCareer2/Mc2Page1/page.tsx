...
const REASONS = [
  {
    ...
    text: (
      <>
        Study at globally top-ranked and AACSB-<br/>accredited business schools.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Access to real-world learning through<br/> internships and consulting projects.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Diverse specialisations tailored to The<br/> modern global economy.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       3-year OPT (STEM extension) for analytics <br/>and management-related programs.
  ...
  },
  {
    ...
    text: (
      <>
       Excellent networking and job opportunities<br/> with multinational corporations.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-20">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#545454]">
          Why Study Business & Management <br/>In The USA
        </h1>
      </div>
