...
export default function Mc3Page0 () {
  return (
    <main className="min-h-screen bg-white py-20 ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-10">
            <h1 className="mb-6 leading-15 text-3xl lg:text-4xl font-bold text-[#545454]">
              About Information Technology & <br/>AI in the USA
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-8">
             The United States is home to Silicon Valley, global tech<br/> leaders, and the world’s top-ranked universities for IT and <br/>AI. Students gain a strong foundation in computing,<br/> software engineering, and artificial intelligence through<br/> hands-on research, internships, and access to advanced<br/> technology labs. The U.S. is ideal for ambitious learners<br/> looking to build a career in technology, data, or innovation.
            </p>
            <button
      ...
      <section className="mx-auto max-w-screen-xl text-center mt-20">
        ...
        <div className="flex justify-center mt-16">
          <Image
            src="/images/mc3usapage0Img2.png"
