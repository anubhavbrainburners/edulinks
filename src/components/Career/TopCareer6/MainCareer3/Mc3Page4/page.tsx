  ...
  return (
    ...
    >
      ...
      <div className="text-center -mt-5 relative z-20 max-w-6xl">
        ...
        >
         Information Technology & AI in the United States
        </h1>
        ...
        >
         ...
         Study in the global centre of innovation — where world-class tech education meets limitless career<br/> opportunities.
          </span>
        </p>
