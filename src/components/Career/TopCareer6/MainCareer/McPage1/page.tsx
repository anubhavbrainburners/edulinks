...
const REASONS = [
  {
    ...
    text: (
      <>
        Home to 8 of the world’s top 10 universities<br/> for engineering and technology.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Strong research partnerships with NASA,<br/> Tesla, Boeing, and General Electric.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Access to cutting-edge laboratories, <br/>workshops, and innovation centres.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       STEM-designated programs offering 3-year<br/> OPT for international students.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Competitive salaries and strong Demand<br/> across global engineering sectors.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-20">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#545454]">
         Why Study Engineering &<br/> Manufacturing in the USA
        </h1>
      </div>
