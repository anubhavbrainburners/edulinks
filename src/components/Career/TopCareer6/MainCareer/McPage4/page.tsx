  ...
  return (
    ...
    >
      ...
      <div className="text-center -mt-5 relative z-20 max-w-6xl">
        ...
        >
          Engineering & Manufacturing in the United States
        </h1>
        ...
        >
          ...
          Join the global leaders in innovation and technology — study engineering and manufacturing in the world’s most<br/> advanced industrial economy.
          </span>
        </p>
