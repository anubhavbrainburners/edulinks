        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-12">
            <h1 className="mb-6 text-3xl lg:text-4xl font-bold text-[#545454]">
              About Engineering & <br/>Manufacturing in the USA
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-12">
              The United States is home to groundbreaking engineering<br/> innovation, world-class research, and advanced <br/>manufacturing industries. From aerospace and civil <br/>engineering to robotics and renewable energy, U.S. <br/>universities prepare students to design, build, and lead in an <br/>ever-evolving global economy.
            </p>
            <button
