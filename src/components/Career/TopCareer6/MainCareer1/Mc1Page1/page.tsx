...
const REASONS = [
  {
    ...
    text: (
      <>
      Home to top-ranked universities And<br/> medical schools in the world.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Access to advanced labs, hospitals, And<br/> biomedical research centres.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        High demand for skilled healthcare and Life<br/> science professionals.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Opportunities for internships And<br/> residencies in world-class institutions.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       STEM-designated programs offering 3-year <br/>OPT and H-1B visa pathways..
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-20">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#545454]">
         Why Study Healthcare & Life Sciences<br/> In the USA
        </h1>
      </div>
