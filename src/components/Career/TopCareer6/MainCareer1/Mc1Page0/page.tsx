...
export default function Mc1Page0 () {
  return (
    <main className="min-h-screen bg-white py-20 ">
      ...
      <section className="mx-auto ">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-12">
            <h1 className="mb-6 text-3xl lg:text-4xl font-bold leading-13 text-[#545454]">
              About Healthcare & Life Sciences<br/> In The USA
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-12">
            The United States is a global leader in healthcare, medicine,<br/> and biotechnology innovation. With cutting-edge research <br/>universities, advanced hospitals, and thriving <br/>pharmaceutical industries, students gain the knowledge and <br/>skills to drive breakthroughs in health, wellness, and life<br/> sciences. Programs combine academic excellence with <br/> clinical practice and global research exposure.
            </p>
            <button
      ...
      <section className="mx-auto max-w-screen-xl text-center mt-20">
        ...
        <div className="flex justify-center mt-16">
          <Image
            src="/images/mc1usapage0Img2.png"
