  ...
  return (
    ...
    >
      ...
      <div className="text-center -mt-5 relative z-20 max-w-6xl">
        ...
        >
          Healthcare & Life Sciences in the United <br/>States
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
           Shape the future of global healthcare and research with world-class education and hands-on<br/> experience in the U.S.
          </span>
        </p>
