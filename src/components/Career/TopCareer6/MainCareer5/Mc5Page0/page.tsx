...
export default function Mc5Page0 () {
  return (
    <main className="min-h-screen bg-white py-20 ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-10">
            <h1 className="mb-6 leading-15 text-3xl lg:text-4xl font-bold text-[#545454]">
             About Education & Research In <br/> The USA
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-8">
             The United States is a global leader in education and <br/>academic research, home to many of the world’s top-<br/>ranked universities and research institutions. Programs in<br/> education, psychology, and research studies focus on <br/>teaching innovation, academic leadership, and evidence-<br/>based inquiry — preparing graduates to become educators, administrators, and thought leaders worldwide.
            </p>
            <button
      ...
      <section className="mx-auto max-w-screen-xl text-center mt-20">
        ...
        <div className="flex justify-center mt-16">
          <Image
            src="/images/mc5usapage0Img2.png"
