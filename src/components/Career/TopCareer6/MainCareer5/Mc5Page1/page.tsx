...
const REASONS = [
  {
    ...
    text: (
      <>
        Home to top-ranked universities with World-<br/>renowned education faculties.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Strong emphasis on innovation, inclusivity,<br/> and cross-cultural learning.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Research opportunities funded by Major <br/>government and private grants.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       High global demand for qualified Educators<br/> and education researchers.
  ...
  },
  {
    ...
    text: (
      <>
     Pathways to OPT (Optional Practical Training) <br/>and long-term academic roles.
      </>
    ),
  },
];
  ...
  return (
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-20">
        ...
        Why Study Education & Research In The
        <br/> USA
        </h1>
      </div>
