...
export default function TC6Page0 () {
  ...
  return (
    ...
    >
      ...
      <div className="text-center -mt-5 relative z-20 max-w-6xl">
        ...
        >
          Top Career Opportunities in the USA
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Explore the most in-demand professions and industries across the United States. Discover your career path and 
          </span>
          <span className="block text-base sm:text-lg">
            the best courses to reach your goals
          </span>
        </p>
