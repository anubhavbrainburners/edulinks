...
const REASONS = [
  {
    ...
    text: (
      <>
        Tech professionals are in high demand Across<br/>
         New Zealand’s fast-growing digital economy.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Strong focus on innovation, sustainability, <br/>and real-world problem-solving.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Post-study work visa (up to 3 years) and PR<br/> pathways for skilled IT professionals.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Access to internships and research <br/>opportunities in emerging technologies.
  ...
  },
  {
    ...
    text: (
      <>
      English-speaking, multicultural environment<br/> ideal for international students.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-20">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#545454]">
          Why Study IT & AI in New Zealand
        </h1>
      </div>
