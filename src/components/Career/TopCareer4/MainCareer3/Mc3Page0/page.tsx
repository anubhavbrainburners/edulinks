        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-10">
            <h1 className="mb-6 leading-15 text-3xl lg:text-4xl font-bold text-[#545454]">
              About Information Technology & <br/>AI In New Zealand
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-8">
             New Zealand is becoming a leading destination for<br/> technology education and digital innovation. With <br/>strong government investment and a growing tech <br/>industry, universities provide future-focused programs <br/>in AI, data science, software development, and <br/>cybersecurity — preparing graduates for global tech <br/>careers.
            </p>
            <button
