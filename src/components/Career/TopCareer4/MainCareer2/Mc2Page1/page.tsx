...
const REASONS = [
  {
    ...
    text: (
      <>
       Globally recognised business schools With<br/> industry-aligned curricula.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Focus on real-world skills through<br/> internships and co-op programs.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Excellent employability in finance, consulting, <br/>and management roles.
      </>
    ),
  },
  {
    ...
    text: (
      <>
      Post-study work visa of up to 3 years for<br/> international graduates.
  ...
  },
  {
    ...
    text: (
      <>
       Safe, multicultural learning environment with <br/>strong business networks.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-20">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#545454]">
          Why Study Business & Management in <br/>New Zealand
        </h1>
      </div>
