        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-12">
            <h1 className="mb-6 text-3xl lg:text-4xl font-bold text-[#545454]">
             About Business & Management<br/> in New Zealand
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-12">
             New Zealand’s business programs emphasise practical <br/>learning, innovation, and global awareness. Students gain <br/>hands-on experience through industry projects,<br/> internships, and entrepreneurial labs, preparing for <br/>leadership roles across international markets. With a<br/> growing economy and supportive post-study visa options, <br/>it’s an ideal place to build a career in business.
            </p>
            <button
