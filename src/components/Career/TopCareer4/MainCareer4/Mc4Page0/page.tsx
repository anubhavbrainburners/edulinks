        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-10">
            <h1 className="mb-6 leading-15 text-3xl lg:text-4xl font-bold text-[#545454]">
              About Agriculture & Environmental <br/>Sciences in New Zealand
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-8">
              New Zealand is a global leader in agriculture, agribusiness,<br/> and environmental sustainability. With<br/> vast natural resources and a strong focus on innovation,<br/> universities offer research-driven programs in farming, <br/>food science, conservation, and environmental<br/> management — preparing graduates for impactful, <br/>green careers.
            </p>
            <button
