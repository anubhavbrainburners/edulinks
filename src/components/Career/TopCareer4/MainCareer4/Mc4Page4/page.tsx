...
export default function MC4Page4 () {
  ...
  return (
    ...
    >
      ...
      <div className="text-center -mt-5 relative z-20 max-w-6xl">
        ...
        >
          Agriculture & Environmental Sciences in New<br/> Zealand
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
           Study in one of the world’s most sustainable and nature-driven countries — where agriculture, food technology, <br/>and environmental innovation thrive together.
          </span>
        </p>
