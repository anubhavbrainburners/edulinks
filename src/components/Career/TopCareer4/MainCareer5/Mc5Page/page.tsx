        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-10">
            <h1 className="mb-6 leading-15 text-3xl lg:text-4xl font-bold text-[#545454]">
             About Education & Teaching In <br/>New Zealand
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-8">
             New Zealand is known for its high-quality, inclusive <br/>education system and innovative teaching methods.<br/> Education and teaching programs focus on practical <br/>classroom training, cultural understanding, and <br/>leadership skills — preparing graduates for careers <br/>both in New Zealand and around the world.
            </p>
            <button
