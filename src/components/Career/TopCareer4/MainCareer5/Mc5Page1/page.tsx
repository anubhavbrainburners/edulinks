...
const REASONS = [
  {
    ...
    text: (
      <>
        Degrees recognised globally and accredited <br/>by the Teaching Council of Aotearoa New <br/>Zealand.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Strong practical focus with extensive<br/> teaching placements in schools.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        High demand for qualified teachers Across <br/>public and private institutions.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Clear PR pathways for education<br/> professionals under skilled migration lists.
  ...
  },
  {
    ...
    text: (
      <>
      Post-study work visa up to 3 years For <br/>eligible graduates.
      </>
    ),
  },
];

export default function Mc5Page1 () {
  return (
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-20">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#545454]">
          Why Study Education & Teaching in Australia
        </h1>
      </div>
