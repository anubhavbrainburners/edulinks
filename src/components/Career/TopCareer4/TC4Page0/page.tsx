...
export default function TC4Page0 () {
  ...
  return (
    ...
    >
      ...
      <div className="text-center -mt-5 relative z-20 max-w-6xl">
        ...
        >
          Top Career Opportunities in New Zealand
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Discover New Zealand’s most in-demand careers and growing industries. Find your ideal path and the right 
          </span>
          <span className="block text-base sm:text-lg">
