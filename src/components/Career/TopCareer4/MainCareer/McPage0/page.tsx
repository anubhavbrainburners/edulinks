        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-12">
            <h1 className="mb-6 text-3xl lg:text-4xl font-bold text-[#545454]">
             About Engineering & <br/>Construction in New Zealand
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-12">
             New Zealand’s engineering and construction industry <br/>is expanding rapidly, driven by smart infrastructure,<br/> renewable energy, and sustainable development. <br/>Universities focus on practical, research-led<br/> education, producing highly skilled professionals who<br/> are globally employable.
            </p>
            <button
