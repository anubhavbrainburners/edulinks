      ...
      <div className="text-center -mt-5 relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-base sm:text-lg">
           Build your global engineering career in one of the world’s most innovative and sustainable nations — where<br/> hands-on learning meets real industry growth.
          </span>
        </p>
