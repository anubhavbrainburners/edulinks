...
const REASONS = [
  {
    ...
    text: (
      <>
        Accredited degrees recognised globally by<br/> the Washington Accord.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Practical learning with internships and <br/>industry projects.
      </>
    ),
  },
  {
    ...
    text: (
      <>
      High demand for engineers and construction <br/>managers across the country.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Pathways to Post-Study Work Visa (up to 3<br/> years) and Permanent Residency (PR).
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Strong focus on sustainability and <br/>renewable technologies.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-20">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#545454]">
         Why Study Engineering & Construction<br/> in New Zealand
        </h1>
      </div>
