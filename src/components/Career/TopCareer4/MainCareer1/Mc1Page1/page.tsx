...
const REASONS = [
  {
    ...
    text: (
      <>
        Nursing degrees accredited by the New <br/>Zealand Nursing Council and globally <br/>recognised.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Extensive hands-on clinical placements in<br/> hospitals and health centres.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Strong employability and PR pathways In <br/>healthcare professions.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Supportive, multicultural learning <br/>environment with modern facilities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
      Post-study work visa up to 3 years For<br/>eligible health graduates.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-20">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#545454]">
          Why Study Healthcare & Nursing in New <br/>Zealand
        </h1>
      </div>
