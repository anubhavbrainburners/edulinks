    ...
    <main className="min-h-screen bg-white py-20 ">
      ...
      <section className="mx-auto ">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          About Healthcare & Nursing in<br/> New Zealand
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-12">
              New Zealand offers world-class healthcare education<br/> with a focus on practical training, clinical placements,<br/> and evidence-based learning. With an ageing <br/>population and a growing healthcare sector, qualified <br/>nurses and health professionals are in high demand<br/> across hospitals, clinics, and community health <br/>programs.
            </p>
            <button
