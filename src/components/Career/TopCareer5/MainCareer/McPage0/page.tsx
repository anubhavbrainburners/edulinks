        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-12">
            <h1 className="mb-6 text-3xl lg:text-4xl font-bold text-[#545454]">
             About Engineering & Technology<br/> In the UK
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-12">
             The United Kingdom has a long-standing reputation for <br/>excellence in engineering and technology education. From<br/> civil and mechanical engineering to emerging fields like <br/>robotics and AI, UK universities combine research, <br/>innovation, and hands-on training to prepare students for<br/> leadership roles in global industries.
            </p>
            <button
