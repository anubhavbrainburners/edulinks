...
const REASONS = [
  {
    ...
    text: (
      <>
      UK universities rank among the top 50<br/> globally for engineering and technology.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Emphasis on innovation, design, And<br/> industry-focused learning.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Access to research facilities and internships<br/> with leading companies.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        2-year post-study work visa for international <br/>graduates.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Pathways to skilled worker visas and Global<br/> career opportunities.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-20">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#545454]">
          Why Study Engineering & Technology <br/>In the UK
        </h1>
      </div>
