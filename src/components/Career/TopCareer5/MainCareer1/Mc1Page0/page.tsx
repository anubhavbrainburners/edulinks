        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-12">
            <h1 className="mb-6 text-3xl lg:text-4xl font-bold text-[#545454]">
             About Healthcare & Nursing In <br/>The UK
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-12">
              The UK is a global leader in medical and nursing<br/> education, offering world-class training through advanced facilities and hands-on clinical placements.<br/> With a strong public healthcare system (the NHS) and <br/>internationally accredited programs, the UK provides<br/> an ideal environment for aspiring nurses, doctors, and <br/>health professionals.
            </p>
            <button
