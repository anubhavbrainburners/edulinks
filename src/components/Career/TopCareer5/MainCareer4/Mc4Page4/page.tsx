  ...
  return (
    ...
    >
      ...
      <div className="text-center -mt-5 relative z-20 max-w-6xl">
        ...
        >
          Creative Industries & Media in the United<br/> Kingdom
        </h1>
        ...
        >
          ...
          Unleash your creativity in one of the world’s most vibrant cultural and media hubs — where art, storytelling, and <br/>innovation shape the future.
          </span>
        </p>
