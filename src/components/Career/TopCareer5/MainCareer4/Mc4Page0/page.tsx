        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-10">
            <h1 className="mb-6 leading-15 text-3xl lg:text-4xl font-bold text-[#545454]">
              About Creative Industries & Media In <br/>The UK
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-8">
             The United Kingdom is a global powerhouse in arts,<br/> design, film, and media — home to world-renowned<br/> creative institutions and a thriving entertainment <br/>industry. With strong ties to global production houses, <br/>fashion brands, and digital studios, UK universities offer<br/> students the perfect blend of creativity, technology,<br/> and real-world experience.
            </p>
            <button
