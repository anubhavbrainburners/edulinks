...
const REASONS = [
  {
    ...
    text: (
      <>
        Study in the world’s leading creative hub —<br/> London, Manchester, and Glasgow.
      </>
    ),
  },
  {
    ...
    text: (
      <>
      Access to industry-standard Studios, Labs, <br/>and Production Spaces.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Real-world exposure through internships And <br/>live creative projects.
      </>
    ),
  },
  {
    ...
    text: (
      <>
      Global career opportunities in media, Design,<br/> And digital communication.
      </>
    ),
  },
  {
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-20">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#545454]">
          Why Study Creative Industries & Media <br/>In The UK
        </h1>
      </div>
