...
export default function TC5Page0 () {
  ...
  return (
    ...
    >
      ...
      <div className="text-center -mt-5 relative z-20 max-w-6xl">
        ...
        >
          Top Career Opportunities in the UK
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Explore the UK’s most in-demand careers and industries. Discover your ideal career path and find the right  
          </span>
          <span className="block text-base sm:text-lg">
