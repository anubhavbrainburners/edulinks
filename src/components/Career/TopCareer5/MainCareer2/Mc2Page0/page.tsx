        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-12">
            <h1 className="mb-6 text-3xl lg:text-4xl font-bold text-[#545454]">
              About Business & Finance <br/>In the UK
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-12">
             The United Kingdom is one of the world’s most influential <br/>financial and business hubs, home to London — the global<br/> centre for banking, entrepreneurship, and corporate<br/> leadership. UK universities are globally recognised for <br/>excellence in business education, producing graduates who <br/>lead industries across finance, consulting, marketing, and <br/>management.
            </p>
            <button
