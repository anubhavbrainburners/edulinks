...
const REASONS = [
  {
    ...
    text: (
      <>
      Globally recognised degrees from top-<br/>ranked business schools
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Study in the world’s leading financial hub —<br/> London.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Practical internships and placement<br/> opportunities with global companies.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       2-year post-study work visa and clear PR<br/> pathways for skilled professionals.
  ...
  },
  {
    ...
    text: (
      <>
       Networking opportunities with top <br/>employers, investors, and innovators.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-20">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#545454]">
         Why Study Business & Finance in the<br/> UK
        </h1>
      </div>
