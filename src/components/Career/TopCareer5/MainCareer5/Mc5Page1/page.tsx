...
const REASONS = [
  {
    ...
    text: (
      <>
       Degrees accredited by the Department for<br/> Education (DfE) and recognised worldwide.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Extensive classroom placements Across<br/> schools and educational institutions.
      </>
    ),
  },
  {
    ...
    text: (
      <>
      High demand for qualified teachers in UK<br/> public and private schools.
      </>
    ),
  },
  {
    ...
    text: (
      <>
      Pathways to Qualified Teacher Status (QTS)<br/> and teaching licenses abroad.
  ...
  },
  {
    ...
    text: (
      <>
      2-year post-study work visa and PR <br/>opportunities under skilled migration.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-20">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#545454]">
          Why Study Education & Teaching In The<br/> UK
        </h1>
      </div>
