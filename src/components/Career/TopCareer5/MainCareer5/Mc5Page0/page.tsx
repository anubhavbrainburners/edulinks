        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-10">
            <h1 className="mb-6 leading-15 text-3xl lg:text-4xl font-bold text-[#545454]">
             About Education & Teaching In <br/>The UK
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-8">
             The UK is globally recognised for its exceptional <br/>education system and high teaching standards.<br/> Universities combine theory, classroom practice, and <br/>leadership development to prepare graduates for <br/>teaching, educational administration, and academic <br/>research careers — both in the UK and internationally.
            </p>
            <button
