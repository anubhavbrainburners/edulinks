      ...
      <section className="mx-auto ">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-10">
            ...
            About Information Technology & <br/>Data Science in the UK
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-8">
             The UK is one of the world’s leading technology and <br/>innovation hubs, home to global tech giants and <br/>thriving startups. Universities offer future-focused IT <br/>and data programs combining technical expertise with<br/> problem-solving, analytics, and research. With high <br/>employability and post-study work options, the UK is <br/>an ideal destination for aspiring tech professionals.
            </p>
            <button
