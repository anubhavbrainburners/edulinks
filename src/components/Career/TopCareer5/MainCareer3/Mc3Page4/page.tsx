...
export default function MC3Page4 () {
  ...
  return (
    ...
    >
      ...
      <div className="text-center -mt-5 relative z-20 max-w-6xl">
        ...
        >
          Information Technology & Data Science in the United <br/>Kingdom
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Master the digital world with UK’s cutting-edge programs in IT, Artificial Intelligence, and Data Science — where <br/>innovation drives opportunity.
          </span>
        </p>
