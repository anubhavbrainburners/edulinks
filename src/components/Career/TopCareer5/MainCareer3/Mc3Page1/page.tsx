...
const REASONS = [
  {
    ...
    text: (
      <>
       UK universities rank among the top Globally <br/>for computer science and AI research.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Strong demand for data scientists, software<br/> engineers, and cybersecurity experts.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Practical learning with real-world Projects<br/> and internships.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       2-year post-study work visa for international <br/>students.
  ...
  },
  {
    ...
    text: (
      <>
      Pathways to skilled jobs in tech, fintech, And<br/> data analytics sectors.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-20">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#545454]">
          Why Study IT & Data Science in the UK
        </h1>
      </div>
