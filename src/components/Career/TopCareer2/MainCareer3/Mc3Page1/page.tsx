...
const REASONS = [
  {
    ...
    text: (
      <>
        Strong global demand for IT and AI <br/>professionals in every industry.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Industry-integrated co-op programs for<br/> real-world tech experience.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Canada’s AI hubs — Toronto, Montreal, and<br/> Vancouver — rank among the world’s top AI <br/>research centres.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Post-study work permits and PR <br/>opportunities for tech graduates.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Government-backed innovation initiatives <br/>supporting international talent.
      </>
    ),
  },
];
