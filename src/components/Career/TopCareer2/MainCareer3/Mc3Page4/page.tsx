  ...
  return (
    ...
    >
      ...
      <div className="text-center -mt-5 relative z-20 max-w-6xl">
        ...
        >
          Information Technology & AI in Canada
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Shape the digital future with Canada’s cutting-edge IT and AI programs — designed to prepare you for high-<br/>demand tech careers worldwide.
          </span>
        </p>
