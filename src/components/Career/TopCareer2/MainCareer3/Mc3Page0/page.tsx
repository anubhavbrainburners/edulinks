    ...
    <main className="min-h-screen bg-white py-20 ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-10">
            <h1 className="mb-6 leading-15 text-3xl lg:text-4xl font-bold text-[#545454]">
              About Information Technology & <br/> AI in Canada
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-8">
             Canada is home to one of the world’s fastest-growing <br/>tech sectors, with global companies investing in<br/> innovation hubs across Toronto, Vancouver, and <br/>Montreal. Universities in Canada offer programs<br/> focused on data science, artificial intelligence,<br/> cybersecurity, and software development — blending <br/>theoretical knowledge with hands-on experience.
            </p>
            <button
      ...
      <section className="mx-auto max-w-screen-xl text-center mt-20">
        ...
        <div className="flex justify-center mt-16">
          <Image
            src="/images/mc3canpage0Img2.png"
