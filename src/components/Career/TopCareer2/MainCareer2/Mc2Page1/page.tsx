...
const REASONS = [
  {
    ...
    text: (
      <>
        Canadian business degrees are globally <br/>accredited and recognised.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Access to internship and co-op programs<br/> with leading multinational companies.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       High employability rates and post-study <br/>work opportunities in corporate sectors.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Competitive salaries and career progression <br/>in finance, consulting, and analytics.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Opportunity for PR through in-demand <br/>occupations in business and finance.
      </>
    ),
  },
];

export default function Mc2Page1 () {
  return (
