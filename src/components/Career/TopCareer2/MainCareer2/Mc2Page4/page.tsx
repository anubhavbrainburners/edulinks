      ...
      <div className="text-center -mt-5 relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-base sm:text-lg">
           Build a successful global career in business, management, and finance — with internationally recognised <br/>programs and world-class opportunities in Canada.
          </span>
        </p>
