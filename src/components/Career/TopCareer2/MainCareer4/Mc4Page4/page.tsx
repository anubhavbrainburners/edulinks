      ...
      <div className="text-center -mt-5 relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-base sm:text-lg">
            Discover endless opportunities in one of the world’s most welcoming destinations — study hospitality, tourism,<br/> and event management in Canada’s thriving service industry.
          </span>
        </p>
