    ...
    <main className="min-h-screen bg-white py-20 ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-10">
            <h1 className="mb-6 leading-15 text-3xl lg:text-4xl font-bold text-[#545454]">
              About Hospitality & Tourism in <br/> Canada
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-8">
              Canada’s hospitality and tourism sector is one of its <br/>fastest-growing industries, attracting millions of visitors<br/> annually. With world-class programs focused on <br/>practical learning, leadership, and global service<br/>standards, students gain the skills to work in hotels,<br/> resorts, travel companies, and event management<br/> worldwide.
            </p>
            <button
      ...
      <section className="mx-auto max-w-screen-xl text-center mt-20">
        ...
        <div className="flex justify-center mt-16">
          <Image
            src="/images/mc4canpage0Img2.png"
