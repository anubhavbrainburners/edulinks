...
const REASONS = [
  {
    ...
    text: (
      <>
        Canada ranks among the top global <br/>destinations for tourism and hospitality <br/>education.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Programs offer hands-on training,<br/> internships, and co-op placements in <br/>leading hotels and travel brands.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Excellent post-study work opportunities <br/>across Canada’s tourism sector.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Pathways to PR for skilled graduates in <br/>hospitality and event management.
      </>
    ),
  },
  {
