...
export default function MCPage4 () {
  ...
  return (
    ...
    >
      ...
      <div className="text-center -mt-5 relative z-20 max-w-6xl">
        ...
        >
          Engineering & Construction in Canada
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
           Build your future with Canada’s high-quality engineering and construction education — focused on innovation, <br/> sustainability, and real-world industry experience.
          </span>
        </p>
