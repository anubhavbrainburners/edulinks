        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-12">
            <h1 className="mb-6 text-3xl lg:text-4xl font-bold text-[#545454]">
             About Engineering & <br/>Construction in Canada
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-12">
              Canada’s engineering and construction sectors are <br/>among the country’s fastest-growing industries. With<br/> rapid urban development, renewable energy projects,<br/> and infrastructure expansion, there’s an increasing <br/>demand for skilled engineers, project managers, and<br/>
            </p>
            <button
