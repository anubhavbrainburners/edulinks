...
const REASONS = [
  {
    ...
    text: (
      <>
        Canadian education degrees are<br/> internationally recognised and accredited.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Growing demand for teachers in public and<br/> private institutions nationwide.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Hands-on practicum experience and real<br/> classroom teaching placements.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Pathways to PR for educators under skilled <br/>occupation programs.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Opportunity to teach English globally with <br/>TESOL certification.
      </>
    ),
  },
];
