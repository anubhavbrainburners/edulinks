...
const REASONS = [
  {
    ...
    text: (
      <>
        Canadian nursing and healthcare degrees<br/> are globally recognised and highly<br/> employable.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Extensive clinical placements and research<br/> opportunities in top hospitals and clinics.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Excellent job security and high earning <br/>potential across healthcare roles.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Clear PR pathways for healthcare <br/>professionals through federal and provincial<br/> programs.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Strong support for international students,<br/> including co-op and postgraduate work<br/> permits.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-20">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#545454]">
          Why Study Engineering & Construction <br/>in Canada
        </h1>
      </div>
