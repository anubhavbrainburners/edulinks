    ...
    <main className="min-h-screen bg-white py-20 ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-12">
            <h1 className="mb-6 text-3xl lg:text-4xl font-bold text-[#545454]">
             About Health Sciences & Nursing<br/> in Canada
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-12">
              Health Sciences and Nursing programs in Canada are <br/>globally recognised for their quality, innovation, and<br/> hands-on clinical training. With Canada’s growing <br/>healthcare needs and ageing population, the demand <br/>for qualified nurses and health professionals continues<br/>to rise across all provinces.
            </p>
            <button
      ...
      <section className="mx-auto max-w-screen-xl text-center mt-20">
        ...
        <div className="flex justify-center mt-16">
          <Image
            src="/images/mc1canpage0Img2.png"
