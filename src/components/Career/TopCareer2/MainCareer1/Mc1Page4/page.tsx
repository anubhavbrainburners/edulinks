...
export default function MC1Page4 () {
  ...
  return (
    ...
    >
      ...
      <div className="text-center -mt-5 relative z-20 max-w-6xl">
        ...
        >
          Health Sciences & Nursing in Canada
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Join one of the most respected healthcare education systems in the world — with career pathways in nursing, <br/>medicine, and allied health that make a global impact.
          </span>
        </p>
