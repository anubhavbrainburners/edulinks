    ...
    <main className="min-h-screen bg-white py-20 ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-12">
            <h1 className="mb-6 text-3xl lg:text-4xl font-bold text-[#545454]">
             About Healthcare & Life Sciences <br/>in Germany
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-12">
             Germany’s healthcare and life sciences education <br/>system is globally recognised for its excellence in<br/> research, medical innovation, and biotechnology.<br/> Students benefit from a strong public healthcare <br/>network, advanced laboratories, and tuition-free or<br/> low-cost education at top universities — all while<br/> gaining valuable clinical and research experience.
            </p>
            <button
      ...
      <section className="mx-auto max-w-screen-xl text-center mt-20">
        ...
        <div className="flex justify-center mt-16">
          <Image
            src="/images/mc1gerpage0Img2.png"
