...
const REASONS = [
  {
    ...
    text: (
      <>
       Tuition-free or low-cost study at globally<br/> recognised universities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Access to advanced research facilities and <br/>funded PhD opportunities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Opportunities to collaborate with leading<br/> professors and research centres.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        18-month post-study work visa with options<br/> to stay for research or academia.
  ...
  },
  {
    ...
    text: (
      <>
       English-taught Master’s and Doctorate<br/> programs available in most universities.
      </>
    ),
  },
];
  ...
  return (
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-20">
        ...
        Why Study Education & Research in<br/> Germany
        </h1>
      </div>
