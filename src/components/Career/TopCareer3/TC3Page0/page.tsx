...
export default function TC3Page0 () {
      ...
      <div className="text-center -mt-5 relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-base sm:text-lg">
            Explore Germany’s most in-demand professions and future-focused industries. Discover the right career path
          </span>
          <span className="block text-base sm:text-lg">
            and the courses that can take you there.
          </span>
        </p>
