...
const REASONS = [
  {
    ...
    text: (
      <>
        Globally accredited programs focused on <br/>innovation and sustainability.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Opportunity to study in Europe’s financial <br/>powerhouse — home to Frankfurt, Berlin, and<br/> Munich.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Tuition-free or low-cost business degrees<br/> at public universities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Internships and work placements with top<br/> German and global companies.
  ...
  },
  {
    ...
    text: (
      <>
       18-month post-study work visa and strong<br/> PR pathways for skilled professionals.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-20">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#545454]">
          Why Study Business & Finance in Germany
        </h1>
      </div>
