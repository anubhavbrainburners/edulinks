    ...
    <main className="min-h-screen bg-white py-20 ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-12">
            <h1 className="mb-6 text-3xl lg:text-4xl font-bold text-[#545454]">
             About Business & Finance <br/>in Germany
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-12">
              Germany is Europe’s largest economy and a global leader in <br/>business and finance education. Universities emphasise<br/> practical learning, research, and analytical skills that <br/>prepare graduates for leadership roles in multinational<br/> companies, startups, and financial institutions. Affordable <br/>tuition and strong employment prospects make Germany a <br/>top destination for aspiring business professionals.
            </p>
            <button
      ...
      <section className="mx-auto max-w-screen-xl text-center mt-20">
        ...
        <div className="flex justify-center mt-16">
          <Image
            src="/images/mc2gerpage0Img2.png"
