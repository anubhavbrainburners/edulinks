...
const REASONS = [
  {
    ...
    text: (
      <>
        Globally recognised for engineering And<br/> technical excellence.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Tuition-free or low-cost education At<br/> leading public universities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Strong collaboration with companies like <br/>BMW, Siemens, Bosch & Mercedes-Benz.
      </>
    ),
  },
  {
    ...
    text: (
      <>
      Opportunity for paid internships and On-<br/>the-Job training (HiWi & Workstudent<br/> programs).
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Post-study work visa of 18 months With<br/> clear PR and employment pathways.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-20">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#545454]">
          Why Study Engineering & <br/>Manufacturing in Germany
        </h1>
      </div>
