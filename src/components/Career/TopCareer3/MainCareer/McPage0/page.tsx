        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 lg:ml-50 mt-12">
            <h1 className="mb-6 text-3xl lg:text-4xl font-bold text-[#545454]">
             About Engineering & <br/>Construction in Germany
            </h1>

            <p className="text-lg lg:text-xl leading-normal text-[#000000] max-w-3xl mt-12">
           Germany is renowned for its world-leading engineering and <br/>manufacturing excellence. From automotive design to <br/>renewable energy and automation, students gain cutting-<br/>edge knowledge through practice-oriented programs at<br/> top public and technical universities. With tuition-free or<br/> low-cost education and strong industry connections,<br/> Germany offers unmatched value for aspiring engineers.
            </p>
            <button
