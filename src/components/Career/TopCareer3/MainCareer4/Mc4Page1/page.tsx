...
const REASONS = [
  {
    ...
    text: (
      <>
        Germany leads Europe in renewable energy<br/> production and innovation.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Study at top universities focused on <br/>sustainability and green technology.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    text: (
      <>
        Strong industry collaboration with <br/>companies like Siemens, Enercon, and<br/> Bosch.
  ...
  },
  {
    ...
    text: (
      <>
      Growing career opportunities in research, <br/>consulting, and sustainable engineering.
      </>
    ),
  },
   {
    ...
    text: (
      <>
       18-month post-study work visa And<br/> pathways to permanent residence.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-20">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#545454]">
          Why Study Renewable Energy & <br/>Sustainability in Germany
        </h1>
      </div>
