      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-base sm:text-lg">
            Unlock your future with globally recognized degrees, multicultural experiences, and career pathways in one of the 
          </span>
          <span className="block text-base sm:text-lg">
            world’s top destinations for international students.
          </span>
        </p>
