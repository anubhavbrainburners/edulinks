      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-base sm:text-lg">
            Unlock your future with world-renowned universities, cutting-edge research opportunities, and limitless career
          </span>
          <span className="block text-base sm:text-lg">
            pathways in the world’s most popular study-abroad destination.
          </span>
        </p>
