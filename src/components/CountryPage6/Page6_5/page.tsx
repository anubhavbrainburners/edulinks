...
export default function Page6_5() {
  return (
    <section className="relative w-full py-20 md:py-30 -mt-20 md:-mt-28 bg-white">
      ...
      <div className="relative z-20 max-w-4xl mx-auto h-[400px] md:h-[500px] px-6">
        ...
        <div className="absolute -top-4 right-5 flex items-center gap-2 md:gap-3">
        ...
        {/* === IELTS / TOEFL === */}
        <div className="absolute top-[120px] md:top-[160px] -left-4 flex items-center gap-2 md:gap-3">
