...
export default function Page6_6() {
  return (
    <section className="relative w-full flex flex-col items-center mt-20 md:mt-40 py-12 md:py-16 px-4 sm:px-6 md:px-20">
      ...
      {/* Layout */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-10 items-center w-full max-w-6xl">
        {/* Left Side - Bullet Points */}
        <div className="space-y-2 sm:space-y-4 md:space-y-6 px-2 sm:px-6 md:px-0">
