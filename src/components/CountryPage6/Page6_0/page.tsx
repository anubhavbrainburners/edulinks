      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-base sm:text-lg">
            Unlock your future with world-class universities, tuition-free or low-cost education, and career opportunities in 
          </span>
          <span className="block text-base sm:text-lg">
            one of Europe’s most innovative economies.
          </span>
        </p>
