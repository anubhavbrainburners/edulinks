...
const steps: Step[] = [
  { id: 1, title: "Academic transcripts (GPA requirements vary by university)" },
  { id: 2, title: "English proficiency test: IELTS / TOEFL / PTE" },
  { id: 3, title: "Standardized tests (if required by program): SAT / ACT / GRE / GMAT" },
  { id: 4, title: "Resume + Recommendation Letters" },
  { id: 5, title: "Valid passport" },
  { id: 6, title: "Statement of Purpose (SOP) & Essays" },
];

export default function Page5_5M() {
