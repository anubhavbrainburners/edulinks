...
export default function BelowHeaderSD() {
  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-base sm:text-lg">
            From world-class universities and affordable education options to post-study career opportunities and vibrant student 
          </span>
          <span className="block text-base sm:text-lg">
            communities, EduLinks helps you choose the country that truly fits your academic goals and future ambitions. With personalized 
          </span>
          <span className="block text-base sm:text-lg">
      ...
      >
        <button className="px-6 py-2.5 -translate-y-6 rounded-full text-white bg-[#37D7D9] font-medium hover:bg-[#00B7C1] hover:shadow-md hover:shadow-gray-400 transition-shadow duration-300 ease-in-out">
          Start Exploring
        </button>
      </div>
    </section>
