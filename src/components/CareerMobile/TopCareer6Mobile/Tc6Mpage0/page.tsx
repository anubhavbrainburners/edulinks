...
import Tc6Mpage1 from "../Tc6Mpage1/page";
import Tc6Mpage2 from "../Tc6Mpage2/page";

export default function Tc6Mpage0 () {
  return (
    <>
    <section
      id="below-header"
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-base sm:text-lg">
              Explore the most in-demand professions and industries across the United States. Discover your career path and the best courses to reach your goals
          </span>
        </p>
