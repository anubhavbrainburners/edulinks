...
const REASONS = [
  {
    ...
    text: (
      <>
      Study in one of the world’s largest hospitality and tourism markets.
      </>
    ),
  },
  {
    ...
    text: (
      <>
      Access to paid internships and co-op programs with global hotel chains.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Practical experience through real-world projects and industry placements.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        3-year OPT (STEM-designated extension) for hospitality analytics and management programs.
  ...
  },
  {
    ...
    text: (
      <>
      High employability across travel, food, And hospitality sectors.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-16">
        <h1 className="text-3xl font-bold text-[#545454] leading-snug">
          Why Study Creative Industries & Media in the USA?
        </h1>
      </div>
