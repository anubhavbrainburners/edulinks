...
const REASONS = [
  {
    ...
    text: (
      <>
        Home to 8 of the world’s top 10 universities for engineering and technology.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Strong research partnerships with NASA, Tesla, Boeing, and General Electric.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Access to cutting-edge laboratories, workshops, and innovation centres.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       STEM-designated programs offering 3-year OPT for international students.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Competitive salaries and strong Demand across global engineering sectors.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-16">
        <h1 className="text-3xl font-bold text-[#545454] leading-snug">
          Why Study Engineering & Manufacturing in the USA?
        </h1>
      </div>
