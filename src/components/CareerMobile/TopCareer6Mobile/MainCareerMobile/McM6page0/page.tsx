        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Engineering & Manufacturing in the USA
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-5 -mt-3">
              The United States is home to groundbreaking engineering innovation, world-class research, and advanced manufacturing industries. From aerospace and civil engineering to robotics and renewable energy, U.S. universities prepare students to design, build, and lead in an ever-evolving global economy.
            </p>
            <button
