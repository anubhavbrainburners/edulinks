  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          Healthcare & Life Sciences in the United States
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Shape the future of global healthcare and research with world-class education and hands-on experience in the U.S.
          </span>
        </p>
