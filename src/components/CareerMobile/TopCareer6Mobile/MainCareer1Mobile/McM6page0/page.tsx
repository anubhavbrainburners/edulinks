        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Healthcare & Life Sciences in the USA
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              The United States is a global leader in healthcare, medicine, and biotechnology innovation. With cutting-edge research universities, advanced hospitals, and thriving pharmaceutical industries, students gain the knowledge and skills to drive breakthroughs in health, wellness, and life sciences. Programs combine academic excellence with clinical practice and global research exposure.
            </p>
            <button
