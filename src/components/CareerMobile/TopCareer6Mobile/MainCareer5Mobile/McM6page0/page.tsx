        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Education & Research in the USA
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              The United States is a global leader in education and academic research, home to many of the world’s top-ranked universities and research institutions. Programs in education, psychology, and research studies focus on teaching innovation, academic leadership, and evidence-based inquiry — preparing graduates to become educators, administrators, and thought leaders worldwide.
            </p>
            <button
          ...
          >
           ...
           {/* RIGHT: Illustration */}
          <div className="-mt-10 relative left-34 top-13">
