        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Business & Management in the USA
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              The United States is the world’s most dynamic business and innovation hub — home to Fortune 500 companies, leading startups, and top-ranked business schools. Business and management programs in the U.S. emphasize leadership, entrepreneurship, and strategic thinking, preparing graduates for global careers in finance, consulting, technology, and management.
            </p>
            <button
