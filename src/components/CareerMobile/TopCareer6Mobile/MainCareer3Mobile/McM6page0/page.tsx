        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Information Technology & AI in the USA
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              The United States is home to Silicon Valley, global tech leaders, and the world’s top-ranked universities for IT and AI. Students gain a strong foundation in computing, software engineering, and artificial intelligence through hands-on research, internships, and access to advanced technology labs. The U.S. is ideal for ambitious learners looking to build a career in technology, data, or innovation.
            </p>
            <button
