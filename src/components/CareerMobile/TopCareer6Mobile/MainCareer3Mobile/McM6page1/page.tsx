...
const REASONS = [
  {
    ...
    text: (
      <>
       Home to the top 10 global universities For Computer Science and AI.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Industry-integrated learning with opportunities at Google, Microsoft, IBM, and Meta.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       STEM-designated degrees offering 3 years of Optional Practical Training (OPT).
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Competitive salaries and strong job Growth Across the tech industry.
  ...
  },
  {
    ...
    text: (
      <>
       Pathways to H-1B work visa and long-Term career advancement.
      </>
    ),
  },
];
