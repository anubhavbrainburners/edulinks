        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Education & Teaching in Australia
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              Australia’s education system is globally respected for its quality, creativity, and emphasis on student outcomes. Education and Teaching programs combine strong academic foundations with practical teaching placements, preparing graduates to teach in schools, colleges, and international classrooms.
            </p>
            <button
