...
const REASONS = [
  {
    ...
    text: (
      <>
        Australian teaching degrees are internationally recognised and accredited.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Strong demand for qualified teachers across Australia and globally.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Extensive classroom placements and real-world teaching practice.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Opportunity to specialise in inclusive and digital education.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Pathways to PR through skilled teacher occupations in Australia.
      </>
    ),
  },
];
