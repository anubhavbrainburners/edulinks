        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Business & Management in Australia
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              Business and Management programs in Australia are designed to develop leadership, strategy, and analytical skills through practical and globally oriented learning. With major hubs like Sydney and Melbourne leading in finance, marketing, and entrepreneurship, Australia provides excellent opportunities for business graduates to build impactful careers.
            </p>
            <button
