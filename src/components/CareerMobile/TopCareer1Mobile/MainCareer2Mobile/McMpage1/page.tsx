...
const REASONS = [
  {
    ...
    text: (
      <>
        Globally recognised MBAs and business degrees accredited by AACSB, EQUIS, and AMBA.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Practical, case-based learning with internships and consulting projects.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        High graduate employability in management, marketing, finance, and analytics.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Opportunity to work part-time while studying and full-time after graduation.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Strong pathways to PR for in-demand business and analytics roles.
      </>
    ),
  },
];
