...
const REASONS = [
  {
    ...
    text: (
      <>
        High global demand for IT and AI professionals across all industries.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Practical, project-based curriculum aligned with real-world tech needs.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Access to top research labs and innovation hubs across major cities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Strong career pathways in tech, analytics, and automation.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Post-study work visa and PR opportunities for skilled IT graduates.
      </>
    ),
  },
];
