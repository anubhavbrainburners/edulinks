        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Information Technology & AI in Australia
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              Australia is at the forefront of digital transformation, offering cutting-edge education in IT, computer science, and artificial intelligence. With rising demand for tech professionals across industries, universities combine theory, coding, and innovation with hands-on industry projects and internships.
            </p>
            <button
