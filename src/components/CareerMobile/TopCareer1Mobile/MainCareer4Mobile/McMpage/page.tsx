      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-base sm:text-lg">
            Experience world-class hospitality and tourism education in one of the world’s top travel destinations — with hands-on training, global exposure, and career-ready skills.
          </span>
        </p>
