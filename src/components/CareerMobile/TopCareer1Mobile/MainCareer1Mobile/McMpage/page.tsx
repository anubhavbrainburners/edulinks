  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          Health Sciences in<br/> Australia
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Explore Australia’s world-class medical and health education — from nursing and public health to biomedical research — with strong career outcomes and global recognition.
          </span>
        </p>
