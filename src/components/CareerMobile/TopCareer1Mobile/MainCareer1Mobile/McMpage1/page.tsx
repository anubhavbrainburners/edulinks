...
const REASONS = [
  {
    ...
    text: (
      <>
        Australia’s health programs are globally accredited and recognised by international health bodies.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Hands-on learning through hospital placements, clinics, and research labs.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Growing demand for healthcare professionals across urban and regional Australia.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Excellent graduate employability and PR pathways in nursing, medicine, and allied health.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Opportunity to work during and after studies in Australia’s healthcare sector.
      </>
    ),
  },
];
