        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Health Sciences in Australia
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              Health Sciences programs in Australia focus on practical training, advanced research, and clinical exposure. With an ageing population and rising global health needs, careers in nursing, allied health, medicine, and public health are among the most in-demand fields across the country.
            </p>
            <button
