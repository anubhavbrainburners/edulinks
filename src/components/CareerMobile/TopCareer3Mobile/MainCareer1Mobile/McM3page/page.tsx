...
import McM3page0 from "../McM3page0/page";
import McM3page1 from "../McM3page1/page";
import McM3page2 from "../McM3page2/page";

export default function McM3page () {
  return (
    <>
    <section
      id="below-header"
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          Healthcare & Life Sciences in Germany
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Advance your career in one of Europe’s top destinations for medical, pharmaceutical, and biological research — where innovation meets care.
          </span>
        </p>
