...
const REASONS = [
  {
    ...
    text: (
      <>
       World-class medical and biotechnology education with modern facilities.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    text: (
      <>
      High demand for skilled professionals In hospitals, labs, and research centres.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Opportunities for research and clinical practice during studies.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        18-month post-study work visa and strong PR pathways for healthcare professionals.
      </>
    ),
  },
];
