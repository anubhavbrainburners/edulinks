...
import Tc3Mpage1 from "../Tc3Mpage1/page";
import Tc3Mpage2 from "../Tc3Mpage2/page";

export default function Tc3Mpage0 () {
  return (
    <>
    <section
      id="below-header"
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          Top 20 Universities in<br/> Germany
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Explore Germany’s most in-demand professions and future-focused industries. Discover the right career path and the courses that can take you there.
          </span>
        </p>
