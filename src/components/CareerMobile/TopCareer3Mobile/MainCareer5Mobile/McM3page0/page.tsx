        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Education & Research in Germany
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              Germany is globally recognised for its strong academic traditions, world-class research institutions, and free or affordable education. Universities emphasise critical thinking, interdisciplinary learning, and innovation — making Germany a top destination for educators, researchers, and academics.
            </p>
            <button
