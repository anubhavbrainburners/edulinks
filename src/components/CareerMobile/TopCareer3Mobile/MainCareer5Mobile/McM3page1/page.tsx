...
const REASONS = [
  {
    ...
    text: (
      <>
       Tuition-free or low-cost study at globally recognised universities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Access to advanced research facilities and funded PhD opportunities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Opportunities to collaborate with leading professors and research centres.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        18-month post-study work visa with options to stay for research or academia.
  ...
  },
  {
    ...
    text: (
      <>
       English-taught Master’s and Doctorate programs available in most universities.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-16">
        <h1 className="text-3xl font-bold text-[#545454] leading-snug">
          Why Study Education & Research in Germany
        </h1>
      </div>
