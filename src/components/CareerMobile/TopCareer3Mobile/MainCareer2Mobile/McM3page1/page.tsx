...
const REASONS = [
  {
    ...
    text: (
      <>
        Globally accredited programs focused on innovation and sustainability.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Opportunity to study in Europe’s financial powerhouse — home to Frankfurt, Berlin, and Munich.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Tuition-free or low-cost business degrees at public universities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Internships and work placements with top German and global companies.
  ...
  },
  {
    ...
    text: (
      <>
       18-month post-study work visa and strong PR pathways for skilled professionals.
      </>
    ),
  },
];

export default function McM3page1() {
  return (
