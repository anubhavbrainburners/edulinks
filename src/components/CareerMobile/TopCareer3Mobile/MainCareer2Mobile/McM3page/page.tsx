      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-base sm:text-lg">
            Gain a global business edge with Germany’s world-renowned management, finance, and economics programs — where theory meets real-world innovation.
          </span>
        </p>
