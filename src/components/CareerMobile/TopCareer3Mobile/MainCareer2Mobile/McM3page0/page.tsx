        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Business & Finance in Germany
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              Germany is Europe’s largest economy and a global leader in business and finance education. Universities emphasise practical learning, research, and analytical skills that prepare graduates for leadership roles in multinational companies, startups, and financial institutions. Affordable tuition and strong employment prospects make Germany a top destination for aspiring business professionals.
            </p>
            <button
