...
const REASONS = [
  {
    ...
    text: (
      <>
        Home to leading tech innovators and global research institutions.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    text: (
      <>
        Strong career demand in AI, data, and software engineering.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Access to paid internships and Research projects in tech companies.
  ...
  },
  {
    ...
    text: (
      <>
       18-month post-study work visa and EU-wide job opportunities.
      </>
    ),
  },
];
