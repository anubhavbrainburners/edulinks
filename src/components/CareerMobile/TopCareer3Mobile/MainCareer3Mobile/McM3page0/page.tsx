        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Information Technology & AI in Germany
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              Germany is at the forefront of the digital revolution, offering top-quality programs in Information Technology, Artificial Intelligence, and Computer Science. With world-class research universities, affordable education, and booming demand for tech professionals, Germany provides an ideal environment for future-ready IT careers.
            </p>
            <button
