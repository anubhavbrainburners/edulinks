  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          Information Technology & AI in Germany
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Study in one of Europe’s leading tech and innovation hubs — where AI, data science, and digital engineering are shaping the future.
          </span>
        </p>
