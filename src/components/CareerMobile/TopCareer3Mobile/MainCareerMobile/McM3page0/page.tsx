        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Engineering & Manufacturing in Germany
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-5 -mt-3">
              Germany is renowned for its world-leading engineering and manufacturing excellence. From automotive design to renewable energy and automation, students gain cutting-edge knowledge through practice-oriented programs at top public and technical universities. With tuition-free or low-cost education and strong industry connections, Germany offers unmatched value for aspiring engineers.
            </p>
            <button
