        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Renewable Energy & Sustainability in Germany
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              Germany is a global pioneer in renewable energy and sustainable development. With its ambitious Energiewende (energy transition) policy, the country is investing heavily in clean power, smart infrastructure, and environmental technology. Universities combine cutting-edge research with practical learning to prepare students for careers that drive a greener future.
            </p>
            <button
