...
import McM4page0 from "../McM3page0/page";
import McM4page1 from "../McM3page1/page";
import McM4page2 from "../McM3page2/page";
  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          Renewable Energy & Sustainability in Germany
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Study in Europe’s clean energy leader — where innovation, green technology, and sustainability meet real-world impact.
          </span>
        </p>
