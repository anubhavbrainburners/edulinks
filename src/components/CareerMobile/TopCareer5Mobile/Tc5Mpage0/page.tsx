...
import Tc5Mpage1 from "../Tc5Mpage1/page";
import Tc5Mpage2 from "../Tc5Mpage2/page";

export default function Tc5Mpage0 () {
  return (
    <>
    <section
      id="below-header"
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-base sm:text-lg">
             Explore the UK’s most in-demand careers and industries. Discover your ideal career path and find the right course to get started.
          </span>
        </p>
