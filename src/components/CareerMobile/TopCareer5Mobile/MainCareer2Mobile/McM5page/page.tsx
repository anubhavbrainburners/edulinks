  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          Business & Finance in the United Kingdom
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Build a world-class career in global business and finance — study at the heart of innovation, strategy, and leadership in the UK.
          </span>
        </p>
