...
const REASONS = [
  {
    ...
    text: (
      <>
      Globally recognised degrees from top-ranked business schools
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Study in the world’s leading financial hub — London.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Practical internships and placement opportunities with global companies.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       2-year post-study work visa and clear PR pathways for skilled professionals.
  ...
  },
  {
    ...
    text: (
      <>
       Networking opportunities with top employers, investors, and innovators.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-16">
        <h1 className="text-3xl font-bold text-[#545454] leading-snug">
          Why Study Business & Finance in the UK?
        </h1>
      </div>
