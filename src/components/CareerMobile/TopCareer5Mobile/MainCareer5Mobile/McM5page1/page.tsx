...
const REASONS = [
  {
    ...
    text: (
      <>
       Degrees accredited by the Department for Education (DfE) and recognised worldwide.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Extensive classroom placements Across schools and educational institutions.
      </>
    ),
  },
  {
    ...
    text: (
      <>
      High demand for qualified teachers in UK public and private schools.
      </>
    ),
  },
  {
    ...
    text: (
      <>
      Pathways to Qualified Teacher Status (QTS) and teaching licenses abroad.
  ...
  },
  {
    ...
    text: (
      <>
      2-year post-study work visa and PR opportunities under skilled migration.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-16">
        <h1 className="text-3xl font-bold text-[#545454] leading-snug">
          Why Study Education & Teaching in the UK?
        </h1>
      </div>
