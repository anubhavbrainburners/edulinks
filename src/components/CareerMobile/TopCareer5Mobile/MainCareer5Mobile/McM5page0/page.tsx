        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Education & Teaching in the UK
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              The UK is globally recognised for its exceptional education system and high teaching standards. Universities combine theory, classroom practice, and leadership development to prepare graduates for teaching, educational administration, and academic research careers — both in the UK and internationally.
            </p>
            <button
