  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          Education & Teaching in the United Kingdom
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Empower future generations and make a global impact with the UK’s world-leading education and teacher training programs.
          </span>
        </p>
