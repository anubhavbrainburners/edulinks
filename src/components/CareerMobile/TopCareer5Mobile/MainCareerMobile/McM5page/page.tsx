  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          Engineering & Technology in the United Kingdom
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Build your future with world-class engineering and technology programs — where innovation, creativity, and global impact come together.
          </span>
        </p>
