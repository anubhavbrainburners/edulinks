  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          Healthcare & Nursing in the United Kingdom
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Join one of the world’s most advanced healthcare education systems — and train with globally recognised universities and hospitals across the UK.
          </span>
        </p>
