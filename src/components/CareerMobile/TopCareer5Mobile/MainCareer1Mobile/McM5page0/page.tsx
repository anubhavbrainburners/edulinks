        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Healthcare & Nursing in the UK
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              The UK is a global leader in medical and nursing education, offering world-class training through advanced facilities and hands-on clinical placements. With a strong public healthcare system (the NHS) and internationally accredited programs, the UK provides an ideal environment for aspiring nurses, doctors, and health professionals.
            </p>
            <button
