...
const REASONS = [
  {
    ...
    text: (
      <>
       UK universities rank among the top Globally for computer science and AI research.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Strong demand for data scientists, software engineers, and cybersecurity experts.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Practical learning with real-world Projects and internships.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    text: (
      <>
      Pathways to skilled jobs in tech, fintech, And data analytics sectors.
      </>
    ),
  },
];
