        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Information Technology & Data Science in the UK
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              The UK is one of the world’s leading technology and innovation hubs, home to global tech giants and thriving startups. Universities offer future-focused IT and data programs combining technical expertise with problem-solving, analytics, and research. With high employability and post-study work options, the UK is an ideal destination for aspiring tech professionals.
            </p>
            <button
