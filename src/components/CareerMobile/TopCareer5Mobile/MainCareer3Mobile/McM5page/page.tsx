...
import McM5page0 from "../McM5page0/page";
import McM5page1 from "../McM5page1/page";
import McM5page2 from "../McM5page2/page";

export default function McM5page () {
  return (
    <>
    <section
      id="below-header"
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          Information Technology & Data Science in the United Kingdom
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Master the digital world with UK’s cutting-edge programs in IT, Artificial Intelligence, and Data Science — where innovation drives opportunity.
          </span>
        </p>
