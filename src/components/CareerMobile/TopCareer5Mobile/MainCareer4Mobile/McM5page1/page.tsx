...
const REASONS = [
  {
    ...
    text: (
      <>
        Study in the world’s leading creative hub — London, Manchester, and Glasgow.
      </>
    ),
  },
  {
    ...
    text: (
      <>
      Access to industry-standard Studios, Labs, and Production Spaces.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Real-world exposure through internships And live creative projects.
      </>
    ),
  },
  {
    ...
    text: (
      <>
      Global career opportunities in media, Design, And digital communication.
      </>
    ),
  },
  {
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-16">
        <h1 className="text-3xl font-bold text-[#545454] leading-snug">
          Why Study Creative Industries & Media in the UK?
        </h1>
      </div>
