  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          Creative Industries & Media in the United Kingdom
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Unleash your creativity in one of the world’s most vibrant cultural and media hubs — where art, storytelling, and innovation shape the future.
          </span>
        </p>
