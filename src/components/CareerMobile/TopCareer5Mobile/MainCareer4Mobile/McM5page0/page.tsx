        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Creative Industries & Media in the UK
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              The United Kingdom is a global powerhouse in arts, design, film, and media — home to world-renowned creative institutions and a thriving entertainment industry. With strong ties to global production houses, fashion brands, and digital studios, UK universities offer students the perfect blend of creativity, technology, and real-world experience.
            </p>
            <button
