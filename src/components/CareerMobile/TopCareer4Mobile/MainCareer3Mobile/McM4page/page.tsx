  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          Information Technology & AI in New Zealand
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Shape the digital future with globally recognised IT and AI degrees in New Zealand — where innovation meets opportunity.
          </span>
        </p>
