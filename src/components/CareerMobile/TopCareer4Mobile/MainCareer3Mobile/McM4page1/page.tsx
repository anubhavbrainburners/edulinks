...
const REASONS = [
  {
    ...
    text: (
      <>
        Tech professionals are in high demand Across
  ...
  },
  {
    ...
    text: (
      <>
        Strong focus on innovation, sustainability, and real-world problem-solving.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Post-study work visa (up to 3 years) and PR pathways for skilled IT professionals.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Access to internships and research opportunities in emerging technologies.
  ...
  },
  {
    ...
    text: (
      <>
      English-speaking, multicultural environment ideal for international students.
      </>
    ),
  },
];
