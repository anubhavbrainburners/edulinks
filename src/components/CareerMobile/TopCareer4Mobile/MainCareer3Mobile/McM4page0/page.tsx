...
export default function McM4page0 () {
  return (
        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Information Technology & AI in New Zealand
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              New Zealand is becoming a leading destination for technology education and digital innovation. With strong government investment and a growing tech industry, universities provide future-focused programs in AI, data science, software development, and cybersecurity — preparing graduates for global tech careers.
            </p>
            <button
