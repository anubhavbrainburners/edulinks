...
import Tc4Mpage1 from "../Tc4Mpage1/page";
import Tc4Mpage2 from "../Tc4Mpage2/page";

export default function Tc4Mpage0 () {
  return (
    <>
    <section
      id="below-header"
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          Top 20 Universities in<br/> New Zealand
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
             Discover New Zealand’s most in-demand careers and growing industries. Find your ideal path and the right course to begin your journey.
          </span>
        </p>
