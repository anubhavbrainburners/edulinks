        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Business & Management in New Zealand
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              New Zealand’s business programs emphasise practical learning, innovation, and global awareness. Students gain hands-on experience through industry projects, internships, and entrepreneurial labs, preparing for leadership roles across international markets. With a growing economy and supportive post-study visa options, it’s an ideal place to build a career in business.
            </p>
            <button
