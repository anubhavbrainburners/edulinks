...
const REASONS = [
  {
    ...
    text: (
      <>
       Globally recognised business schools With industry-aligned curricula.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Focus on real-world skills through internships and co-op programs.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Excellent employability in finance, consulting, and management roles.
      </>
    ),
  },
  {
    ...
    text: (
      <>
      Post-study work visa of up to 3 years for international graduates.
  ...
  },
  {
    ...
    text: (
      <>
       Safe, multicultural learning environment with strong business networks.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-16">
        <h1 className="text-3xl font-bold text-[#545454] leading-snug">
          Why Study Business & Management in New Zealand?
        </h1>
      </div>
