        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Engineering & Construction in New Zealand
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-5 -mt-3">
              New Zealand’s engineering and construction industry is expanding rapidly, driven by smart infrastructure, renewable energy, and sustainable development. Universities focus on practical, research-led education, producing highly skilled professionals who are globally employable.
            </p>
            <button
