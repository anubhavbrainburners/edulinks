...
const REASONS = [
  {
    ...
    text: (
      <>
        Accredited degrees recognised globally by the Washington Accord.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Practical learning with internships and industry projects.
      </>
    ),
  },
  {
    ...
    text: (
      <>
      High demand for engineers and construction managers across the country.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Pathways to Post-Study Work Visa (up to 3 years) and Permanent Residency (PR).
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Strong focus on sustainability and renewable technologies.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-16">
        <h1 className="text-3xl font-bold text-[#545454] leading-snug">
          Why Study Engineering & Manufacturing in Germany?
        </h1>
      </div>
