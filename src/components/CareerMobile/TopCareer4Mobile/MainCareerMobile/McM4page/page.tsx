  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          Engineering & Construction in New Zealand
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Build your global engineering career in one of the world’s most innovative and sustainable nations — where hands-on learning meets real industry growth.
          </span>
        </p>
