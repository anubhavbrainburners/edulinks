        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Agriculture & Environmental Sciences in New Zealand
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              New Zealand is a global leader in agriculture, agribusiness, and environmental sustainability. With vast natural resources and a strong focus on innovation, universities offer research-driven programs in farming, food science, conservation, and environmental management — preparing graduates for impactful, green careers.
            </p>
            <button
