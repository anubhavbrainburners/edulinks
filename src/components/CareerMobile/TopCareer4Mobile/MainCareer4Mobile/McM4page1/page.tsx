...
const REASONS = [
  {
    ...
    text: (
      <>
       One of the most sustainable agricultural economies in the world.
      </>
    ),
  },
  {
    ...
    text: (
      <>
      Strong research and industry collaboration with global agritech firms.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Hands-on learning with fieldwork, labs, And internships in real environments.
      </>
    ),
  },
  {
    ...
    text: (
      <>
      High employability in agriculture, food Tech, and environmental policy sectors.
  ...
  },
  {
    ...
    text: (
      <>
       Pathways to PR and post-study work visas for science graduates.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-16">
        <h1 className="text-3xl font-bold text-[#545454] leading-snug">
          Why Study Agriculture & Environmental Sciences in New Zealand?
        </h1>
      </div>
