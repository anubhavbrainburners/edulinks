...
import McM4page0 from "../McM4page0/page";
import McM4page1 from "../McM4page1/page";
import McM4page2 from "../McM4page2/page";


export default function McM4page() {
  return (
    <>
    <section
      id="below-header"
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          Agriculture & Environmental Sciences in New Zealand
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Study in one of the world’s most sustainable and nature-driven countries — where agriculture, food technology, and environmental innovation thrive together.
          </span>
        </p>
