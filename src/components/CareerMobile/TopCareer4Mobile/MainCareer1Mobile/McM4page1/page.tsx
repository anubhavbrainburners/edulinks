...
const REASONS = [
  {
    ...
    text: (
      <>
        Nursing degrees accredited by the New Zealand Nursing Council and globally recognised.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Extensive hands-on clinical placements in hospitals and health centres.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Strong employability and PR pathways In healthcare professions.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Supportive, multicultural learning environment with modern facilities.
      </>
    ),
  },
  {
    ...
    text: (
      <>
      Post-study work visa up to 3 years For eligible health graduates.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-16">
        <h1 className="text-3xl font-bold text-[#545454] leading-snug">
          Why Study Healthcare & Nursing in New Zealand
        </h1>
      </div>
