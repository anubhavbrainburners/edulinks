  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          Healthcare & Nursing in New Zealand
        </h1>
        ...
        >
          <span className="block text-base sm:text-lg">
            Join one of the world’s most trusted healthcare systems — study nursing and health sciences in New Zealand and make a real difference globally.
          </span>
        </p>
