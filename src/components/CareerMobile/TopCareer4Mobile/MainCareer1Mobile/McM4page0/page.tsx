        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Healthcare & Nursing in New Zealand
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              New Zealand offers world-class healthcare education with a focus on practical training, clinical placements, and evidence-based learning. With an ageing population and a growing healthcare sector, qualified nurses and health professionals are in high demand across hospitals, clinics, and community health programs.
            </p>
            <button
