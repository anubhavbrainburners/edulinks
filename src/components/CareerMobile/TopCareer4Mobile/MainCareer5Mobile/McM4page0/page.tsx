        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Education & Teaching in New Zealand
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              New Zealand is known for its high-quality, inclusive education system and innovative teaching methods. Education and teaching programs focus on practical classroom training, cultural understanding, and leadership skills — preparing graduates for careers both in New Zealand and around the world.
            </p>
            <button
