...
const REASONS = [
  {
    ...
    text: (
      <>
        Degrees recognised globally and accredited by the Teaching Council of Aotearoa New Zealand.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Strong practical focus with extensive teaching placements in schools.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        High demand for qualified teachers Across public and private institutions.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Clear PR pathways for education professionals under skilled migration lists.
  ...
  },
  {
    ...
    text: (
      <>
      Post-study work visa up to 3 years For eligible graduates.
      </>
    ),
  },
];
    ...
    <main className="min-h-screen bg-white px-6">
      ...
      <div className="mx-auto max-w-screen-xl text-center mb-16">
        <h1 className="text-3xl font-bold text-[#545454] leading-snug">
          Why Study Education & Teaching in New Zealand?
        </h1>
      </div>
