        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Information Technology & AI in Canada
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              Canada is home to one of the world’s fastest-growing tech sectors, with global companies investing in innovation hubs across Toronto, Vancouver, and Montreal. Universities in Canada offer programs focused on data science, artificial intelligence, cybersecurity, and software development — blending theoretical knowledge with hands-on experience.
            </p>
            <button
          ...
          >
           ...
           {/* RIGHT: Illustration */}
          <div className="-mt-25 relative left-12 top-12">
