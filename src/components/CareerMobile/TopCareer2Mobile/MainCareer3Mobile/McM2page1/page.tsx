...
const REASONS = [
  {
    ...
    text: (
      <>
        Strong global demand for IT and AI professionals in every industry.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Industry-integrated co-op programs for real-world tech experience.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Canada’s AI hubs — Toronto, Montreal, and Vancouver — rank among the world’s top AI research centres.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Post-study work permits and PR opportunities for tech graduates.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Government-backed innovation initiatives supporting international talent.
      </>
    ),
  },
];
