        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Education & Teaching in Canada
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              Canada is known for its world-class education system and strong focus on innovation, inclusivity, and global learning. Teaching programs combine theoretical foundations with extensive classroom placements, preparing graduates to educate in schools, colleges, and language institutions both in Canada and abroad.
            </p>
            <button
