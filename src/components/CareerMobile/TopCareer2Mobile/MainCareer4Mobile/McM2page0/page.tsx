        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Hospitality & Tourism in Canada
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              Canada’s hospitality and tourism sector is one of its fastest-growing industries, attracting millions of visitors annually. With world-class programs focused on practical learning, leadership, and global service standards, students gain the skills to work in hotels, resorts, travel companies, and event management worldwide.
            </p>
            <button
