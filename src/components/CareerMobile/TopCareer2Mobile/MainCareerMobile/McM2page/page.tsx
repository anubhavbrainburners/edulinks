      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-base sm:text-lg">
            Build your future with Canada’s high-quality engineering and construction education — focused on innovation, sustainability, and real-world industry experience.
          </span>
        </p>
