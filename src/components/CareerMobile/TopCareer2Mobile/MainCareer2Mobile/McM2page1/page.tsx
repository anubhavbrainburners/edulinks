...
const REASONS = [
  {
    ...
    text: (
      <>
        Canadian business degrees are globally accredited and recognised.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Access to internship and co-op programs with leading multinational companies.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       High employability rates and post-study work opportunities in corporate sectors.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Competitive salaries and career progression in finance, consulting, and analytics.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Opportunity for PR through in-demand occupations in business and finance.
      </>
    ),
  },
];
