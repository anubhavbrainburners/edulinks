        ...
        <div className="grid grid-cols-1 gap-8 text-center">
          ...
          <div className=" order-2">
            <h1 className="mb-6 text-3xl font-bold text-[#545454]">
              About Business & Finance in Canada
            </h1>

            <p className="text-lg leading-normal text-[#666666] px-4 -mt-3">
              Canada is a global hub for business innovation and financial growth. From banking and entrepreneurship to marketing and analytics, Canadian universities prepare students for dynamic roles across global industries. With strong economic stability and opportunities in major cities like Toronto, Vancouver, and Montreal, Canada is one of the best destinations for aspiring business professionals.
            </p>
            <button
