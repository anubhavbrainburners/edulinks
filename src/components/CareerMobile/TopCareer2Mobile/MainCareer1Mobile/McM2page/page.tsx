      ...
      <div className="text-center relative z-20 max-w-6xl">
        ...
        >
          <span className="block text-base sm:text-lg">
            Join one of the most respected healthcare education systems in the world — with career pathways in nursing, medicine, and allied health that make a global impact.
          </span>
        </p>
