...
const REASONS = [
  {
    ...
    text: (
      <>
        Canadian nursing and healthcare degrees are globally recognised and highly employable.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Extensive clinical placements and research opportunities in top hospitals and clinics.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Excellent job security and high earning potential across healthcare roles.
      </>
    ),
  },
  {
    ...
    text: (
      <>
       Clear PR pathways for healthcare professionals through federal and provincial programs.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        Strong support for international students, including co-op and postgraduate work permits.
      </>
    ),
  },
];
