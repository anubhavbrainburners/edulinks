...
export default function CombinedAiQuiz() {
    ...
    const stepConfig = {
        1: {
            ...
            options: ["Germany", "Canada", "UK", "USA", "Australia", "New Zealand", "France"],
            progress: 33,
    ...
    const generateQuestions = async (difficulty: string) => {
        ...
        try {
            ...
            // fallback support for other structures (optional)
    ...
    const getOptionColor = (option: string) => {
        ...
        return option === "Easy" ? "#4CAF50" :
            option === "Medium" ? "#FFD700" : "#FF4C4C";
    };
            ...
            >
                <div className="max-w-[650px] mx-auto text-[#545454]">
                    <div className="bg-white rounded-4xl shadow-lg px-8 pt-10 pb-10">
                        ...
                        <form className="space-y-4" aria-label="Quiz options">
                  ...
                  `}
                                >
                                    {currentStep === 3 ? "Generate Test" : "Next"} <FaArrowRightLong />
                                </button>
                            </div>
